...
static ItemRow rItemTable[] = {
    ...
    [0x09] = ITEM_ROW(0x53, 0, 0x0B, 0x004F, 0x00DD, 0x01, 0x2E, ItemUpgrade_None, ItemEffect_None, -1, -1), // Longshot
    ...
    [0x11] = ITEM_ROW(0x53, 0, 0x16, 0x0044, 0x00EB, 0x01, 0x37, ItemUpgrade_None, ItemEffect_None, -1, -1), // Green Potion
    [0x12] = ITEM_ROW(0x53, 0, 0x17, 0x0045, 0x00EB, 0x02, 0x39, ItemUpgrade_None, ItemEffect_None, -1, -1), // Blue Potion
    ...
    [0x39] = ITEM_ROW(0x53, 0, 0x6F, 0x0068, 0x00C8, 0x01, 0x21, ItemUpgrade_None, ItemEffect_None, -1, -1), // Stone of Agony
    [0x3A] = ITEM_ROW(0x53, 0, 0x70, 0x007B, 0x00D7, 0x00, 0x24, ItemUpgrade_None, ItemEffect_None, -1, -1), // Gerudo Membership Card
    [0x3B] = ITEM_ROW(0x53, 0, 0x41, 0x004A, 0x010E, 0x02, 0x46, ItemUpgrade_None, ItemEffect_GiveFairyOcarina, -1, -1), // Fairy Ocarina
    ...
    [0x3E] = ITEM_ROW(0x3E, 1, 0x7A, 0x00C2, 0x00BD, 0x01, 0x14, ItemUpgrade_None, ItemEffect_FullHeal, -1, -1), // Piece of Heart
    ...
    [0x59] = ITEM_ROW(0x53, 0, 0x0C, 0x0071, 0x0158, 0x01, 0x61, ItemUpgrade_None, ItemEffect_None, -1, -1), // Ice Arrow
    [0x5A] = ITEM_ROW(0x53, 0, 0x12, 0x0072, 0x0158, 0x02, 0x62, ItemUpgrade_None, ItemEffect_None, -1, -1), // Light Arrow
    [0x5B] = ITEM_ROW(0x5B, 1, 0x71, 0x00B4, 0x0024, 0x02, 0x63, ItemUpgrade_None, ItemEffect_None, -1, -1), // Gold Skulltula Token
    [0x5C] = ITEM_ROW(0x53, 0, 0x05, 0x00AD, 0x015D, 0x00, 0x64, ItemUpgrade_None, ItemEffect_None, -1, -1), // Din's Fire
    [0x5D] = ITEM_ROW(0x53, 0, 0x0D, 0x00AE, 0x015D, 0x01, 0x65, ItemUpgrade_None, ItemEffect_None, -1, -1), // Farore's Wind
    [0x5E] = ITEM_ROW(0x53, 0, 0x13, 0x00AF, 0x015D, 0x02, 0x66, ItemUpgrade_None, ItemEffect_None, -1, -1), // Nayru's Love
    ...
    [0x8C] = ITEM_ROW(0x53, 0, 0x41, 0x0043, 0x0199, 0x00, 0x01, ItemUpgrade_None, ItemEffect_GiveBottle, 0x15, -1), // Bottle with Red Potion
    [0x8D] = ITEM_ROW(0x53, 0, 0x41, 0x0044, 0x0199, 0x01, 0x01, ItemUpgrade_None, ItemEffect_GiveBottle, 0x16, -1), // Bottle with Green Potion
    [0x8E] = ITEM_ROW(0x53, 0, 0x41, 0x0045, 0x0199, 0x02, 0x01, ItemUpgrade_None, ItemEffect_GiveBottle, 0x17, -1), // Bottle with Blue Potion
    ...
    [0x95] = ITEM_ROW(0x53, 2, 0x41, 0x09D4, 0x00B9, 0x00, 0x0A, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x01, DUNGEON_FOREST_TEMPLE ), // Forest Temple Boss Key
    [0x96] = ITEM_ROW(0x53, 2, 0x41, 0x09D5, 0x00B9, 0x00, 0x0A, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x01, DUNGEON_FIRE_TEMPLE   ), // Fire Temple Boss Key
    [0x97] = ITEM_ROW(0x53, 2, 0x41, 0x09D6, 0x00B9, 0x00, 0x0A, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x01, DUNGEON_WATER_TEMPLE  ), // Water Temple Boss Key
    [0x98] = ITEM_ROW(0x53, 2, 0x41, 0x09D7, 0x00B9, 0x00, 0x0A, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x01, DUNGEON_SPIRIT_TEMPLE ), // Spirit Temple Boss Key
    [0x99] = ITEM_ROW(0x53, 2, 0x41, 0x09D8, 0x00B9, 0x00, 0x0A, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x01, DUNGEON_SHADOW_TEMPLE ), // Shadow Temple Boss Key
    [0x9A] = ITEM_ROW(0x53, 2, 0x41, 0x09D9, 0x00B9, 0x00, 0x0A, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x01, DUNGEON_GANONS_CASTLE_SECOND_PART  ), // Ganon's Castle Boss Key

    [0x9B] = ITEM_ROW(0x53, 1, 0x41, 0x09DA, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_DEKU_TREE         ), // Deku Tree Compass
    [0x9C] = ITEM_ROW(0x53, 1, 0x41, 0x09DB, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_DODONGOS_CAVERN   ), // Dodongo's Cavern Compass
    [0x9D] = ITEM_ROW(0x53, 1, 0x41, 0x09DC, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_JABUJABUS_BELLY   ), // Jabu Jabu Compass
    [0x9E] = ITEM_ROW(0x53, 1, 0x41, 0x09DD, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_FOREST_TEMPLE     ), // Forest Temple Compass
    [0x9F] = ITEM_ROW(0x53, 1, 0x41, 0x09DE, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_FIRE_TEMPLE       ), // Fire Temple Compass
    [0xA0] = ITEM_ROW(0x53, 1, 0x41, 0x09DF, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_WATER_TEMPLE      ), // Water Temple Compass
    [0xA1] = ITEM_ROW(0x53, 1, 0x41, 0x09E0, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_SPIRIT_TEMPLE     ), // Spirit Temple Compass
    [0xA2] = ITEM_ROW(0x53, 1, 0x41, 0x09E1, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_SHADOW_TEMPLE     ), // Shadow Temple Compass
    [0xA3] = ITEM_ROW(0x53, 1, 0x41, 0x09E2, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_BOTTOM_OF_THE_WELL), // Bottom of the Well Compass
    [0xA4] = ITEM_ROW(0x53, 1, 0x41, 0x09E3, 0x00B8, 0x00, 0x0B, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x02, DUNGEON_ICE_CAVERN        ), // Ice Cavern Compass

    [0xA5] = ITEM_ROW(0x53, 1, 0x41, 0x09E4, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_DEKU_TREE      ), // Deku Tree Map
    [0xA6] = ITEM_ROW(0x53, 1, 0x41, 0x09E5, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_DODONGOS_CAVERN), // Dodongo's Cavern Map
    [0xA7] = ITEM_ROW(0x53, 1, 0x41, 0x09E6, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_JABUJABUS_BELLY), // Jabu Jabu Map
    [0xA8] = ITEM_ROW(0x53, 1, 0x41, 0x09E7, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_FOREST_TEMPLE  ), // Forest Temple Map
    [0xA9] = ITEM_ROW(0x53, 1, 0x41, 0x09E8, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_FIRE_TEMPLE    ), // Fire Temple Map
    [0xAA] = ITEM_ROW(0x53, 1, 0x41, 0x09E9, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_WATER_TEMPLE   ), // Water Temple Map
    [0xAB] = ITEM_ROW(0x53, 1, 0x41, 0x09EA, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_SPIRIT_TEMPLE  ), // Spirit Temple Map
    [0xAC] = ITEM_ROW(0x53, 1, 0x41, 0x09EB, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_SHADOW_TEMPLE  ), // Shadow Temple Map
    [0xAD] = ITEM_ROW(0x53, 1, 0x41, 0x09EC, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_BOTTOM_OF_THE_WELL   ), // Bottom of the Well Map
    [0xAE] = ITEM_ROW(0x53, 1, 0x41, 0x09ED, 0x00C8, 0x00, 0x1C, ItemUpgrade_None, ItemEffect_GiveDungeonItem, 0x04, DUNGEON_ICE_CAVERN     ), // Ice Cavern Map

    [0xAF] = ITEM_ROW(0x53, 3, 0x41, 0x09EE, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_FOREST_TEMPLE, -1), // Forest Temple Small Key
    [0xB0] = ITEM_ROW(0x53, 3, 0x41, 0x09EF, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_FIRE_TEMPLE,   -1), // Fire Temple Small Key
    [0xB1] = ITEM_ROW(0x53, 3, 0x41, 0x09F0, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_WATER_TEMPLE,  -1), // Water Temple Small Key
    [0xB2] = ITEM_ROW(0x53, 3, 0x41, 0x09F1, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_SPIRIT_TEMPLE, -1), // Spirit Temple Small Key
    [0xB3] = ITEM_ROW(0x53, 3, 0x41, 0x09F2, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_SHADOW_TEMPLE, -1), // Shadow Temple Small Key
    [0xB4] = ITEM_ROW(0x53, 3, 0x41, 0x09F3, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_BOTTOM_OF_THE_WELL,       -1), // Bottom of the Well Small Key
    [0xB5] = ITEM_ROW(0x53, 3, 0x41, 0x09F4, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_GERUDO_TRAINING_GROUNDS,  -1), // Gerudo Training Small Key
    [0xB6] = ITEM_ROW(0x53, 3, 0x41, 0x09F5, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_GERUDO_FORTRESS,          -1), // Gerudo Fortress Small Key
    [0xB7] = ITEM_ROW(0x53, 3, 0x41, 0x09F6, 0x00AA, 0x00, 0x02, ItemUpgrade_None, ItemEffect_GiveSmallKey, DUNGEON_GANONS_CASTLE_FIRST_PART, -1), // Ganon's Castle Small Key
