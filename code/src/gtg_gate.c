...
#define BgSpot12Saku_Update_addr 0x29E030
#define BgSpot12Saku_Update ((ActorFunc)BgSpot12Saku_Update_addr)

#define BgSpot12Saku_Init_addr 0x27AD6C
#define BgSpot12Saku_Init ((ActorFunc)BgSpot12Saku_Init_addr)
