...
u16 ItemUpgrade_Hookshot(SaveContext* saveCtx, u16 itemId) {
    switch (saveCtx->items[SLOT_HOOKSHOT]) {
        case ITEM_NONE:
            return GI_HOOKSHOT; // Hookshot
        default:
            return GI_LONGSHOT; // Longshot
    }
}
...
u16 ItemUpgrade_Strength(SaveContext* saveCtx, u16 itemId) {
    switch ((saveCtx->upgrades >> 6) & 0x7) {
        case 0:
            return GI_BRACELET; // Goron Bracelet
        case 1:
            return GI_GAUNTLETS_SILVER; // Silver Gauntlets
        default:
            return GI_GAUNTLETS_GOLD; // Gold Gauntlets
    }
}
...
u16 ItemUpgrade_BombBag(SaveContext* saveCtx, u16 itemId) {
    switch ((saveCtx->upgrades >> 3) & 0x7) {
        case 0:
            return GI_BOMB_BAG_20; // Bomb Bag
        case 1:
            return GI_BOMB_BAG_30; // Bigger Bomb Bag
        default:
            return GI_BOMB_BAG_40; // Biggest Bomb Bag
    }
}
...
u16 ItemUpgrade_Quiver(SaveContext* saveCtx, u16 itemId) {
    switch (saveCtx->upgrades & 0x7) {
        case 0:
            return GI_BOW; // Bow
        case 1:
            return GI_QUIVER_40; // Big Quiver
        default:
            return GI_QUIVER_50; // Biggest Quiver
    }
}
...
u16 ItemUpgrade_BulletBag(SaveContext* saveCtx, u16 itemId) {
    switch ((saveCtx->upgrades >> 14) & 0x7) {
        case 0:
            return GI_SLINGSHOT; // Slingshot
        case 1:
            return GI_BULLET_BAG_40; // Bullet Bag (40)
        default:
            return GI_BULLET_BAG_50; // Bullet Bag (50)
    }
}
...
u16 ItemUpgrade_Wallet(SaveContext* saveCtx, u16 itemId) {
    switch ((saveCtx->upgrades >> 12) & 0x3) {
        case 0:
            return GI_WALLET_ADULT; // Adult's Wallet
        case 1:
            return GI_WALLET_GIANT; // Giant's Wallet
        default:
...
u16 ItemUpgrade_Scale(SaveContext* saveCtx, u16 itemId) {
    switch ((saveCtx->upgrades >> 9) & 0x7) {
        case 0:
            return GI_SCALE_SILVER; // Silver Scale
        default:
            return GI_SCALE_GOLD; // Gold Scale
    }
}
...
u16 ItemUpgrade_Nuts(SaveContext* saveCtx, u16 itemId) {
    switch ((saveCtx->upgrades >> 20) & 0x7) {
        case 0:
            return GI_NUT_UPGRADE_30; // 30 Nuts. 0 and 1 are both starting capacity
        case 1:
            return GI_NUT_UPGRADE_30; // 30 Nuts
        default:
            return GI_NUT_UPGRADE_40; // 40 Nuts
    }
}
...
u16 ItemUpgrade_Sticks(SaveContext* saveCtx, u16 itemId) {
    switch ((saveCtx->upgrades >> 17) & 0x7) {
        case 0:
            return GI_STICK_UPGRADE_20; // 20 Sticks. 0 and 1 are both starting capacity
        case 1:
            return GI_STICK_UPGRADE_20; // 20 Sticks
        default:
            return GI_STICK_UPGRADE_30; // 30 Sticks
    }
}
...
u16 ItemUpgrade_Ocarina(SaveContext* saveCtx, u16 itemId) {
    switch (saveCtx->items[SLOT_OCARINA]) {
        case ITEM_NONE:
            return GI_OCARINA_FAIRY; // Fairy Ocarina
        default:
            return GI_OCARINA_OOT; // Ocarina of Time
    }
}
