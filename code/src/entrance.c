...
const EntranceData entranceData[] = {
    ...
    { 0x00BB, "Child Spawn" , "KF Links House" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},
    { 0x0282, "Adult Spawn" , "Temple of Time" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},

    { 0x0600, "Minuet of Forest" , "SFM Warp Pad" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},
    { 0x04F6, "Bolero of Fire" , "DMC Warp Pad" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},
    { 0x0604, "Serenade of Water" , "Lake Hylia Warp Pad" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},
    { 0x01F1, "Requiem of Spirit" , "Desert Colossus Warp Pad" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},
    { 0x0568, "Nocturne of Shadow" , "Graveyard Warp Pad" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},
    { 0x05F4, "Prelude of Light" , "Temple of Time Warp Pad" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},

    { 0x0554, "DMT Owl Flight" , "Kakariko Village Owl Drop" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},
    { 0x027E, "LH Owl Flight" , "Hyrule Field Owl Drop" , ENTRANCE_GROUP_ONE_WAY, ENTRANCE_TYPE_ONE_WAY},
    ...
    { 0x0272, "KF" , "Link's House" , ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0433, "KF" , "Mido's House" , ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0437, "KF" , "Saria's House" , ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x009C, "KF" , "House of Twins" , ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x00C9, "KF" , "Know-It-All House" , ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x00C1, "KF" , "KF Shop" , ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x071B, "KF" , "KF Storms Grotto", ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0000, "KF" , "Deku Tree" , ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_DUNGEON, 1 },
    ...
    { 0x081B, "KF Storms Grotto" , "KF", ENTRANCE_GROUP_KOKIRI_FOREST, ENTRANCE_TYPE_GROTTO, },
    ...
    { 0x071A, "Lost Woods" , "LW Near Shortcuts Grotto", ENTRANCE_GROUP_LOST_WOODS, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0719, "Lost Woods" , "LW Scrubs Grotto", ENTRANCE_GROUP_LOST_WOODS, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0720, "Lost Woods" , "Deku Theater", ENTRANCE_GROUP_LOST_WOODS, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x081A, "LW Near Shortcuts Grotto" , "Lost Woods", ENTRANCE_GROUP_LOST_WOODS, ENTRANCE_TYPE_GROTTO },
    { 0x0819, "LW Scrubs Grotto" , "Lost Woods", ENTRANCE_GROUP_LOST_WOODS, ENTRANCE_TYPE_GROTTO },
    { 0x0820, "Deku Theater" , "Lost Woods", ENTRANCE_GROUP_LOST_WOODS, ENTRANCE_TYPE_GROTTO },

    // Sacred Forest Meadow
    { 0x01A9, "SFM" , "Lost Woods" , ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_OVERWORLD },
    { 0x0716, "SFM" , "SFM Wolfos Grotto", ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0718, "SFM" , "SFM Fairy Grotto", ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0717, "SFM" , "SFM Storms Grotto", ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0169, "SFM" , "Forest Temple" , ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_DUNGEON, 1 },
    { 0x0816, "SFM Wolfos Grotto" , "SFM", ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_GROTTO },
    { 0x0818, "SFM Fairy Grotto" , "SFM", ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_GROTTO },
    { 0x0817, "SFM Storms Grotto" , "SFM", ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_GROTTO },
    { 0x0215, "Forest Temple" , "SFM" , ENTRANCE_GROUP_SFM, ENTRANCE_TYPE_DUNGEON },
    ...
    { 0x02FD, "Kakariko" , "Carpenter Boss House" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0550, "Kakariko" , "House of Skulltula" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x039C, "Kakariko" , "Impa's House Front" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x05C8, "Kakariko" , "Impa's House Back" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0453, "Kakariko" , "Windmill" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x003B, "Kakariko" , "Kak Shooting Gallery" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0072, "Kakariko" , "Granny's Potion Shop" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x00B7, "Kakariko" , "Kak Bazaar" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0384, "Kakariko" , "Kak Potion Shop Front" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x03EC, "Kakariko" , "Kak Potion Shop Back" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x070A, "Kakariko" , "Kak Open Grotto", ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x070B, "Kakariko" , "Kak Redead Grotto", ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0098, "Kakariko" , "Bottom of the Well" , ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_DUNGEON, 1 },
    ...
    { 0x080A, "Kak Open Grotto" , "Kakariko", ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_GROTTO },
    { 0x080B, "Kak Redead Grotto" , "Kakariko", ENTRANCE_GROUP_KAKARIKO, ENTRANCE_TYPE_GROTTO },
    ...
    { 0x030D, "Graveyard" , "Dampe's Shack" , ENTRANCE_GROUP_GRAVEYARD, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x004B, "Graveyard" , "Shield Grave", ENTRANCE_GROUP_GRAVEYARD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x031C, "Graveyard" , "Heart Piece Grave", ENTRANCE_GROUP_GRAVEYARD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x002D, "Graveyard" , "Composer's Grave", ENTRANCE_GROUP_GRAVEYARD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x044F, "Graveyard" , "Dampe's Grave", ENTRANCE_GROUP_GRAVEYARD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0037, "Graveyard" , "Shadow Temple" , ENTRANCE_GROUP_GRAVEYARD, ENTRANCE_TYPE_DUNGEON, 1 },
    ...
    { 0x0315, "DMT" , "DMT Great Fairy Fountain" , ENTRANCE_GROUP_DEATH_MOUNTAIN_TRAIL, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0708, "DMT" , "DMT Storms Grotto", ENTRANCE_GROUP_DEATH_MOUNTAIN_TRAIL, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0709, "DMT" , "DMT Cow Grotto", ENTRANCE_GROUP_DEATH_MOUNTAIN_TRAIL, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0004, "DMT" , "Dodongo's Cavern" , ENTRANCE_GROUP_DEATH_MOUNTAIN_TRAIL, ENTRANCE_TYPE_DUNGEON, 1 },
    { 0x045B, "DMT Great Fairy Fountain" , "DMT" , ENTRANCE_GROUP_DEATH_MOUNTAIN_TRAIL, ENTRANCE_TYPE_INTERIOR},
    { 0x0808, "DMT Storms Grotto" , "DMT", ENTRANCE_GROUP_DEATH_MOUNTAIN_TRAIL, ENTRANCE_TYPE_GROTTO },
    { 0x0809, "DMT Cow Grotto" , "DMT", ENTRANCE_GROUP_DEATH_MOUNTAIN_TRAIL, ENTRANCE_TYPE_GROTTO },
    ...
    { 0x04BE, "DMC" , "DMC Great Fairy Fountain" , ENTRANCE_GROUP_DEATH_MOUNTAIN_CRATER, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0706, "DMC" , "DMC Upper Grotto", ENTRANCE_GROUP_DEATH_MOUNTAIN_CRATER, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0705, "DMC" , "DMC Hammer Grotto", ENTRANCE_GROUP_DEATH_MOUNTAIN_CRATER, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0165, "DMC" , "Fire Temple" , ENTRANCE_GROUP_DEATH_MOUNTAIN_CRATER, ENTRANCE_TYPE_DUNGEON, 1 },
    { 0x0482, "DMC Great Fairy Fountain" , "DMC" , ENTRANCE_GROUP_DEATH_MOUNTAIN_CRATER, ENTRANCE_TYPE_INTERIOR },
    { 0x0806, "DMC Upper Grotto" , "DMC", ENTRANCE_GROUP_DEATH_MOUNTAIN_CRATER, ENTRANCE_TYPE_GROTTO },
    { 0x0805, "DMC Hammer Grotto" , "DMC", ENTRANCE_GROUP_DEATH_MOUNTAIN_CRATER, ENTRANCE_TYPE_GROTTO },
    ...
    { 0x037C, "Goron City" , "Goron Shop" , ENTRANCE_GROUP_GORON_CITY, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0707, "Goron City" , "Goron City Grotto", ENTRANCE_GROUP_GORON_CITY, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x03FC, "Goron Shop" , "Goron City" , ENTRANCE_GROUP_GORON_CITY, ENTRANCE_TYPE_INTERIOR },
    { 0x0807, "Goron City Grotto" , "Goron City", ENTRANCE_GROUP_GORON_CITY, ENTRANCE_TYPE_GROTTO },

    // Zora's River
    { 0x0181, "ZR" , "Hyrule Field" , ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_OVERWORLD },
    { 0x04DA, "ZR" , "Lost Woods" , ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_OVERWORLD },
    { 0x0108, "ZR" , "Zora's Domain" , ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_OVERWORLD },
    { 0x0702, "ZR" , "ZR Storms Grotto", ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0703, "ZR" , "ZR Fairy Grotto", ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0704, "ZR" , "ZR Open Grotto", ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0802, "ZR Storms Grotto" , "ZR", ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_GROTTO },
    { 0x0803, "ZR Fairy Grotto" , "ZR", ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_GROTTO },
    { 0x0804, "ZR Open Grotto" , "ZR", ENTRANCE_GROUP_ZORAS_RIVER, ENTRANCE_TYPE_GROTTO },
    ...
    { 0x0380, "Zora's Domain" , "Zora Shop" , ENTRANCE_GROUP_ZORAS_DOMAIN, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x071C, "Zora's Domain" , "ZD Storms Grotto", ENTRANCE_GROUP_ZORAS_DOMAIN, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x03C4, "Zora Shop" , "Zora's Domain" , ENTRANCE_GROUP_ZORAS_DOMAIN, ENTRANCE_TYPE_INTERIOR },
    { 0x081C, "ZD Storms Grotto" , "Zora's Domain", ENTRANCE_GROUP_ZORAS_DOMAIN, ENTRANCE_TYPE_GROTTO },

    // Zora's Fountain
    { 0x01A1, "ZF" , "Zora's Domain" , ENTRANCE_GROUP_ZORAS_FOUNTAIN, ENTRANCE_TYPE_OVERWORLD },
    { 0x0371, "ZF" , "ZF Great Fairy Fountain" , ENTRANCE_GROUP_ZORAS_FOUNTAIN, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0028, "ZF" , "Jabu Jabu's Belly" , ENTRANCE_GROUP_ZORAS_FOUNTAIN, ENTRANCE_TYPE_DUNGEON, 1 },
    { 0x0088, "ZF" , "Ice Cavern" , ENTRANCE_GROUP_ZORAS_FOUNTAIN, ENTRANCE_TYPE_DUNGEON, 1 },
    { 0x0394, "ZF Great Fairy Fountain" , "ZF" , ENTRANCE_GROUP_ZORAS_FOUNTAIN, ENTRANCE_TYPE_INTERIOR },
    { 0x0221, "Jabu Jabu's Belly" , "ZF" , ENTRANCE_GROUP_ZORAS_FOUNTAIN, ENTRANCE_TYPE_DUNGEON },
    { 0x03D4, "Ice Cavern" , "ZF" , ENTRANCE_GROUP_ZORAS_FOUNTAIN, ENTRANCE_TYPE_DUNGEON },
    ...
    { 0x0710, "Hyrule Field" , "HF Near Market Grotto", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x070E, "Hyrule Field" , "HF Near Kak Grotto", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x070D, "Hyrule Field" , "HF Tektite Grotto", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x070F, "Hyrule Field" , "HF Fairy Grotto", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0711, "Hyrule Field" , "HF Cow Grotto", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0713, "Hyrule Field" , "HF Open Grotto", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0712, "Hyrule Field" , "HF Inside Fence Grotto", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0714, "Hyrule Field" , "HF Southeast Grotto", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0810, "HF Near Market Grotto" , "Hyrule Field", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO },
    { 0x080E, "HF Near Kak Grotto" , "Hyrule Field", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO },
    { 0x080D, "HF Tektite Grotto" , "Hyrule Field", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO },
    { 0x080F, "HF Fairy Grotto" , "Hyrule Field", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO },
    { 0x0811, "HF Cow Grotto" , "Hyrule Field", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO },
    { 0x0813, "HF Open Grotto" , "Hyrule Field", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO },
    { 0x0812, "HF Inside Fence Grotto" , "Hyrule Field", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO },
    { 0x0814, "HF Southeast Grotto" , "Hyrule Field", ENTRANCE_GROUP_HYRULE_FIELD, ENTRANCE_TYPE_GROTTO },

    // Lon Lon Ranch
    { 0x01F9, "Lon Lon Ranch" , "Hyrule Field" , ENTRANCE_GROUP_LON_LON_RANCH, ENTRANCE_TYPE_OVERWORLD },
    { 0x004F, "Lon Lon Ranch" , "Talon's House" , ENTRANCE_GROUP_LON_LON_RANCH, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x02F9, "Lon Lon Ranch" , "LLR Stables" , ENTRANCE_GROUP_LON_LON_RANCH, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x05D0, "Lon Lon Ranch" , "LLR Tower" , ENTRANCE_GROUP_LON_LON_RANCH, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0715, "Lon Lon Ranch" , "LLR Grotto", ENTRANCE_GROUP_LON_LON_RANCH, ENTRANCE_TYPE_GROTTO, 1 },
    ...
    { 0x0815, "LLR Grotto" , "Lon Lon Ranch", ENTRANCE_GROUP_LON_LON_RANCH, ENTRANCE_TYPE_GROTTO },
    ...
    { 0x0043, "Lake Hylia" , "LH Lab" , ENTRANCE_GROUP_LAKE_HYLIA, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x045F, "Lake Hylia" , "Fishing Hole" , ENTRANCE_GROUP_LAKE_HYLIA, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0701, "Lake Hylia" , "LH Grotto", ENTRANCE_GROUP_LAKE_HYLIA, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0010, "Lake Hylia" , "Water Temple" , ENTRANCE_GROUP_LAKE_HYLIA, ENTRANCE_TYPE_DUNGEON, 1 },
    ...
    { 0x0801, "LH Grotto" , "Lake Hylia", ENTRANCE_GROUP_LAKE_HYLIA, ENTRANCE_TYPE_GROTTO },
    { 0x021D, "Water Temple" , "Lake Hylia" , ENTRANCE_GROUP_LAKE_HYLIA, ENTRANCE_TYPE_DUNGEON },
    ...
    { 0x0219, "GV" , "Lake Hylia", ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_OVERWORLD },
    { 0x03A0, "GV" , "Carpenters' Tent" , ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x071F, "GV" , "GV Octorok Grotto", ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x071E, "GV" , "GV Storms Grotto", ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_GROTTO, 1 },
    ...
    { 0x071D, "GF" , "GF Storms Grotto", ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0008, "GF" , "Gerudo Training Grounds" , ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_DUNGEON, 1 },
    { 0x03D0, "Carpenters' Tent" , "GV" , ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_INTERIOR },
    { 0x081F, "GV Octorok Grotto" , "GV", ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_GROTTO },
    { 0x081E, "GV Storms Grotto" , "GV", ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_GROTTO },
    { 0x081D, "GF Storms Grotto" , "GF", ENTRANCE_GROUP_GERUDO_VALLEY, ENTRANCE_TYPE_GROTTO },
    ...
    { 0x0588, "Colossus" , "Colossus Great Fairy Fountain" , ENTRANCE_GROUP_HAUNTED_WASTELAND, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0700, "Desert Colossus" , "Colossus Grotto", ENTRANCE_GROUP_HAUNTED_WASTELAND, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0082, "Desert Colossus" , "Spirit Temple" , ENTRANCE_GROUP_HAUNTED_WASTELAND, ENTRANCE_TYPE_DUNGEON, 1 },
    { 0x057C, "Colossus Great Fairy Fountain" , "Colossus" , ENTRANCE_GROUP_HAUNTED_WASTELAND, ENTRANCE_TYPE_INTERIOR },
    { 0x0800, "Colossus Grotto" , "Desert Colossus", ENTRANCE_GROUP_HAUNTED_WASTELAND, ENTRANCE_TYPE_GROTTO },
    ...
    { 0x007E, "Market Entrance" , "Guard House" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    ...
    { 0x016D, "Market" , "MK Shooting Gallery" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0507, "Market" , "Bombchu Bowling" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0063, "Market" , "Treasure Chest Game" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x043B, "Market" , "Man-in-Green's House" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0530, "Market" , "Mask Shop" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x052C, "Market" , "MK Bazaar" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0388, "Market" , "MK Potion Shop" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x0528, "Market" , "Bombchu Shop" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    ...
    { 0x0053, "Outside Temple of Time" , "Temple of Time" , ENTRANCE_GROUP_MARKET, ENTRANCE_TYPE_INTERIOR, 1 },
    ...
    { 0x0578, "HC Grounds" , "HC Great Fairy Fountain" , ENTRANCE_GROUP_HYRULE_CASTLE, ENTRANCE_TYPE_INTERIOR, 1 },
    { 0x070C, "HC Grounds" , "HC Storms Grotto", ENTRANCE_GROUP_HYRULE_CASTLE, ENTRANCE_TYPE_GROTTO, 1 },
    { 0x0340, "HC Great Fairy Fountain" , "HC Grounds" , ENTRANCE_GROUP_HYRULE_CASTLE, ENTRANCE_TYPE_INTERIOR },
    { 0x080C, "HC Storms Grotto" , "HC Grounds", ENTRANCE_GROUP_HYRULE_CASTLE, ENTRANCE_TYPE_GROTTO },
    { 0x04C2, "OGC" , "OGC Great Fairy Fountain" , ENTRANCE_GROUP_HYRULE_CASTLE, ENTRANCE_TYPE_INTERIOR, 1 },
...
void SortEntranceList(EntranceOverride* entranceList, u8 byDest) {
    ...
    // Sort Destination List by matching destination strings with source strings
    } else {
        for (size_t i = 0; i < ENTRANCE_OVERRIDES_MAX_COUNT; i++) {
            if (EntranceIsNull(&entranceList[i])) {
                break;
            }
            // Keep One Way entrances at the beginning
            if (GetEntranceData(entranceList[i].index)->group == ENTRANCE_GROUP_ONE_WAY) {
                idx++;
                continue;
            }
            for (size_t j = 0; j < ENTRANCE_OVERRIDES_MAX_COUNT; j++) {
                ...
                // Keep One Way entrances at the beginning
                if (GetEntranceData(tempList[j].index)->group == ENTRANCE_GROUP_ONE_WAY) {
                    continue;
                }
                const EntranceData* curEntrance = GetEntranceData(entranceList[i].index);
