...
typedef enum ObjectId {
    ...
    OBJECT_CUSTOM_UNBOTTLED_BIG_POE  = 0x0084,
    ...
    OBJECT_GI_BIG_POE                = 0x019A,
    OBJECT_GI_KOKIRI_EMERALD         = 0x019C,
    OBJECT_GI_GORON_RUBY             = 0x019D,
    OBJECT_GI_ZORA_SAPPHIRE          = 0x019E,
