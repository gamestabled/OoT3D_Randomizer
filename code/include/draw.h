...
#define ENTR_COLOR_OVERWORLD    RGB8(0x00, 0xFF, 0x00)
#define ENTR_COLOR_INTERIOR     RGB8(0x00, 0xA0, 0xFF)
#define ENTR_COLOR_GROTTO       RGB8(0xFF, 0x98, 0x00)
#define ENTR_COLOR_DUNGEON      RGB8(0xBB, 0x00, 0xFF)
