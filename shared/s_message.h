...
typedef enum TextControlCode {
    ...
    TEXT_CTRL_TRIFORCE_PIECE_COUNT,
    TEXT_CTRL_DEKU_SHIELD_COUNT,
    TEXT_CTRL_HYLIAN_SHIELD_COUNT,
    TEXT_CTRL_FINAL_TIME,
    TEXT_CTRL_CHECK_PERCENTAGE,
    TEXT_CTRL_SAVE_COUNT,
    TEXT_CTRL_DEATH_COUNT,
    TEXT_CTRL_HIT_COUNT,
