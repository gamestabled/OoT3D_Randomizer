...
void AreaTable_Init_SpiritTemple() {
    ...
    |    VANILLA/MQ DECIDER    |
    ---------------------------*/
    areaTable[SPIRIT_TEMPLE_ENTRYWAY] =
        Area("Spirit Temple Entryway", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
             {
                 // Exits
    ...
    if (Dungeon::SpiritTemple.IsVanilla()) {
        ...
        static constexpr auto ForEachEnemy_ChildSide = [](auto& enemyCheckFn) {
            return CanDefeatEnemies(6, 0, 1) &&
                   (enemyCheckFn(6, 0, 3, { 3 }) ||
                    ((Boomerang || Slingshot || (HasExplosives && LogicSpiritChildBombchu)) &&
                     (enemyCheckFn(6, 0, 3, { 0 }) ||
                      (CanPassEnemy(6, 0, 3, 0) &&
                       (enemyCheckFn(6, 0, 3, { 4, 5 }) ||
                        (CanDefeatEnemy(6, 0, 27, 0) && enemyCheckFn(6, 0, 2, { 5, 6 })))))));
        };
        areaTable[SPIRIT_TEMPLE_CHILD] =
            Area("Child Spirit Temple", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&DekuBabaSticks,
                                 { [] { return DekuBabaSticks || ForEachEnemy_ChildSide(CanGetDekuBabaSticks); } }),
                     EventAccess(&DekuBabaNuts,
                                 { [] { return DekuBabaNuts || ForEachEnemy_ChildSide(CanGetDekuBabaNuts); } }),
            ...
            Area("Child Spirit Temple Stalfos room before bridge", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 ...
                 },
                 {
                    ...
                    Entrance(SPIRIT_TEMPLE_CHILD_STALFOS_ROOM_AFTER_BRIDGE, { [] {
                                return CanPassEnemy(6, 0, 3, 0) && (Boomerang || Slingshot || (HasExplosives && LogicSpiritChildBombchu));
                            }
                        }),
                    Entrance(SPIRIT_TEMPLE_CHILD, { [] {
                        return CanPassEnemy(6, 0, 3, 0);}}),
                 });
        areaTable[SPIRIT_TEMPLE_CHILD_STALFOS_ROOM_AFTER_BRIDGE] =
            Area("Child Spirit Temple Stalfos room after bridge", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 ...
                 {
                    // Locations
                    LocationAccess(SPIRIT_TEMPLE_CHILD_BRIDGE_CHEST, { [] {return true;}}),
                 },
                 {
                     // Exits
                     Entrance(SPIRIT_TEMPLE_CHILD_STALFOS_ROOM_BEFORE_BRIDGE, {[]{ return CanChildDamage;}}),
                     Entrance(SPIRIT_TEMPLE_CHILD_ANUBIS_ROOM,{[]{return true;}}),
                     
                 });
        areaTable[SPIRIT_TEMPLE_CHILD_ANUBIS_ROOM] =
            Area("Child Spirit Temple Anubis room", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&DekuBabaSticks,
                                 { [] { return DekuBabaSticks || ForEachEnemy_ChildSide(CanGetDekuBabaSticks); } }),
        ...
        static constexpr auto ForEachEnemy_EarlyAdult = [](auto& enemyCheckFn) {
            return enemyCheckFn(6, 0, 0, { 2 }) ||
                   ((CanUse(BOW) || CanUse(HOOKSHOT) || CanUse(SLINGSHOT) || CanUse(BOOMERANG) || HasBombchus ||
                     (Bombs && LogicSpiritLowerAdultSwitch)) &&
                    (HoverBoots || CanJumpslash) && enemyCheckFn(6, 0, 14, {})) ||
        ...
        areaTable[SPIRIT_TEMPLE_CENTRAL_CHAMBER] = Area(
            "Spirit Temple Central Chamber", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE,
            {
                // Events
                EventAccess(&DekuBabaSticks,
                            { [] { return DekuBabaSticks || ForEachEnemy_CentralChamber(CanGetDekuBabaSticks); } }),
                EventAccess(&DekuBabaNuts,
                            { [] { return DekuBabaNuts || ForEachEnemy_CentralChamber(CanGetDekuBabaNuts); } }),
            },
            {
                // Locations
                LocationAccess(SPIRIT_TEMPLE_MAP_CHEST, { [] {
                                   return ((HasExplosives || SmallKeys(SPIRIT_TEMPLE, 3) ||
                                            (SmallKeys(SPIRIT_TEMPLE, 2) && BombchusInLogic &&
                                             ShuffleDungeonEntrances.Is(SHUFFLEDUNGEONS_OFF))) &&
                                           (CanUse(DINS_FIRE) ||
                                            (((MagicMeter && FireArrows) || LogicSpiritMapChest) && Bow && Sticks))) ||
                                          (SmallKeys(SPIRIT_TEMPLE, 5) && HasExplosives && CanUse(STICKS)) ||
                                          (SmallKeys(SPIRIT_TEMPLE, 3) &&
                                           (CanUse(FIRE_ARROWS) || (LogicSpiritMapChest && Bow)) &&
                                           CanUse(SILVER_GAUNTLETS));
                               } }),
                LocationAccess(SPIRIT_TEMPLE_SUN_BLOCK_ROOM_CHEST, { [] {
                                   return CanPassEnemy(6, 0, 8, 6, SpaceAroundEnemy::NONE) &&
                                          (((HasExplosives || SmallKeys(SPIRIT_TEMPLE, 3) ||
                                             (SmallKeys(SPIRIT_TEMPLE, 2) && BombchusInLogic &&
                                              ShuffleDungeonEntrances.Is(SHUFFLEDUNGEONS_OFF))) &&
                                            (CanUse(DINS_FIRE) ||
                ...
                LocationAccess(SPIRIT_TEMPLE_STATUE_ROOM_HAND_CHEST, { [] {
                                   return SmallKeys(SPIRIT_TEMPLE, 3) && CanUse(SILVER_GAUNTLETS) &&
                                          CanPlay(ZeldasLullaby);
                               } }),
                LocationAccess(SPIRIT_TEMPLE_STATUE_ROOM_NORTHEAST_CHEST, { [] {
                                   return SmallKeys(SPIRIT_TEMPLE, 3) && CanUse(SILVER_GAUNTLETS) &&
                                          CanPlay(ZeldasLullaby) && (Hookshot || HoverBoots);
                               } }),
                LocationAccess(SPIRIT_TEMPLE_GS_HALL_AFTER_SUN_BLOCK_ROOM, { [] {
                                   return (HasExplosives && Boomerang && Hookshot) ||
                                          (CanUse(BOOMERANG) && SmallKeys(SPIRIT_TEMPLE, 5) && HasExplosives) ||
                                          (Hookshot && CanUse(SILVER_GAUNTLETS) &&
                                           (SmallKeys(SPIRIT_TEMPLE, 3) ||
                                            (SmallKeys(SPIRIT_TEMPLE, 2) && Boomerang && BombchusInLogic &&
                                             ShuffleDungeonEntrances.Is(SHUFFLEDUNGEONS_OFF))));
                               } }),
                LocationAccess(SPIRIT_TEMPLE_GS_LOBBY, { [] {
                                   return ((HasExplosives || SmallKeys(SPIRIT_TEMPLE, 3) ||
                                            (SmallKeys(SPIRIT_TEMPLE, 2) && BombchusInLogic &&
                                             ShuffleDungeonEntrances.Is(SHUFFLEDUNGEONS_OFF))) &&
                                           LogicSpiritLobbyGS && Boomerang && (Hookshot || HoverBoots)) ||
                                          (LogicSpiritLobbyGS && SmallKeys(SPIRIT_TEMPLE, 5) && HasExplosives &&
                                           CanUse(BOOMERANG)) ||
                                          (SmallKeys(SPIRIT_TEMPLE, 3) && CanUse(SILVER_GAUNTLETS) &&
                                           (Hookshot || HoverBoots));
                               } }),
            },
            {
                ...
                Entrance(SPIRIT_TEMPLE_OUTDOOR_HANDS,
                         { [] { return CanDefeatEnemy(6, 0, 10, 0) && CanDefeatEnemy(6, 0, 20, 0); } }),
        ...
        areaTable[SPIRIT_TEMPLE_OUTDOOR_HANDS] = Area(
            "Spirit Temple Outdoor Hands", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
            {
                ...
                LocationAccess(SPIRIT_TEMPLE_SILVER_GAUNTLETS_CHEST, { [] {
                                   return (SmallKeys(SPIRIT_TEMPLE, 3) && CanDefeatEnemies(6, 0, 17) && Longshot) ||
                                          SmallKeys(SPIRIT_TEMPLE, 5);
                               } }),
                LocationAccess(SPIRIT_TEMPLE_MIRROR_SHIELD_CHEST, { [] {
                                   return SmallKeys(SPIRIT_TEMPLE, 4) && CanDefeatEnemies(6, 0, 17) &&
                                          CanUse(SILVER_GAUNTLETS);
                               } }),
            },
            {
        ...
        static constexpr auto ForEachEnemy_BeyondCentralLockedDoor = [](auto& enemyCheckFn) {
            return enemyCheckFn(6, 0, 16, {}) || enemyCheckFn(6, 0, 18, {});
        };
            ...
            Area("Spirit Temple Beyond Central Locked Door", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&DekuBabaSticks, { [] {
                         return DekuBabaSticks || ForEachEnemy_BeyondCentralLockedDoor(CanGetDekuBabaSticks);
                     } }),
                     EventAccess(&DekuBabaNuts, { [] {
                         return DekuBabaNuts || ForEachEnemy_BeyondCentralLockedDoor(CanGetDekuBabaNuts);
                     } }),
                 },
                 {
                     // Locations
                     LocationAccess(SPIRIT_TEMPLE_NEAR_FOUR_ARMOS_CHEST, { [] {
                                        return (MirrorShield || (ExtraArrowEffects && CanUse(LIGHT_ARROWS))) &&
                                               CanDefeatEnemies(6, 0, 17);
                                    } }),
                     LocationAccess(SPIRIT_TEMPLE_HALLWAY_LEFT_INVISIBLE_CHEST, { [] {
                                        return CanDefeatEnemies(6, 0, 17) && (LogicLensSpirit || CanUse(LENS_OF_TRUTH));
                                    } }),
                     ...
                     Entrance(SPIRIT_TEMPLE_BEYOND_FINAL_LOCKED_DOOR, { [] {
                                  return SmallKeys(SPIRIT_TEMPLE, 5) &&
                                         (LogicSpiritWall || CanUse(LONGSHOT) ||
                                          (CanPassEnemies(6, 0, 23, {}, SpaceAroundEnemy::NARROW) &&
                                           (!Settings::Enemizer && SoulSkulltula &&
                                            (HasBombchus || Bow || CanUse(HOOKSHOT) || Hammer))));
                              } }),
                 });

        static constexpr auto ForEachEnemy_BeyondFinalLockedDoor = [](auto& enemyCheckFn) {
            return enemyCheckFn(6, 0, 22, {}) || enemyCheckFn(6, 0, 25, {}) || enemyCheckFn(6, 0, 26, { 0, 1, 2, 3 }) ||
                   ((HasExplosives || CanDetonateAnyEnemy(6, 0, 26, { 0, 1, 2 })) && enemyCheckFn(6, 0, 26, { 4 }));
        };
        areaTable[SPIRIT_TEMPLE_BEYOND_FINAL_LOCKED_DOOR] = Area(
            "Spirit Temple Beyond Final Locked Door", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE,
            {
                // Events
                EventAccess(&DekuBabaSticks, { [] {
                    return DekuBabaSticks || ForEachEnemy_BeyondFinalLockedDoor(CanGetDekuBabaSticks);
                } }),
                EventAccess(&DekuBabaNuts,
                            { [] { return DekuBabaNuts || ForEachEnemy_BeyondFinalLockedDoor(CanGetDekuBabaNuts); } }),
            },
            {
                // Locations
            ...
            },
            {
                ...
                Entrance(SPIRIT_TEMPLE_INSIDE_STATUE_HEAD, { [] {
                             return (HasExplosives || CanDetonateAnyEnemy(6, 0, 26, { 0, 1, 2 })) && MirrorShield &&
                                    Hookshot;
                         } }),
            });
    ...
    if (Dungeon::SpiritTemple.IsMQ()) {
        areaTable[SPIRIT_TEMPLE_MQ_LOBBY] = Area(
            "Spirit Temple MQ Lobby", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
            {
                // Locations
                LocationAccess(SPIRIT_TEMPLE_MQ_ENTRANCE_FRONT_LEFT_CHEST, { [] { return true; } }),
                LocationAccess(SPIRIT_TEMPLE_MQ_ENTRANCE_BACK_LEFT_CHEST, { [] {
                                   return Here(SPIRIT_TEMPLE_MQ_LOBBY, [] { return CanBlastOrSmash; }) &&
                                          ((IsChild && CanUse(SLINGSHOT)) || (IsAdult && CanUse(BOW)));
                               } }),
                LocationAccess(SPIRIT_TEMPLE_MQ_ENTRANCE_BACK_RIGHT_CHEST, { [] {
                                   return HasBombchus || (IsAdult && (CanUse(BOW) || CanUse(HOOKSHOT))) ||
                                          (IsChild && (CanUse(SLINGSHOT) || CanUse(BOOMERANG)));
                               } }),
            },
            {
                // Exits
                ...
                Entrance(SPIRIT_TEMPLE_MQ_ADULT,
                         { [] { return HasBombchus && IsAdult && CanUse(LONGSHOT) && CanUse(SILVER_GAUNTLETS); } }),
            });

        areaTable[SPIRIT_TEMPLE_MQ_CHILD] =
            Area("Spirit Temple MQ Child", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                 ...
                 {
                     // Locations
                     LocationAccess(SPIRIT_TEMPLE_MQ_CHILD_HAMMER_SWITCH_CHEST, { [] {
                                        return Here(SPIRIT_TEMPLE_MQ_ADULT,
                                                    [] { return SmallKeys(SPIRIT_TEMPLE, 7) && Hammer; });
                                    } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_MAP_ROOM_ENEMY_CHEST,
                                    { [] { return KokiriSword && HasBombchus && Slingshot && CanUse(DINS_FIRE); } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_MAP_CHEST, { [] { return KokiriSword || Bombs; } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_SILVER_BLOCK_HALLWAY_CHEST, { [] {
                                        return HasBombchus && SmallKeys(SPIRIT_TEMPLE, 7) && Slingshot &&
                                               (CanUse(DINS_FIRE) || (Here(SPIRIT_TEMPLE_MQ_ADULT, [] {
                                                    return IsAdult && CanUse(FIRE_ARROWS);
                                                })));
                                    } }),
                     // Trick: HasBombchus && SmallKeys(SPIRIT_TEMPLE, 7) && Slingshot && (CanUse(DINS_FIRE) ||
                     // (SPIRIT_TEMPLE_MQ_ADULT.Adult() && IsAdult && (CanUse(FIRE_ARROWS) || (LogicSpiritMQFrozenEye &&
                     // CanUse(BOW) && CanPlay(SongOfTime)))))
                 },
                 {
                     // Exits
        ...
        areaTable[SPIRIT_TEMPLE_MQ_ADULT] =
            Area("Spirit Temple MQ Adult", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     ...
                     LocationAccess(SPIRIT_TEMPLE_MQ_CHEST_SWITCH_CHEST,
                                    { [] { return SmallKeys(SPIRIT_TEMPLE, 5) && CanPlay(SongOfTime); } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_BOSS_KEY_CHEST, { [] {
                                        return SmallKeys(SPIRIT_TEMPLE, 5) && CanPlay(SongOfTime) &&
                                               (MirrorShield || (ExtraArrowEffects && CanUse(LIGHT_ARROWS)));
                                    } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_GS_NINE_THRONES_ROOM_WEST,
                                    { [] { return SmallKeys(SPIRIT_TEMPLE, 7); } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_GS_NINE_THRONES_ROOM_NORTH,
                                    { [] { return SmallKeys(SPIRIT_TEMPLE, 7); } }),
                 },
                 {
                     // Exits
                     Entrance(SPIRIT_TEMPLE_MQ_LOWER_ADULT, { [] {
                                  return (MirrorShield || (ExtraArrowEffects && CanUse(LIGHT_ARROWS))) && IsAdult &&
                                         CanUse(FIRE_ARROWS);
                              } }),
                     // Trick: MirrorShield && IsAdult && (CanUse(FIRE_ARROWS) || (LogicSpiritMQLowerAdult &&
                     // CanUse(DINS_FIRE) && Bow))
                     Entrance(SPIRIT_TEMPLE_MQ_SHARED, { [] { return true; } }),
                     Entrance(SPIRIT_TEMPLE_MQ_BOSS_AREA,
                              { [] { return SmallKeys(SPIRIT_TEMPLE, 6) && CanPlay(ZeldasLullaby) && Hammer; } }),
                     Entrance(SPIRIT_TEMPLE_MQ_MIRROR_SHIELD_HAND, { [] {
                                  return SmallKeys(SPIRIT_TEMPLE, 5) && CanPlay(SongOfTime) && CanJumpslash &&
                                         (LogicLensSpiritMQ || CanUse(LENS_OF_TRUTH));
                              } }),
                 });

        areaTable[SPIRIT_TEMPLE_MQ_SHARED] =
            Area("Spirit Temple MQ Shared", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(SPIRIT_TEMPLE_MQ_CHILD_CLIMB_NORTH_CHEST,
                                    { [] { return SmallKeys(SPIRIT_TEMPLE, 6); } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_COMPASS_CHEST, { [] {
                                        return (IsChild && CanUse(SLINGSHOT) && SmallKeys(SPIRIT_TEMPLE, 7)) ||
                                               (IsAdult && CanUse(BOW)) || (Bow && Slingshot);
                                    } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_SUN_BLOCK_ROOM_CHEST,
                                    { [] { return CanPlay(SongOfTime) || IsAdult; } }),
                     ...
                     // Trick: (LogicSpiritMQSunBlockGS && Boomerange && (CanPlay(SongOfTime) ||
                     // LogicSpiritMQSunBlockSoT)) || IsAdult
                 },
                 {
                     // Exits
        ...
        areaTable[SPIRIT_TEMPLE_MQ_LOWER_ADULT] =
            Area("Spirit Temple MQ Lower Adult", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(SPIRIT_TEMPLE_MQ_LEEVER_ROOM_CHEST, { [] { return true; } }),
                     LocationAccess(SPIRIT_TEMPLE_MQ_SYMPHONY_ROOM_CHEST, { [] {
                                        return SmallKeys(SPIRIT_TEMPLE, 7) && Hammer && Ocarina && SongOfTime &&
                                               EponasSong && SunsSong && SongOfStorms && ZeldasLullaby;
                                    } }),
                     ...
                     LocationAccess(SPIRIT_TEMPLE_MQ_GS_SYMPHONY_ROOM, { [] {
                                        return SmallKeys(SPIRIT_TEMPLE, 7) && Hammer && Ocarina && SongOfTime &&
                                               EponasSong && SunsSong && SongOfStorms && ZeldasLullaby;
                                    } }),
                 },
        ...
        areaTable[SPIRIT_TEMPLE_MQ_SILVER_GAUNTLETS_HAND] =
            Area("Spirit Temple MQ Silver Gauntlets Hand", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
    ...
    areaTable[SPIRIT_TEMPLE_BOSS_ROOM] = Area(
        "Spirit Temple Boss Room", "Spirit Temple", NONE, NO_DAY_NIGHT_CYCLE,
        {
            ...
            EventAccess(&SpiritTempleClear, { [] {
                return SpiritTempleClear || (CanDefeatEnemy(23, 0, 1, 0) && SoulTwinrova && CanUse(MIRROR_SHIELD) &&
