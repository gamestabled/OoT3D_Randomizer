...
void AreaTable_Init_WaterTemple() {
    ...
    |    VANILLA/MQ DECIDER    |
    ---------------------------*/
    areaTable[WATER_TEMPLE_ENTRYWAY] =
        Area("Water Temple Entryway", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
             {
                 // Exits
    ...
    if (Dungeon::WaterTemple.IsVanilla()) {
        ...
        areaTable[WATER_TEMPLE_LOBBY] = Area(
            ...
            {},
            {
                ...
                Entrance(WATER_TEMPLE_EAST_LOWER,
                         { [] {
                              return WaterTempleLow ||
                                     ((LogicFewerTunicRequirements || CanUse(ZORA_TUNIC)) &&
                                      (CanUse(IRON_BOOTS) || (CanUse(LONGSHOT) && LogicWaterTempleTorchLongshot)));
                          },
                           /*Glitched*/
                           [] {
                               return ((Bugs || Fish) && CanUse(HOVER_BOOTS) &&
                ...
                Entrance(WATER_TEMPLE_NORTH_LOWER, { [] {
                             return WaterTempleLow ||
                                    ((LogicFewerTunicRequirements || CanUse(ZORA_TUNIC)) && CanUse(IRON_BOOTS));
                         } }),
                Entrance(WATER_TEMPLE_SOUTH_LOWER,
                         { [] {
                           ...
                           /*Glitched*/
                           [] {
                               return CanUse(IRON_BOOTS) && (WaterTempleMiddle || WaterTempleHigh) &&
                                      (LogicFewerTunicRequirements || CanUse(ZORA_TUNIC)) &&
                                      AdultCanAccess(WATER_TEMPLE_WEST_LOWER) &&
                                      CanDoGlitch(GlitchType::LedgeClip, GlitchDifficulty::INTERMEDIATE);
                           } }),
                Entrance(WATER_TEMPLE_WEST_LOWER, { [] {
                             return WaterTempleLow && GoronBracelet && (IsChild || CanDive || CanUse(IRON_BOOTS)) &&
                                    (LogicFewerTunicRequirements || CanUse(ZORA_TUNIC));
                         } }),
                Entrance(WATER_TEMPLE_CENTRAL_PILLAR_LOWER,
                         { [] { return WaterTempleLow && SmallKeys(WATER_TEMPLE, 5); } }),
                Entrance(WATER_TEMPLE_CENTRAL_PILLAR_UPPER, { [] {
                ...
                Entrance(WATER_TEMPLE_HIGH_WATER,
                         { [] {
                              return IsAdult &&
                                     (CanUse(HOVER_BOOTS) || (LogicWaterTempleUpperBoost && Bombs && CanTakeDamage));
                          },
                           /*Glitched*/
                           [] {
                               return CanDoGlitch(GlitchType::HoverBoost, GlitchDifficulty::INTERMEDIATE) ||
                                      (Bombs && HasBombchus &&
                                       CanDoGlitch(GlitchType::BombHover, GlitchDifficulty::NOVICE) &&
                                       CanDoGlitch(GlitchType::ISG, GlitchDifficulty::INTERMEDIATE));
                           } }),
                Entrance(WATER_TEMPLE_BLOCK_CORRIDOR,
                         { [] {
                              return (WaterTempleLow || WaterTempleMiddle) && (CanUse(SLINGSHOT) || CanUse(BOW)) &&
                                     (CanUse(LONGSHOT) || CanUse(HOVER_BOOTS) ||
                                      (LogicWaterCentralBow && (IsAdult || WaterTempleMiddle)));
                          },
                           /*Glitched*/
                           [] {
                               return (WaterTempleLow || WaterTempleMiddle) && IsAdult &&
                                      CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::INTERMEDIATE);
                           } }),
                Entrance(WATER_TEMPLE_FALLING_PLATFORM_ROOM,
                         { [] { return WaterTempleHigh && SmallKeys(WATER_TEMPLE, 4); },
                           /*Glitched*/
                           [] {
                               return SmallKeys(WATER_TEMPLE, 4) &&
                                      (CanDoGlitch(GlitchType::HoverBoost, GlitchDifficulty::INTERMEDIATE) ||
                                       CanDoGlitch(GlitchType::HammerSlide, GlitchDifficulty::NOVICE));
                           } }),
                Entrance(WATER_TEMPLE_PRE_BOSS_ROOM,
        ...
        areaTable[WATER_TEMPLE_EAST_LOWER] =
            Area("Water Temple East Lower", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&WaterTempleLow,
                                 { [] { return WaterTempleLow || CanPlay(ZeldasLullaby); },
                                   /*Glitched*/
                                   [] {
                                       return ZeldasLullaby &&
                                              (CanDoGlitch(GlitchType::DungeonBombOI, GlitchDifficulty::INTERMEDIATE) ||
                                               ((Bugs || Fish) && CanShield &&
                                                ((Bombs && CanDoGlitch(GlitchType::QPA, GlitchDifficulty::ADVANCED)) ||
                                                 (HasBombchus &&
                 ...
                 {},
                 {
                     ...
                     Entrance(WATER_TEMPLE_CRACKED_WALL,
                              { [] {
                                   return WaterTempleMiddle || (WaterTempleHigh && WaterTempleLow &&
                                                                ((CanUse(HOVER_BOOTS) && LogicWaterCrackedWallHovers) ||
                                                                 LogicWaterCrackedWallNothing));
                               },
                                /*Glitched*/
                                [] {
                                    return WaterTempleHigh && WaterTempleLow &&
                                           CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE);
                                } }),
                     Entrance(WATER_TEMPLE_TORCH_ROOM,
            ...
            Area("Water Temple North Lower", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     ...
                     Entrance(WATER_TEMPLE_BOULDERS_LOWER,
                              { [] {
                                   return (CanUse(LONGSHOT) || (LogicWaterBossKeyRegion && CanUse(HOVER_BOOTS))) &&
                                          SmallKeys(WATER_TEMPLE, 4);
                               },
                                /*Glitched*/
                                [] {
        ...
        areaTable[WATER_TEMPLE_BLOCK_ROOM] = Area(
            ...
            {},
            {
                // Exits
                Entrance(WATER_TEMPLE_BOULDERS_LOWER,
                         { [] { return (GoronBracelet && HasExplosives) || CanUse(HOOKSHOT); } }),
                Entrance(WATER_TEMPLE_JETS_ROOM,
                         { [] { return (GoronBracelet && HasExplosives) || (CanUse(HOOKSHOT) && CanUse(HOVER_BOOTS)); },
                           /*Glitched*/
                           [] {
        ...
        areaTable[WATER_TEMPLE_BOULDERS_UPPER] =
            Area("Water Temple Boulders Upper", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 ...
                 {},
                 {
                     ...
                     Entrance(WATER_TEMPLE_BOSS_KEY_ROOM, { [] {
                                  return (CanUse(IRON_BOOTS) || (IsAdult && LogicWaterBKJumpDive)) &&
                                         SmallKeys(WATER_TEMPLE, 5);
                              } }),
                 });

        areaTable[WATER_TEMPLE_BOSS_KEY_ROOM] = Area(
            "Water Temple Boss Key Room", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
            {
                // Events
            ...
            Area("Water Temple South Lower", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 ...
                 },
                 {
                     ...
                     LocationAccess(WATER_TEMPLE_GS_BEHIND_GATE,
                                    { [] {
                                         return CanUse(HOOKSHOT) ||
                                                (IsAdult && (CanJumpslash || CanUseProjectile) && CanUse(HOVER_BOOTS));
                                     },
                                      /*Glitched*/
                                      [] {
                                          return (CanUse(BOOMERANG) && CanDoGlitch(GlitchType::HoverBoost,
        ...
        areaTable[WATER_TEMPLE_WEST_LOWER] =
            Area("Water Temple West Lower", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 ...
                 {},
                 {
                     // Exits
                     Entrance(WATER_TEMPLE_LOBBY,
                              { [] { return CanUse(HOOKSHOT) && CanUse(IRON_BOOTS) && GoronBracelet; },
                                /*Glitched*/
                                [] {
                                    return CanUse(IRON_BOOTS) && (LogicFewerTunicRequirements || CanUse(ZORA_TUNIC)) &&
                                           CanDoGlitch(GlitchType::LedgeClip, GlitchDifficulty::INTERMEDIATE);
                                } }),
        ...
        areaTable[WATER_TEMPLE_CENTRAL_PILLAR_LOWER] =
            Area("Water Temple Central Pillar Lower", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
        ...
        areaTable[WATER_TEMPLE_CENTRAL_PILLAR_UPPER] =
            Area("Water Temple Central Pillar Upper", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&WaterTempleMiddle,
                                 { [] { return WaterTempleMiddle || CanPlay(ZeldasLullaby); },
                                   /*Glitched*/
                                   [] {
                                       return ZeldasLullaby &&
                                              (CanDoGlitch(GlitchType::DungeonBombOI, GlitchDifficulty::INTERMEDIATE) ||
                 ...
                 {
                     // Locations
                     LocationAccess(WATER_TEMPLE_GS_CENTRAL_PILLAR, { [] {
                                        return CanUse(LONGSHOT) || (LogicWaterCentralGSFW && WaterTempleHigh &&
                                                                    CanUse(FARORES_WIND) && HookshotOrBoomerang);
                                    } }),
                 },
                 {
                     // Exits
        ...
        areaTable[WATER_TEMPLE_HIGH_WATER] =
            Area("Water Temple High Water", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&WaterTempleHigh,
                                 { [] { return WaterTempleHigh || CanPlay(ZeldasLullaby); },
                                   /*Glitched*/
                                   [] {
                                       return ZeldasLullaby &&
                                              (CanDoGlitch(GlitchType::DungeonBombOI, GlitchDifficulty::INTERMEDIATE) ||
        ...
        areaTable[WATER_TEMPLE_BLOCK_CORRIDOR] = Area(
            "Water Temple Block Corridor", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
            {
                // Locations
                LocationAccess(WATER_TEMPLE_CENTRAL_BOW_TARGET_CHEST,
                               { [] { return GoronBracelet && (WaterTempleLow || WaterTempleMiddle); },
                                 /*Glitched*/
                                 [] {
                                     return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::INTERMEDIATE) &&
                                            (WaterTempleLow || WaterTempleMiddle);
                                 } }),
            },
            {
                // Exits
        ...
        areaTable[WATER_TEMPLE_DARK_LINK_ROOM] =
        ...
        areaTable[WATER_TEMPLE_LONGSHOT_ROOM] =
            Area("Water Temple Longshot Room", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
        ...
        areaTable[WATER_TEMPLE_RIVER] =
            Area("Water Temple River", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(WATER_TEMPLE_RIVER_CHEST, { [] {
                                        return (CanUse(SLINGSHOT) || CanUse(BOW)) &&
                                               (IsAdult || CanUse(HOVER_BOOTS) || CanUse(HOOKSHOT));
                                    } }),
                     LocationAccess(WATER_TEMPLE_GS_RIVER, { [] {
                                        return (CanUse(IRON_BOOTS) && CanUse(HOOKSHOT)) ||
                                               (LogicWaterRiverGS && CanUse(LONGSHOT));
                                    } }),
                     LocationAccess(WATER_TEMPLE_RIVER_HEART_1, { [] { return (true); } }),
                     LocationAccess(WATER_TEMPLE_RIVER_HEART_2, { [] { return (true); } }),
                     LocationAccess(WATER_TEMPLE_RIVER_HEART_3, { [] { return (true); } }),
                     LocationAccess(WATER_TEMPLE_RIVER_HEART_4, { [] { return (true); } }),
                 },
                 {
                     // Exits
                     Entrance(WATER_TEMPLE_DRAGON_ROOM, { [] {
                                  return (CanUse(SLINGSHOT) || CanUse(BOW)) &&
                                         (IsAdult || CanUse(HOVER_BOOTS) || CanUse(HOOKSHOT));
                              } }),
                 });

        areaTable[WATER_TEMPLE_PRE_BOSS_ROOM] =
            Area("Water Temple Pre Boss Room", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&FairyPot, { [] { return true; } }),
                 },
    ...
    if (Dungeon::WaterTemple.IsMQ()) {
        ...
        areaTable[WATER_TEMPLE_MQ_DIVE] =
            Area("Water Temple MQ Dive", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(WATER_TEMPLE_MQ_MAP_CHEST,
                                    { [] { return HasFireSource && IsAdult && CanUse(HOOKSHOT); } }),
                     LocationAccess(WATER_TEMPLE_MQ_CENTRAL_PILLAR_CHEST, { [] {
                                        return IsAdult && CanUse(ZORA_TUNIC) && CanUse(HOOKSHOT) &&
                                               (CanUse(DINS_FIRE) && CanPlay(SongOfTime));
                                    } }),
                     // Trick: IsAdult && CanUse(ZORA_TUNIC) && CanUse(HOOKSHOT) && ((LogicWaterMQCentralPillar &&
                     // CanUse(FIRE_ARROWS)) || (CanUse(DINS_FIRE) && CanPlay(SongOfTime)))
                 },
                 {
                     // Exits
        ...
        areaTable[WATER_TEMPLE_MQ_LOWERED_WATER_LEVELS] =
            Area("Water Temple MQ Lowered Water Levels", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(WATER_TEMPLE_MQ_COMPASS_CHEST, { [] {
                                        return ((IsAdult && CanUse(BOW)) || CanUse(DINS_FIRE) ||
                                                Here(WATER_TEMPLE_MQ_LOBBY,
                                                     [] { return IsChild && CanUse(STICKS) && HasExplosives; })) &&
                     ...
                     LocationAccess(WATER_TEMPLE_MQ_GS_BEFORE_UPPER_WATER_SWITCH,
                                    { [] { return IsAdult && CanUse(LONGSHOT); } }),
                 },
                 {});

        areaTable[WATER_TEMPLE_MQ_DARK_LINK_REGION] = Area(
            "Water Temple MQ Dark Link Region", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE,
            {
                // Events
                EventAccess(&FairyPot, { [] { return true; } }),
