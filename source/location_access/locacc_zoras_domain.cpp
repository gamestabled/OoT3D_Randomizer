...
void AreaTable_Init_ZorasDomain() {
    areaTable[ZR_FRONT] = Area(
        "ZR Front", "Zora River", ZORAS_RIVER, DAY_NIGHT_CYCLE, {}, {},
        {
            ...
            Entrance(ZORAS_RIVER,
                     { [] { return IsAdult || CanBlastOrSmash; },
                       /*Glitched*/
    ...
    areaTable[ZORAS_RIVER] = Area(
        ...
        },
        {
            ...
            LocationAccess(ZR_FROGS_OCARINA_GAME,
                           { [] {
                             ...
                             /*Glitched*/
                             [] {
                                 return (CanDoGlitch(GlitchType::OutdoorBombOI, GlitchDifficulty::ADVANCED) ||
                                         ((Bugs || Fish) && CanShield &&
                                        ...
                                        IsChild && ZeldasLullaby && SariasSong && SunsSong && EponasSong &&
                                        SongOfTime && SongOfStorms;
                             } }),
            LocationAccess(ZR_FROGS_IN_THE_RAIN,
                           { [] { return IsChild && CanPlay(SongOfStorms); },
                             /*Glitched*/
                             [] {
                                 return (CanDoGlitch(GlitchType::OutdoorBombOI, GlitchDifficulty::ADVANCED) ||
                                         ((Bugs || Fish) && CanShield &&
                                         ...
                                         ((Bugs || Fish) && CanShield && HasBombchus &&
                                          CanDoGlitch(GlitchType::ActionSwap, GlitchDifficulty::ADVANCED))) &&
                                        IsChild && SongOfStorms;
                             } }),
            LocationAccess(ZR_FROGS_ZELDAS_LULLABY,
                           { [] { return IsChild && CanPlay(ZeldasLullaby); },
                             /*Glitched*/
                             [] {
                                 return (CanDoGlitch(GlitchType::OutdoorBombOI, GlitchDifficulty::ADVANCED) ||
                                         ((Bugs || Fish) && CanShield &&
            ...
            LocationAccess(ZR_FROGS_EPONAS_SONG,
                           { [] { return IsChild && CanPlay(EponasSong); },
                             /*Glitched*/
                             [] {
                                 return (CanDoGlitch(GlitchType::OutdoorBombOI, GlitchDifficulty::ADVANCED) ||
                                         ((Bugs || Fish) && CanShield &&
            ...
            LocationAccess(ZR_FROGS_SARIAS_SONG,
            ...
            LocationAccess(ZR_FROGS_SUNS_SONG,
                           { [] { return IsChild && CanPlay(SunsSong); },
                             /*Glitched*/
                             [] {
                                 return (CanDoGlitch(GlitchType::OutdoorBombOI, GlitchDifficulty::ADVANCED) ||
                                         ((Bugs || Fish) && CanShield &&
            ...
            LocationAccess(ZR_FROGS_SONG_OF_TIME,
            ...
            LocationAccess(ZR_NEAR_OPEN_GROTTO_FREESTANDING_POH,
            ...
            LocationAccess(ZR_WATERFALL_RED_RUPEE_1, { [] { return IsAdult && (CanUse(IRON_BOOTS) && CanSurviveUnderwaterFor(4,12)) || LogicZoraRiverRupeesJump; } }),
            LocationAccess(ZR_WATERFALL_RED_RUPEE_2, { [] { return IsAdult && (CanUse(IRON_BOOTS) && CanSurviveUnderwaterFor(4,12)) || LogicZoraRiverRupeesJump; } }),
            LocationAccess(ZR_WATERFALL_RED_RUPEE_3, { [] { return IsAdult && (CanUse(IRON_BOOTS) && CanSurviveUnderwaterFor(4,12)) || LogicZoraRiverRupeesJump; } }),
            LocationAccess(ZR_WATERFALL_RED_RUPEE_4, { [] { return IsAdult && (CanUse(IRON_BOOTS) && CanSurviveUnderwaterFor(4,12)) || LogicZoraRiverRupeesJump; } }),
        ...
        },
        {
            ...
            Entrance(ZR_FAIRY_GROTTO, { [] { return Here(ZORAS_RIVER, [] { return CanBlastOrSmash; }); },
                                        /*Glitched*/
                                        [] {
                                            return Here(ZORAS_RIVER, [] {
                                                return CanUse(STICKS) &&
                                                       CanDoGlitch(GlitchType::QPA, GlitchDifficulty::ADVANCED);
                                            });
                                        } }),
            Entrance(THE_LOST_WOODS,
                     { [] { return CanDive || CanUse(IRON_BOOTS); },
                       /*Glitched*/
                       [] {
    ...
    areaTable[ZORAS_DOMAIN] = Area(
        "Zoras Domain", "Zoras Domain", ZORAS_DOMAIN, NO_DAY_NIGHT_CYCLE,
        {
            // Events
            EventAccess(&EyeballFrogAccess, { [] {
                return EyeballFrogAccess ||
                       (IsAdult && KingZoraThawed && (Eyedrops || EyeballFrog || Prescription || PrescriptionAccess));
            } }),
            ...
            EventAccess(&DeliverLetter, { [] {
                return DeliverLetter || (RutosLetter && IsChild && ZorasFountain.IsNot(ZORASFOUNTAIN_OPEN));
            } }),
        },
        {
            // Locations
        ...
        },
        {
            ...
            Entrance(LAKE_HYLIA, { [] { return IsChild && (CanDive || CanUse(IRON_BOOTS)); },
                                   /*Glitched*/
                                   [] {
                                       return (IsAdult && CanJumpslash && GlitchZDOoBJumpSlash) ||
                                              (IsChild && CanUse(FARORES_WIND) &&
                                               (FaroresWindAnywhere ||
                                                (CanDoGlitch(GlitchType::RestrictedItems, GlitchDifficulty::NOVICE) &&
                                                 (HasBottle || WeirdEgg))) &&
                                               ((CanUse(NAYRUS_LOVE) &&
            ...
            Entrance(ZD_BEHIND_KING_ZORA,
                     { [] {
                          return DeliverLetter || ZorasFountain.Is(ZORASFOUNTAIN_OPEN) ||
                                 (ZorasFountain.Is(ZORASFOUNTAIN_ADULT) && IsAdult);
                      },
                       /*Glitched*/
                       [] {
                           return ((IsChild || CanUse(IRON_BOOTS)) &&
                                   CanDoGlitch(GlitchType::TripleSlashClip, GlitchDifficulty::NOVICE)) ||
                                  CanDoGlitch(GlitchType::ASlide, GlitchDifficulty::NOVICE) ||
    ...
    areaTable[ZD_BEHIND_KING_ZORA] = Area(
        "ZD Behind King Zora", "Zoras Domain", NONE, NO_DAY_NIGHT_CYCLE, {}, {},
        {
            // Exits
    ...
    areaTable[ZORAS_FOUNTAIN] = Area(
        ...
        },
        {
            ...
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_1,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_2,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_3,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_4,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_5,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_6,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_7,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_8,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_9,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_10,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_11,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_12,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_13,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_14,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_15,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_16,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_17,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
            LocationAccess(ZF_UNDERWATER_GREEN_RUPEE_18,
                           { [] { return IsAdult && IronBoots && CanSurviveUnderwaterFor(24); } }),
        ...
        },
        {
            ...
            Entrance(JABU_JABUS_BELLY_ENTRYWAY, { [] { return IsChild && (Fish || OpenJabu); },
                                                  /*Glitched*/
                                                  [] {
                                                      return (IsChild && CanUse(STICKS) && GlitchJabuStickRecoil) ||
                                                             (IsAdult && GlitchJabuAdult);
                                                  } }),
            Entrance(
                ICE_CAVERN_ENTRYWAY,
                { [] { return IsAdult; },
                  /*Glitched*/ [] { return CanDoGlitch(GlitchType::BombHover, GlitchDifficulty::INTERMEDIATE); } }),
            Entrance(ZF_GREAT_FAIRY_FOUNTAIN,
                     { [] { return HasExplosives || (CanUse(SILVER_GAUNTLETS) && Hammer && LogicZFGreatFairy); },
                       /*Glitched*/
                       [] {
                           return IsChild && CanJumpslash && CanShield &&
                                  (CanDoGlitch(GlitchType::SeamWalk, GlitchDifficulty::ADVANCED) ||
