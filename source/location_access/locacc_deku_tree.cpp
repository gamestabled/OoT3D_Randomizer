    ...
    if (Dungeon::DekuTree.IsVanilla()) {
        ...
        areaTable[DEKU_TREE_LOBBY] = Area(
            ...
            },
            {
                ...
                LocationAccess(DEKU_TREE_3F_FLOATING_HEART, { [] { return CanPassEnemies(0, 0, 0, { 0, 1, 2 }, SpaceAroundEnemy::NARROW) && CanPassAnyEnemy(0, 0, 0, { 3, 4, 5 });}}),
            },
            {
                // Exits
                 ...
                 EventAccess(&DekuTreeClear,
                             { [] {
                                  return DekuTreeClear ||
                                         (SoulGohma && CanJumpslash &&
                                          (Nuts || CanUse(SLINGSHOT) || CanUse(BOW) || HookshotOrBoomerang));
                              },
                               /*Glitched*/
                               [] { return SoulGohma && CanDoGlitch(GlitchType::ISG, GlitchDifficulty::NOVICE); } }),
             },
             {
                 // Locations
