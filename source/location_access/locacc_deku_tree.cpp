...
void AreaTable_Init_DekuTree() {
    ...
    |    VANILLA/MQ DECIDER    |
    ---------------------------*/
    areaTable[DEKU_TREE_ENTRYWAY] =
        Area("Deku Tree Entryway", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {},
             {
                 // Exits
    ...
    if (Dungeon::DekuTree.IsVanilla()) {
        areaTable[DEKU_TREE_LOBBY] = Area(
            ...
            },
            {
                ...
                Entrance(DEKU_TREE_BASEMENT_LOWER, { [] {
                             return Here(DEKU_TREE_LOBBY, [] { return CanAdultAttack || CanChildAttack || Nuts; });
                         } }),
                ...
                Entrance(DEKU_TREE_BOSS_ROOM, { [] { return false; },
                                                /*Glitched*/
                                                [] {
                                                    return IsChild && (CanUse(KOKIRI_SWORD) || CanUse(MASTER_SWORD)) &&
                                                           Nuts &&
                                                           CanDoGlitch(GlitchType::SeamWalk, GlitchDifficulty::EXPERT);
                                                } }),
            });
        ...
        areaTable[DEKU_TREE_2F_MIDDLE_ROOM] = Area(
            "Deku Tree 2F Middle Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {},
            {
                ...
                Entrance(DEKU_TREE_LOBBY, { [] {
                             return Here(DEKU_TREE_2F_MIDDLE_ROOM, [] { return HasShield || CanUse(MEGATON_HAMMER); });
                         } }),
            ...
            Area("Deku Tree Slingshot Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {},
                 ...
                 },
                 {
                     ...
                     Entrance(DEKU_TREE_2F_MIDDLE_ROOM,
                              { [] { return CanUse(SLINGSHOT) || CanUse(HOVER_BOOTS); },
                                /*Glitched*/
                                [] {
        ...
        areaTable[DEKU_TREE_COMPASS_ROOM] = Area(
        ...
        areaTable[DEKU_TREE_BASEMENT_LOWER] = Area(
            ...
            },
            {
                ...
                Entrance(DEKU_TREE_BASEMENT_SCRUB_ROOM, { [] {
                             return Here(DEKU_TREE_BASEMENT_LOWER,
        ...
        areaTable[DEKU_TREE_BASEMENT_SCRUB_ROOM] =
            Area("Deku Tree Basement Scrub Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
                     Entrance(DEKU_TREE_BASEMENT_LOWER, { [] { return true; } }),
                     Entrance(DEKU_TREE_BASEMENT_WATER_ROOM, { [] {
                                  return Here(DEKU_TREE_BASEMENT_SCRUB_ROOM,
                                              [] { return CanUse(SLINGSHOT) || CanUse(BOW); });
                              } }),
                 });

        areaTable[DEKU_TREE_BASEMENT_WATER_ROOM] =
            Area("Deku Tree Basement Water Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
        ...
        areaTable[DEKU_TREE_BASEMENT_BACK_LOBBY] = Area(
            "Deku Tree Basement Back Lobby", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE,
            {
                // Events
                EventAccess(&DekuBabaSticks, { [] {
                    return DekuBabaSticks ||
                           (Here(DEKU_TREE_BASEMENT_BACK_LOBBY, [] { return HasFireSourceWithTorch || CanUse(BOW); }) &&
                ...
                EventAccess(&DekuBabaNuts, { [] {
                    return DekuBabaNuts ||
                           (Here(DEKU_TREE_BASEMENT_BACK_LOBBY, [] { return HasFireSourceWithTorch || CanUse(BOW); }) &&
                            (CanJumpslash || CanUse(SLINGSHOT) || CanUse(BOW) || CanUse(MEGATON_HAMMER) ||
        ...
        areaTable[DEKU_TREE_BASEMENT_UPPER] = Area(
            ...
            {},
            {
                ...
                Entrance(DEKU_TREE_OUTSIDE_BOSS_ROOM, { [] {
                             return Here(DEKU_TREE_BASEMENT_UPPER, [] {
                                 return HasFireSourceWithTorch || (LogicDekuB1WebsWithBow && IsAdult && CanUse(BOW));
                             });
                         } }),
            });
            ...
            Area("Deku Tree Outside Boss Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     ...
                     Entrance(DEKU_TREE_BOSS_ROOM,
                              { [] { return Here(DEKU_TREE_OUTSIDE_BOSS_ROOM, [] { return HasShield; }); } }),
                 });

        areaTable[DEKU_TREE_BOSS_ROOM] = Area(
            "Deku Tree Boss Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE,
            {
                // Events
                EventAccess(&DekuTreeClear,
                            { [] {
                                 return DekuTreeClear || (CanJumpslash && (Nuts || CanUse(SLINGSHOT) || CanUse(BOW) ||
                                                                           HookshotOrBoomerang));
                             },
    ...
    if (Dungeon::DekuTree.IsMQ()) {
        areaTable[DEKU_TREE_MQ_LOBBY] = Area(
            "Deku Tree MQ Lobby", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE,
            {
                // Events
                EventAccess(&DekuBabaSticks, { [] {
                    return DekuBabaSticks || (CanUse(KOKIRI_SWORD) || CanUse(MASTER_SWORD) || CanUse(BIGGORON_SWORD) ||
            ...
            },
            {
                ...
                LocationAccess(DEKU_TREE_MQ_SLINGSHOT_ROOM_BACK_CHEST,
            ...
            },
            {
                ...
                Entrance(DEKU_TREE_MQ_COMPASS_ROOM, { [] {
                             return Here(DEKU_TREE_MQ_LOBBY,
                                         [] { return (IsChild && CanUse(SLINGSHOT)) || (IsAdult && CanUse(BOW)); }) &&
                                    Here(DEKU_TREE_MQ_LOBBY,
                                         [] { return HasFireSourceWithTorch || (IsAdult && CanUse(BOW)); });
                         } }),
                ...
                Entrance(DEKU_TREE_MQ_BASEMENT_LEDGE,
                         { [] { return LogicDekuB1Skip || Here(DEKU_TREE_MQ_LOBBY, [] { return IsAdult; }); } }),
            });

        areaTable[DEKU_TREE_MQ_COMPASS_ROOM] =
            Area("Deku Tree MQ Compass Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                     LocationAccess(DEKU_TREE_MQ_COMPASS_CHEST, { [] { return true; } }),
                     LocationAccess(DEKU_TREE_MQ_GS_COMPASS_ROOM, { [] {
                                        return HookshotOrBoomerang && Here(DEKU_TREE_MQ_COMPASS_ROOM, [] {
                                                   return HasBombchus || (Bombs && (CanPlay(SongOfTime) || IsAdult)) ||
                                                          (IsAdult && CanUse(MEGATON_HAMMER) &&
                                                           (CanPlay(SongOfTime) /*|| LogicDekuMQCompassGS*/));
                                               });
                                    } }),
                 },
                 {
        ...
        areaTable[DEKU_TREE_MQ_BASEMENT_WATER_ROOM_FRONT] =
            Area("Deku Tree MQ Basement Water Room Front", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
        ...
        areaTable[DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK] =
            Area("Deku Tree MQ Basement Water Room Front", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {},
                 {
                     // Locations
                 ...
                 },
                 {
                     ...
                     Entrance(DEKU_TREE_MQ_BASEMENT_BACK_ROOM, { [] {
                                  return Here(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK,
                                              [] {
                                                  return (IsChild && CanUse(STICKS)) || CanUse(DINS_FIRE) ||
                                                         Here(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_FRONT,
                                                              [] { return IsAdult && CanUse(FIRE_ARROWS); });
                                              }) &&
                                         Here(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK, [] {
                                             return CanUse(KOKIRI_SWORD) || CanUse(MASTER_SWORD) ||
                                                    CanUse(BIGGORON_SWORD) || CanUseProjectile ||
                                                    (Nuts && CanUse(STICKS));
                                         });
                              } }),
        ...
        areaTable[DEKU_TREE_MQ_BASEMENT_BACK_ROOM] = Area(
            "Deku Tree MQ Basement Back Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {},
            {
                // Locations
                LocationAccess(DEKU_TREE_MQ_GS_BASEMENT_GRAVES_ROOM, { [] {
                                   return (IsAdult && CanUse(LONGSHOT)) || (CanPlay(SongOfTime) && HookshotOrBoomerang);
                               } }),
                LocationAccess(DEKU_TREE_MQ_GS_BASEMENT_BACK_ROOM,
                               { [] { return HasFireSourceWithTorch && HookshotOrBoomerang; } }),
            },
            {
                // Exits
                Entrance(DEKU_TREE_MQ_BASEMENT_LEDGE, { [] { return IsChild; } }),
                Entrance(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK, { [] {
                             return (IsChild && CanUse(KOKIRI_SWORD)) || CanUseProjectile ||
                                    (Nuts && (IsChild && CanUse(STICKS)));
                         } }),
            });

        areaTable[DEKU_TREE_MQ_BASEMENT_LEDGE] =
            Area("Deku Tree MQ Basement Ledge", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&DekuTreeClear, { [] {
                         return DekuTreeClear ||
                                (Here(DEKU_TREE_MQ_BASEMENT_LEDGE, [] { return HasFireSourceWithTorch; }) &&
                                 Here(DEKU_TREE_MQ_BASEMENT_LEDGE, [] { return HasShield; }) && CanJumpslash &&
