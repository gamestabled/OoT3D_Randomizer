    ...
    if (Dungeon::BottomOfTheWell.IsVanilla()) {
        ...
        areaTable[BOTTOM_OF_THE_WELL_MAIN_AREA] = Area(
            ...
            },
            {
                ...
                LocationAccess(BOTTOM_OF_THE_WELL_CENTER_ROOM_PIT_FALL_BLUE_RUPEE_1, { [] { return LogicLensBotw || CanUse(LENS_OF_TRUTH); } }),
                LocationAccess(BOTTOM_OF_THE_WELL_CENTER_ROOM_PIT_FALL_BLUE_RUPEE_2, { [] { return LogicLensBotw || CanUse(LENS_OF_TRUTH); } }),
                ...
                LocationAccess(BOTTOM_OF_THE_WELL_CENTER_ROOM_PIT_FALL_BLUE_RUPEE_5, { [] { return LogicLensBotw || CanUse(LENS_OF_TRUTH); } }),
