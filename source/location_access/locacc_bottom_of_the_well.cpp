    ...
    if (Dungeon::BottomOfTheWell.IsVanilla()) {
        ...
        areaTable[BOTTOM_OF_THE_WELL_MAIN_AREA] = Area(
            ...
            },
            {
                ...
                LocationAccess(BOTTOM_OF_THE_WELL_CLOSED_SARCOPHAGUS_HEART, { [] { return Sticks || CanUse(DINS_FIRE); } }),
                LocationAccess(BOTTOM_OF_THE_WELL_OPEN_SARCOPHAGUS_HEART, { [] { return true; } }),
