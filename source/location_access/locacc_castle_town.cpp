...
void AreaTable_Init_CastleTown() {
                 ...
                 Entrance(TOT_BEYOND_DOOR_OF_TIME,
                          { [] {
                               return OpenDoorOfTime.Is(OPENDOOROFTIME_OPEN) ||
                                      (CanPlay(SongOfTime) &&
                                       (OpenDoorOfTime.Is(OPENDOOROFTIME_CLOSED) || (HasAllStones && OcarinaOfTime)));
                           },
                            /*Glitched*/
                            [] {
                                return SongOfTime && OpenDoorOfTime.Is(OPENDOOROFTIME_CLOSED) &&
                                       (CanDoGlitch(GlitchType::IndoorBombOI, GlitchDifficulty::ADVANCED) ||
                                        ((Bugs || Fish) && Bombs && (CanSurviveDamage || (Fairy && NumBottles >= 2)) &&
                                         CanShield && CanDoGlitch(GlitchType::QPA, GlitchDifficulty::ADVANCED) &&
    ...
    areaTable[HYRULE_CASTLE_GROUNDS] = Area(
        "Hyrule Castle Grounds", "Castle Grounds", HYRULE_CASTLE, DAY_NIGHT_CYCLE,
        {
            // Events
        ...
        Area("Market Treasure Chest Game", "Market Treasure Chest Game", NONE, NO_DAY_NIGHT_CYCLE, {},
             {
                 ...
                 LocationAccess(MARKET_TREASURE_CHEST_GAME_REWARD,
                                { [] {
                                  ...
                                  /*Glitched*/
                                  [] {
                                      return !ShuffleChestMinigame &&
                                             (CanUse(FARORES_WIND) && (HasBottle || WeirdEgg) &&
                                              CanDoGlitch(GlitchType::RestrictedItems, GlitchDifficulty::NOVICE));
                                  } }),
