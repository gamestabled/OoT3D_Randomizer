    ...
    if (Dungeon::JabuJabusBelly.IsMQ()) {
        ...
        areaTable[JABU_JABUS_BELLY_MQ_MAIN] = Area(
            "Jabu Jabus Belly MQ Main", "Jabu Jabus Belly", JABU_JABUS_BELLY, NO_DAY_NIGHT_CYCLE, {},
            {
                ...
                LocationAccess(JABU_JABUS_BELLY_MQ_NEAR_COW_TOP_GREEN_RUPEE, { [] { return true; } }),
                LocationAccess(JABU_JABUS_BELLY_MQ_NEAR_COW_MIDDLE_GREEN_RUPEE,
                               { [] { return SilverScale || CanUse(BOOMERANG) || CanUse(IRON_BOOTS); } }),
                LocationAccess(JABU_JABUS_BELLY_MQ_NEAR_COW_BOTTOM_GREEN_RUPEE,
                               { [] { return GoldScale || CanUse(BOOMERANG) || CanUse(IRON_BOOTS); } }),
