...
void AreaTable_Init_JabuJabusBelly() {
    ...
    if (Dungeon::JabuJabusBelly.IsVanilla()) {
        ...
        areaTable[JABU_JABUS_BELLY_MAIN_LOWER] =
            Area("Jabu Jabus Belly Main Lower", "Jabu Jabus Belly", JABU_JABUS_BELLY, NO_DAY_NIGHT_CYCLE,
                 ...
                 },
                 {
                     ...
                     LocationAccess(JABU_JABUS_BELLY_GS_LOBBY_BASEMENT_UPPER,
                                    { [] { return HookshotOrBoomerang; },
                                      /*Glitched*/
                                      [] {
                                          return Bombs &&
            ...
            Area("Jabu Jabus Belly Lower Side Room", "Jabu Jabus Belly", JABU_JABUS_BELLY, NO_DAY_NIGHT_CYCLE,
                 {
                     ...
                     EventAccess(&FairyPot,
                                 { [] { return FairyPot || (CanUse(BOOMERANG) || CanUse(HOVER_BOOTS)); },
                                   /*Glitched*/
                                   [] {
            ...
            Area("Jabu Jabus Belly Lift Lower", "Jabu Jabus Belly", JABU_JABUS_BELLY, NO_DAY_NIGHT_CYCLE, {},
                 {
                     ...
                     LocationAccess(JABU_JABUS_BELLY_DEKU_SCRUB, { [] {
                                        return (IsChild || CanDive || LogicJabuScrubJumpDive || CanUse(IRON_BOOTS)) &&
                                               CanStunDeku;
                                    } }),
                 },
                 {
        ...
        areaTable[JABU_JABUS_BELLY_BLUE_TENTACLE] =
            Area("Jabu Jabus Belly Blue Tentacle", "Jabu Jabus Belly", JABU_JABUS_BELLY, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
        ...
        areaTable[JABU_JABUS_BELLY_GREEN_TENTACLE] =
            Area("Jabu Jabus Belly Green Tentacle", "Jabu Jabus Belly", JABU_JABUS_BELLY, NO_DAY_NIGHT_CYCLE, {}, {},
                 {
                     // Exits
                     Entrance(JABU_JABUS_BELLY_FORKED_CORRIDOR, { [] {
                                  return Here(JABU_JABUS_BELLY_GREEN_TENTACLE, [] {
        ...
        areaTable[JABU_JABUS_BELLY_BIGOCTO_ROOM] = Area(
            "Jabu Jabus Belly Bigocto Room", "Jabu Jabus Belly", JABU_JABUS_BELLY, NO_DAY_NIGHT_CYCLE, {}, {},
            {
                // Exits
                Entrance(JABU_JABUS_BELLY_MAIN_LOWER, { [] { return true; } }),
                 ...
                 },
                 {
                     ...
                     Entrance(JABU_JABUS_BELLY_BOSS_ENTRYWAY,
                              { [] { return CanUse(BOOMERANG); },
                                /*Glitched*/
                                [] {
                                    return (CanUse(HOVER_BOOTS) && (CanUse(BOW) || CanUse(SLINGSHOT))) ||
                                           ...
                                           (Bombs && CanDoGlitch(GlitchType::ISG, GlitchDifficulty::NOVICE)) ||
                                           CanDoGlitch(GlitchType::SuperStab, GlitchDifficulty::NOVICE);
                                } }),
                 });
    }
    ...
    if (Dungeon::JabuJabusBelly.IsMQ()) {
        ...
        areaTable[JABU_JABUS_BELLY_MQ_MAIN] = Area(
            "Jabu Jabus Belly MQ Main", "Jabu Jabus Belly", JABU_JABUS_BELLY, NO_DAY_NIGHT_CYCLE, {},
            {
                ...
                LocationAccess(JABU_JABUS_BELLY_MQ_NEAR_COW_TOP_GREEN_RUPEE, { [] { return IsChild || SilverScale || LogicJabuScrubJumpDive; } }),
                LocationAccess(JABU_JABUS_BELLY_MQ_NEAR_COW_MIDDLE_GREEN_RUPEE,
                               { [] { return SilverScale || (CanUse(BOOMERANG) && (IsChild || SilverScale || LogicJabuScrubJumpDive)) || CanUse(IRON_BOOTS); } }),
                LocationAccess(JABU_JABUS_BELLY_MQ_NEAR_COW_BOTTOM_GREEN_RUPEE,
                               { [] { return GoldScale || (CanUse(BOOMERANG) && (IsChild || SilverScale || LogicJabuScrubJumpDive)) || CanUse(IRON_BOOTS); } }),
    ...
    areaTable[JABU_JABUS_BELLY_BOSS_ROOM] = Area(
        "Jabu Jabus Belly Boss Room", "Jabu Jabus Belly", NONE, NO_DAY_NIGHT_CYCLE,
        {
            // Events
