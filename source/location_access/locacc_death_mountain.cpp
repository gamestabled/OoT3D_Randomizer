    ...
    areaTable[DMC_CENTRAL_LOCAL] =
        Area("DMC Central Local", "Death Mountain Crater", DEATH_MOUNTAIN_CRATER, NO_DAY_NIGHT_CYCLE,
             ...
             { 
                ...
                LocationAccess(DMC_SCARE_CROW_RUPEE_CIRCLE_GREEN_RUPEE_1, { [] { return IsAdult && CanSurviveHeatFor(24, -1) && (CanUse(DistantScarecrow)||Here(DMC_UPPER_LOCAL,{[]{IsAdult;}})); } }),
                LocationAccess(DMC_SCARE_CROW_RUPEE_CIRCLE_GREEN_RUPEE_2, { [] { return IsAdult && CanSurviveHeatFor(24, -1) && (CanUse(DistantScarecrow)||Here(DMC_UPPER_LOCAL,{[]{IsAdult;}})); } }),
                LocationAccess(DMC_SCARE_CROW_RUPEE_CIRCLE_GREEN_RUPEE_3, { [] { return IsAdult && CanSurviveHeatFor(24, -1) && (CanUse(DistantScarecrow)||Here(DMC_UPPER_LOCAL,{[]{IsAdult;}})); } }),
                LocationAccess(DMC_SCARE_CROW_RUPEE_CIRCLE_GREEN_RUPEE_4, { [] { return IsAdult && CanSurviveHeatFor(24, -1) && (CanUse(DistantScarecrow)||Here(DMC_UPPER_LOCAL,{[]{IsAdult;}})); } }),
                LocationAccess(DMC_SCARE_CROW_RUPEE_CIRCLE_GREEN_RUPEE_5, { [] { return IsAdult && CanSurviveHeatFor(24, -1) && (CanUse(DistantScarecrow)||Here(DMC_UPPER_LOCAL,{[]{IsAdult;}})); } }),
                LocationAccess(DMC_SCARE_CROW_RUPEE_CIRCLE_GREEN_RUPEE_6, { [] { return IsAdult && CanSurviveHeatFor(24, -1) && (CanUse(DistantScarecrow)||Here(DMC_UPPER_LOCAL,{[]{IsAdult;}})); } }),
                LocationAccess(DMC_SCARE_CROW_RUPEE_CIRCLE_RED_RUPEE, { [] { return IsAdult && CanSurviveHeatFor(24, -1) && (CanUse(DistantScarecrow)||Here(DMC_UPPER_LOCAL,{[]{IsAdult;}})); } }),
             },
             {
                 // Exits
