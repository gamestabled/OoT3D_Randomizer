...
void AreaTable_Init_ForestTemple() {
    ...
    if (Dungeon::ForestTemple.IsVanilla()) {
            ...
            "Forest Temple Lobby", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE,
            {
                ...
                EventAccess(&ForestTempleMeg, { [] {
                    return ForestTempleMeg ||
                           (SoulPoe && ForestTempleJoelle && ForestTempleBeth && ForestTempleAmy && CanUse(BOW));
                } }),
            },
            {},
            {
        ...
        areaTable[FOREST_TEMPLE_RED_POE_ROOM] = Area(
            "Forest Temple Red Poe Room", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE,
            {
                // Events
                EventAccess(&ForestTempleJoelle, { [] { return ForestTempleJoelle || (SoulPoe && CanUse(BOW)); } }),
            },
            {
                // Locations
        ...
        areaTable[FOREST_TEMPLE_BLUE_POE_ROOM] =
            Area("Forest Temple Blue Poe Room", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&ForestTempleBeth, { [] { return ForestTempleBeth || (SoulPoe && CanUse(BOW)); } }),
                 },
                 {
                     // Locations
        ...
        areaTable[FOREST_TEMPLE_GREEN_POE_ROOM] =
            Area("Forest Temple Green Poe Room", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE,
                 {
                     // Events
                     EventAccess(&ForestTempleAmy, { [] { return ForestTempleAmy || (SoulPoe && CanUse(BOW)); } }),
                 },
                 {},
                 {
                     // Exits
        ...
        areaTable[FOREST_TEMPLE_EAST_CORRIDOR] =
        ...
        "Forest Temple Boss Room", "Forest Temple", NONE, NO_DAY_NIGHT_CYCLE,
        {
            ...
            EventAccess(&ForestTempleClear, { [] {
                return ForestTempleClear ||
                       (SoulPhantomGanon && (CanUse(KOKIRI_SWORD) || CanUse(MASTER_SWORD) || CanUse(BIGGORON_SWORD)) &&
