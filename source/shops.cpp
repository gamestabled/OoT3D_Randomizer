...
void InitTrickNames() {
  ...
  trickNameTable[GI_SWORD_KNIFE] = {
     ...
     Text{"Biggoron's Knife", "Lame de Grogoron", "Daga de Biggoron", "Spada del Grande Goron", "Biggoron-Messer"}};
  ...
  trickNameTable[GI_LETTER_ZELDA] = {
     ...
     Text{"Zelda's Business Card", "Carte d'affaires de Zelda", "Carta", "Biglietto da visita di Zelda", "Zeldas Visitenkarte"}};
  ...
  trickNameTable[GI_STONE_OF_AGONY] = {
     ...
     Text{"Stone of Agony", "Fragment de cristal", "Fragmento de la Agonía", "Cristallo dell'agonia", "Stein der Weisen"},
  ...
  trickNameTable[GI_GERUDO_CARD] = {
     Text{"Desert Title Deed", "Abonnement Gerudo", "Escritura del desierto", "Proprietà nel deserto", "Wüsten-Urkunde"},
     Text{"Gerudo's Card", "Carte Goron", "Tóken Gerudo", "Goron Card", "Gerudo-Symbol"},
     Text{"Gerudo's Membership Card", "Autographe de Nabooru", "Tarjeta Gerudo", "Gerudo Pass", "Gerudo-Mitgliedskarte"}};
  ...
  trickNameTable[0xB8] = {
     ...
     Text{"Quadruple Defence", "Quadruple défence", "Defensa cuádruple", "Quadrupla Difesa", "Vierfache Abwehrkraft"}};
  ...
  trickNameTable[GI_ODD_POTION] = {
     ...
     Text{"Granny's Poultice", "Mixture de Granny", "Medicina de la abuela", "Medicina della nonna", "Omas Mixtur"},
  ...
  trickNameTable[GI_SWORD_BROKEN] = {
     Text{"Broken Biggoron's Sword", "Épée brisée de Grogoron", "Espada de Biggoron rota", "Spada rotta di Grande Goron", "Zerbrochenes Biggoron-Schwert"},
     Text{"Broken Giant's Knife", "Lame des géants brisée", "Daga gigante rota", "Spada del gigante (rotta)", "Zerbrochenes Langschwert"},
     Text{"Biggoron's Sword", "Épée de Grogoron", "Espada de Biggoron", "Spada di Grande Goron", "Biggoron-Schwert"}};
  trickNameTable[GI_PERSCRIPTION] = {
     Text{"Biggoron's Prescription", "Ordonnance de Grogoron", "Receta de Biggoron", "Ricetta per Grande Goron", "Biggorons Rezept"},
  ...
  trickNameTable[GI_EYEDROPS] = {
     Text{"Biggoron's Eyedrops", "Gouttes de Grogoron", "Gotas de Biggoron", "Collirio di Grande Goron", "Biggorons Augentropfen"},
  ...
  trickNameTable[0x89] = {
     ...
     Text{"Progressive Bombchu Bag", "Sac à Bombchu (prog.)", "Bombachus progresivos", "Portaradiomine progressivo", "Krabbelminenbeutel Aufwertung"}};
  trickNameTable[0x8A] = {
  ...
  trickNameTable[0x90] = {
     Text{"Bottle with Small Jabu-Jabu", "Flacon avec mini Jabu-Jabu", "Lord Chapu-Chapu embotellado", "Chapu Chapu in un'ampolla", "Flasche (Baby Jabu)"},
     Text{"Bottle with Hyrule Bass", "Flacon avec perche d'Hyrule", "Locha de Hyrule embotellada", "Aspio Hyrule in un'ampolla", "Flasche (Hyrulebarsch)"},
     Text{"Bottle with Hyrule Loach", "Flacon avec loche d'Hyrule", "Perca de Términa embotellada", "Luccio Hylia in un'ampolla", "Flasche (Hyrulegrundel)"}};
  trickNameTable[0x91] = {
     Text{"Bottle with Will-O-Wisp", "Flacon avec feu follet", "Botella de llama azul", "Fuoco fatuo in un'ampolla", "Flasche (Rotes Feuer)"},
     Text{"Bottle with Ancient Flame", "Flacon de flamme ancienne", "Botella de fuego ancestral", "Ampolla di fuoco ancestrale", "Flasche (Antike Flamme)"},
     Text{"Bottle with Nayru's Flame", "Flacon de flamme de Nayru", "Botella de llamas de Nayru", "Fiamma di Nayru in un'ampolla", "Flasche (Nayrus Flamme)"}};
  trickNameTable[0x92] = {
     Text{"Bottle with Baby Tektites", "Flacon de bébé Araknon", "Tektites en una botella", "Cuccioli di Tektite in un'ampolla", "Flasche (Baby Tektite)"},
     Text{"Bottle with Lanayru Ants", "Flacon de fourmis de Lanelle", "Celestarabajo embotellado", "Sabbiormiche in un'ampolla", "Flasche (Ranelle-Ameise)"},
     Text{"Bottle with Insects", "Flacon de bibittes", "Saltabosques embotellados", "Artropodi in un'ampolla", "Flasche (Insekt)"}};
  trickNameTable[0x94] = {
     Text{"Bottle with Ghini", "Flacon avec Ghini", "Ghini en una botella", "Ghini in un'ampolla", "Flasche (Ghini)"},
     Text{"Bottle with Imp Poe", "Flacon avec Spectre", "Espectro en una botella", "Anima di spettro in un'ampolla", "Flasche (Geist)"},
     Text{"Bottle with Anti-Fairy", "Flacon avec Tetdoss", "Whisp en una botella", "Anti-fata in un'ampolla", "Flasche (Knochenfratze)"}};

  trickNameTable[0x15] = {
     Text{"Bottle with Maggie's Letter", "Flacon avec lettre de Maggy", "Carta de Dolores", "Lettera di Maggy in un'ampolla", "Flasche (Dolores Brief)"},
     Text{"Bottle with Letter to Kafei", "Flacon avec lettre pour Kafei", "Carta para Kafei", "Lettera per Kafei in un'ampolla", "Flasche (Brief an Kafei)"},
     Text{"Bottle with Zelda's Letter", "Flacon avec lettre de Zelda", "Carta náutica", "Messaggio in bottiglia", "Flasche (Zeldas Brief)"}};
  trickNameTable[0x93] = {
     Text{"Bottle with Composer Brother", "Flacon avec un compositeur", "Hermana Poe embotellada", "Mortaldi in un'ampolla", "Flasche (Ludwig Brahmstein)"},
  ...
  trickNameTable[0xC5] = {
     Text{"Song of Double Time", "Chant accéléré", "Canción del doble tiempo", "Canzone del tempo accelerato", "Thema der Zeit im Wind"},
  ...
  trickNameTable[0xC0] = {
     ...
     Text{"Ballad of the Wind Fish", "Ballade sur Poisson-Rêve", "Balada del Piez Viento", "Ballata del Pesce Vento", "Ballade vom Windfisch"},
  ...
  trickNameTable[0xD3] = {
     ...
     Text{"Medallion of Light", "Médaillon du temple de lumière", "Medalla de la Luz", "Medaglione Lucente", "Medaillon des Lichts"}};
