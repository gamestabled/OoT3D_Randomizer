...
Item BuyFish                    = Item("Buy Fish",            ITEMTYPE_SHOP, 0x07, true,  &none,          200);
...
Item BuyBlueFire                = Item("Buy Blue Fire",       ITEMTYPE_SHOP, 0x27, true,  &BlueFire,      300);
Item BuyBottleBug               = Item("Buy Bottle Bug",      ITEMTYPE_SHOP, 0x28, true,  &none,           50);
Item BuyPoe                     = Item("Buy Poe",             ITEMTYPE_SHOP, 0x2A, false, &none,           30);
Item BuyFairysSpirit            = Item("Buy Fairy's Spirit",  ITEMTYPE_SHOP, 0x2B, true,  &none,           50);
