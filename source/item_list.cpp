...
//  itemTable[MASK_OF_TRUTH]                     = Item(Text{"Mask of Truth",                   "Masque de vérité",                 "Máscara de la Verdad"},                    ITEMTYPE_ITEM,  GI_MASK_MASK,      true,       &MaskofTruth,   MASK_OF_TRUTH);
  ...
  itemTable[BOTTLE_WITH_MILK]                  = Item(Text{"Bottle with Milk",                "Flacon de lait",                   "Botella de leche Lon Lon"},                ITEMTYPE_ITEM,     0x14, true, &HasBottle, BOTTLE_WITH_MILK);
  ...
  itemTable[BOTTLE_WITH_BUGS]                  = Item(Text{"Bottle with Bugs",                "Flacon d'insectes",                "Insecto en una botella"},                  ITEMTYPE_ITEM,     0x92, true, &HasBottle, BOTTLE_WITH_BUGS);
