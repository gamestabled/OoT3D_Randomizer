...
//  itemTable[POCKET_CUCCO]                      = Item(Text{"Pocket Cucco",                    "Cocotte de poche",                 "Cuco de bolsillo"},                        ITEMTYPE_ITEM,  GI_POCKET_CUCCO,   true,       &PocketCucco,   POCKET_CUCCO);
    ...
    itemTable[PRESCRIPTION]                      = Item(Text{"Prescription",                    "Ordonnance",                       "Receta"},                                  ITEMTYPE_ITEM,  GI_PERSCRIPTION,   true,       &Prescription,  PRESCRIPTION);
    ...
    //Bottles
    itemTable[EMPTY_BOTTLE]                      = Item(Text{"Empty Bottle",                    "Flacon vide",                      "Botella vacía"},                           ITEMTYPE_ITEM,     0x0F, true, &NumBottles, EMPTY_BOTTLE);
    itemTable[BOTTLE_WITH_MILK]                  = Item(Text{"Bottle with Milk",                "Flacon de lait",                   "Botella de leche Lon Lon"},                ITEMTYPE_ITEM,     0x14, true, &NumBottles, BOTTLE_WITH_MILK);
    itemTable[BOTTLE_WITH_RED_POTION]            = Item(Text{"Bottle with Red Potion",          "Flacon de potion rouge",           "Botella de poción roja"},                  ITEMTYPE_ITEM,     0x8C, true, &NumBottles, BOTTLE_WITH_RED_POTION);
    itemTable[BOTTLE_WITH_GREEN_POTION]          = Item(Text{"Bottle with Green Potion",        "Flacon de potion verte",           "Botella de poción verde"},                 ITEMTYPE_ITEM,     0x8D, true, &NumBottles, BOTTLE_WITH_GREEN_POTION);
    itemTable[BOTTLE_WITH_BLUE_POTION]           = Item(Text{"Bottle with Blue Potion",         "Flacon de potion bleue",           "Botella de poción azul"},                  ITEMTYPE_ITEM,     0x8E, true, &NumBottles, BOTTLE_WITH_BLUE_POTION);
    itemTable[BOTTLE_WITH_FAIRY]                 = Item(Text{"Bottle with Fairy",               "Flacon avec une fée",              "Hada en una botella"},                     ITEMTYPE_ITEM,     0x8F, true, &NumBottles, BOTTLE_WITH_FAIRY);
    itemTable[BOTTLE_WITH_FISH]                  = Item(Text{"Bottle with Fish",                "Flacon avec un poisson",           "Pez en una botella"},                      ITEMTYPE_ITEM,     0x90, true, &NumBottles, BOTTLE_WITH_FISH);
    itemTable[BOTTLE_WITH_BLUE_FIRE]             = Item(Text{"Bottle with Blue Fire",           "Flacon de flamme bleue",           "Botella de fuego azul"},                   ITEMTYPE_ITEM,     0x91, true, &NumBottles, BOTTLE_WITH_BLUE_FIRE);
    itemTable[BOTTLE_WITH_BUGS]                  = Item(Text{"Bottle with Bugs",                "Flacon d'insectes",                "Insecto en una botella"},                  ITEMTYPE_ITEM,     0x92, true, &NumBottles, BOTTLE_WITH_BUGS);
    itemTable[BOTTLE_WITH_POE]                   = Item(Text{"Bottle with Poe",                 "Flacon avec un Esprit",            "Poe en una botella"},                      ITEMTYPE_ITEM,     0x94, true, &NumBottles, BOTTLE_WITH_POE);
    ...
    //Maps and Compasses
    itemTable[DEKU_TREE_MAP]                     = Item(Text{"Great Deku Tree Map",             "Carte de l'arbre Mojo",            "Mapa del Gran Árbol Deku"},                ITEMTYPE_MAP,      0xA5, false, &noVariable, MAP);
    itemTable[DODONGOS_CAVERN_MAP]               = Item(Text{"Dodongo's Cavern Map",            "Carte de la grotte Dodongo",       "Mapa de la Cueva de los Dodongos"},        ITEMTYPE_MAP,      0xA6, false, &noVariable, MAP);
    itemTable[JABU_JABUS_BELLY_MAP]              = Item(Text{"Jabu-Jabu's Belly Map",           "Carte de Jabu-Jabu",               "Mapa de la tripa de Jabu-Jabu"},           ITEMTYPE_MAP,      0xA7, false, &noVariable, MAP);
    ...
    itemTable[SHADOW_TEMPLE_MAP]                 = Item(Text{"Shadow Temple Map",               "Carte du temple de l'ombre",       "Mapa del Templo de la Sombra"},            ITEMTYPE_MAP,      0xAC, false, &noVariable, MAP);
    ...
    itemTable[DEKU_TREE_COMPASS]                 = Item(Text{"Great Deku Tree Compass",         "Boussole de l'arbre Mojo",         "Brújula del Gran Árbol Deku"},             ITEMTYPE_COMPASS,  0x9B, false, &noVariable, COMPASS);
    itemTable[DODONGOS_CAVERN_COMPASS]           = Item(Text{"Dodongo's Cavern Compass",        "Boussole de la grotte Dodongo",    "Brújula de la Cueva de los Dodongos"},     ITEMTYPE_COMPASS,  0x9C, false, &noVariable, COMPASS);
    itemTable[JABU_JABUS_BELLY_COMPASS]          = Item(Text{"Jabu-Jabu's Belly Compass",       "Boussole de Jabu-Jabu",            "Brújula de la tripa de Jabu-Jabu"},        ITEMTYPE_COMPASS,  0x9D, false, &noVariable, COMPASS);
    ...
    //Boss Keys
    itemTable[FOREST_TEMPLE_BOSS_KEY]            = Item(Text{"Forest Temple Big Key",           "Clé d'or du temple de la forêt",   "Gran llave del Templo del Bosque"},        ITEMTYPE_BOSSKEY,  0x95, true, &BossKeyForestTemple, BOSS_KEY);
    itemTable[FIRE_TEMPLE_BOSS_KEY]              = Item(Text{"Fire Temple Big Key",             "Clé d'or du temple du feu",        "Gran llave del Templo del Fuego"},         ITEMTYPE_BOSSKEY,  0x96, true, &BossKeyFireTemple,   BOSS_KEY);
    itemTable[WATER_TEMPLE_BOSS_KEY]             = Item(Text{"Water Temple Big Key",            "Clé d'or du temple de l'eau",      "Gran llave del Templo del Agua"},          ITEMTYPE_BOSSKEY,  0x97, true, &BossKeyWaterTemple,  BOSS_KEY);
    itemTable[SPIRIT_TEMPLE_BOSS_KEY]            = Item(Text{"Spirit Temple Big Key",           "Clé d'or du temple de l'esprit",   "Gran llave del Templo del Espíritu"},      ITEMTYPE_BOSSKEY,  0x98, true, &BossKeySpiritTemple, BOSS_KEY);
    itemTable[SHADOW_TEMPLE_BOSS_KEY]            = Item(Text{"Shadow Temple Big Key",           "Clé d'or du temple de l'ombre",    "Gran llave del Templo de las Sombras"},    ITEMTYPE_BOSSKEY,  0x99, true, &BossKeyShadowTemple, BOSS_KEY);
    ...
    //Small Keys
    itemTable[FOREST_TEMPLE_SMALL_KEY]           = Item(Text{"Forest Temple Small Key",         "Petite clé du temple de la forêt", "Llave del Templo del Bosque"},             ITEMTYPE_SMALLKEY,          0xAF, true, &ForestTempleKeys,          SMALL_KEY);
    itemTable[FIRE_TEMPLE_SMALL_KEY]             = Item(Text{"Fire Temple Small Key",           "Petite clé du temple du feu",      "Llave del Templo del Fuego"},              ITEMTYPE_SMALLKEY,          0xB0, true, &FireTempleKeys,            SMALL_KEY);
    itemTable[WATER_TEMPLE_SMALL_KEY]            = Item(Text{"Water Temple Small Key",          "Petite clé du temple de l'eau",    "Llave del Templo del Agua"},               ITEMTYPE_SMALLKEY,          0xB1, true, &WaterTempleKeys,           SMALL_KEY);
    itemTable[SPIRIT_TEMPLE_SMALL_KEY]           = Item(Text{"Spirit Temple Small Key",         "Petite clé du temple de l'esprit", "Llave del Templo del Espíritu"},           ITEMTYPE_SMALLKEY,          0xB2, true, &SpiritTempleKeys,          SMALL_KEY);
    itemTable[SHADOW_TEMPLE_SMALL_KEY]           = Item(Text{"Shadow Temple Small Key",         "Petite clé du temple de l'ombre",  "Llave del Templo de las Sombras"},         ITEMTYPE_SMALLKEY,          0xB3, true, &ShadowTempleKeys,          SMALL_KEY);
    itemTable[BOTTOM_OF_THE_WELL_SMALL_KEY]      = Item(Text{"Bottom of the Well Small Key",    "Petite clé du fond du puits",      "Llave del fondo del pozo"},                ITEMTYPE_SMALLKEY,          0xB4, true, &BottomOfTheWellKeys,       SMALL_KEY);
    itemTable[GERUDO_TRAINING_GROUNDS_SMALL_KEY] = Item(Text{"Training Grounds Small Key",      "Petite clé du gymnase Gerudo",     "Llave de la Fortaleza Gerudo"},            ITEMTYPE_SMALLKEY,          0xB5, true, &GerudoTrainingGroundsKeys, SMALL_KEY);
    itemTable[GERUDO_FORTRESS_SMALL_KEY]         = Item(Text{"Gerudo Fortress Small Key",       "Petite clé du repaire Gerudo",     "Llave de la caverna de hielo"},            ITEMTYPE_FORTRESS_SMALLKEY, 0xB6, true, &GerudoFortressKeys,        GERUDO_FORTRESS_SMALL_KEY);
    itemTable[GANONS_CASTLE_SMALL_KEY]           = Item(Text{"Ganon's Castle Small Key",        "Petite clé du château de Ganon",   "Llave del Centro de Instrucción"},         ITEMTYPE_SMALLKEY,          0xB7, true, &GanonsCastleKeys,          SMALL_KEY);
    ...
    itemTable[PIECE_OF_HEART]                    = Item(Text{"Piece of Heart",                  "Quart de cœur",                    "Pieza de corazón"},                        ITEMTYPE_ITEM, GI_HEART_PIECE,       false, &noVariable, PIECE_OF_HEART);
    itemTable[HEART_CONTAINER]                   = Item(Text{"Heart Container",                 "Réceptacle de cœur",               "Contenedor de corazón"},                   ITEMTYPE_ITEM, GI_HEART_CONTAINER_2, false, &noVariable, HEART_CONTAINER);
