...
//Shop Items                                                                                                                price
Item BuyDekuNut5                = Item("Buy Deku Nut (5)",    ITEMTYPE_SHOP, 0x00, true,  &Nuts,           &Hints::NoHintText,  15);
Item BuyArrows30                = Item("Buy Arrows (30)",     ITEMTYPE_SHOP, 0x01, false, &none,           &Hints::NoHintText,  60);
Item BuyArrows50                = Item("Buy Arrows (50)",     ITEMTYPE_SHOP, 0x02, false, &none,           &Hints::NoHintText,  90);
Item BuyBombs525                = Item("Buy Bombs (5) [25]",  ITEMTYPE_SHOP, 0x03, false, &none,           &Hints::NoHintText,  25);
Item BuyDekuNut10               = Item("Buy Deku Nut (10)",   ITEMTYPE_SHOP, 0x04, true,  &Nuts,           &Hints::NoHintText,  30);
Item BuyDekuStick1              = Item("Buy Deku Stick (1)",  ITEMTYPE_SHOP, 0x05, true,  &Sticks,         &Hints::NoHintText,  10);
Item BuyBombs10                 = Item("Buy Bombs (10)",      ITEMTYPE_SHOP, 0x06, false, &none,           &Hints::NoHintText,  50);
Item BuyFish                    = Item("Buy Fish",            ITEMTYPE_SHOP, 0x07, true,  &FishAccess,     &Hints::NoHintText, 200);
...
Item BuyHylianShield            = Item("Buy Hylian Shield",   ITEMTYPE_SHOP, 0x0C, true,  &HylianShield,   &Hints::NoHintText,  80);
Item BuyDekuShield              = Item("Buy Deku Shield",     ITEMTYPE_SHOP, 0x0D, true,  &DekuShield,     &Hints::NoHintText,  40);
Item BuyGoronTunic              = Item("Buy Goron Tunic",     ITEMTYPE_SHOP, 0x0E, true,  &GoronTunic,     &Hints::NoHintText, 200);
Item BuyZoraTunic               = Item("Buy Zora Tunic",      ITEMTYPE_SHOP, 0x0F, true,  &ZoraTunic,      &Hints::NoHintText, 300);
Item BuyHeart                   = Item("Buy Heart",           ITEMTYPE_SHOP, 0x10, false, &none,           &Hints::NoHintText,  10);
Item BuyBombchu10               = Item("Buy Bombchu (10)",    ITEMTYPE_SHOP, 0x15, true,  &BuyBombchus10,  &Hints::NoHintText,  99);
Item BuyBombchu20               = Item("Buy Bombchu (20)",    ITEMTYPE_SHOP, 0x16, true,  &BuyBombchus20,  &Hints::NoHintText, 180);
Item BuyBombchu5                = Item("Buy Bombchu (5)",     ITEMTYPE_SHOP, 0x18, true,  &BuyBombchus5,   &Hints::NoHintText,  60);
Item BuyDekuSeeds30             = Item("Buy Deku Seeds (30)", ITEMTYPE_SHOP, 0x1D, false, &none,           &Hints::NoHintText,  30);
Item SoldOut                    = Item("Sold Out",            ITEMTYPE_SHOP, 0x26, false, &none,           &Hints::NoHintText,   0);
Item BuyBlueFire                = Item("Buy Blue Fire",       ITEMTYPE_SHOP, 0x27, true,  &BlueFireAccess, &Hints::NoHintText, 300);
Item BuyBottleBug               = Item("Buy Bottle Bug",      ITEMTYPE_SHOP, 0x28, true,  &BugsAccess,     &Hints::NoHintText,  50);
Item BuyPoe                     = Item("Buy Poe",             ITEMTYPE_SHOP, 0x2A, false, &none,           &Hints::NoHintText,  30);
Item BuyFairysSpirit            = Item("Buy Fairy's Spirit",  ITEMTYPE_SHOP, 0x2B, true,  &FairyAccess,    &Hints::NoHintText,  50);
Item BuyArrows10                = Item("Buy Arrows (10)",     ITEMTYPE_SHOP, 0x2C, false, &none,           &Hints::NoHintText,  20);
Item BuyBombs20                 = Item("Buy Bombs (20)",      ITEMTYPE_SHOP, 0x2D, false, &none,           &Hints::NoHintText,  80);
Item BuyBombs30                 = Item("Buy Bombs (30)",      ITEMTYPE_SHOP, 0x2E, false, &none,           &Hints::NoHintText, 120);
Item BuyBombs535                = Item("Buy Bombs (5) [35]",  ITEMTYPE_SHOP, 0x2F, false, &none,           &Hints::NoHintText,  35);
