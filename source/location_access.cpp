...
void AreaTable_Init() {
  ...
  areaTable[HAUNTED_WASTELAND] = Area("Haunted Wasteland", "Haunted Wasteland", HAUNTED_WASTELAND, NO_DAY_NIGHT_CYCLE, {
                  ...
                  //Exits
                  Entrance(HW_NEAR_COLOSSUS, []{return LogicLensWasteland || CanUse(LENS_OF_TRUTH);}),
                  Entrance(HW_NEAR_FORTRESS, []{return CanUse(HOVER_BOOTS) || CanUse(LONGSHOT);}),
  });
  ...
  areaTable[DMC_UPPER_LOCAL] = Area("DMC Upper Local", "Death Mountain Crater", DEATH_MOUNTAIN_CRATER, NO_DAY_NIGHT_CYCLE, {
                  ...
                  Entrance(DMC_CENTRAL_NEARBY,     []{return CanUse(GORON_TUNIC) && CanUse(LONGSHOT) && ((DamageMultiplier.IsNot(DAMAGEMULTIPLIER_OHKO) && DamageMultiplier.IsNot(DAMAGEMULTIPLIER_QUADRUPLE)) || (Fairy && !ShuffleDungeonEntrances) || CanUse(NAYRUS_LOVE));})
  });
  ...
  areaTable[DMC_LOWER_LOCAL] = Area("DMC Lower Local", "Death Mountain Crater", DEATH_MOUNTAIN_CRATER, NO_DAY_NIGHT_CYCLE, {}, {}, {
                  ...
                  Entrance(FIRE_TEMPLE_ENTRYWAY,   []{return (CanUse(HOVER_BOOTS) || CanUse(HOOKSHOT)) && (LogicFewerTunicRequirements || CanUse(GORON_TUNIC));}),
  });
  ...
  areaTable[FIRE_TEMPLE_LOWER] = Area("Fire Temple Lower", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {
                  ...
                  LocationAccess(FIRE_TEMPLE_FLARE_DANCER_CHEST, []{return /*SmallKeys(FireTempleKeys, 8) &&*/ CanUse(MEGATON_HAMMER);}),
                  LocationAccess(FIRE_TEMPLE_BOSS_KEY_CHEST,     []{return /*SmallKeys(FireTempleKeys, 8) &&*/ CanUse(MEGATON_HAMMER);}),
                  ...
                  LocationAccess(VOLVAGIA,                       []{return CanUse(GORON_TUNIC) && CanUse(MEGATON_HAMMER) && BossKeyFireTemple &&
                                                                                (LogicFireBossDoorJump || HoverBoots ||
                                                                                  Here(FIRE_TEMPLE_UPPER, []{return CanPlay(SongOfTime) || HasExplosives;}));}),
                  LocationAccess(FIRE_TEMPLE_GS_BOSS_KEY_LOOP,   []{return /*SmallKeys(FireTempleKeys, 8) &&*/ CanUse(MEGATON_HAMMER);}),
                }, {
                  //Exits
                  Entrance(FIRE_TEMPLE_ENTRYWAY,      []{return true;}),
                  Entrance(FIRE_TEMPLE_BIG_LAVA_ROOM, []{return SmallKeys(FireTempleKeys, 1) && (LogicFewerTunicRequirements || CanUse(GORON_TUNIC));}),
  });
  ...
  areaTable[FIRE_TEMPLE_BIG_LAVA_ROOM] = Area("Fire Temple Big Lava Room", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
                  ...
                  Entrance(FIRE_TEMPLE_MIDDLE, []{return CanUse(GORON_TUNIC) && SmallKeys(FireTempleKeys, 3) && (GoronBracelet || LogicFireStrength) && (HasExplosives || Bow || Hookshot);}),
  });
  ...
  areaTable[FIRE_TEMPLE_MIDDLE] = Area("Fire Temple Middle", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
                  ...
                  LocationAccess(FIRE_TEMPLE_SCARECROW_CHEST,              []{return SmallKeys(FireTempleKeys, 5) && (CanUse(SCARECROW) || (LogicFireScarecrow && CanUse(LONGSHOT)));}),
                  LocationAccess(FIRE_TEMPLE_MAP_CHEST,                    []{return SmallKeys(FireTempleKeys, 5) || (SmallKeys(FireTempleKeys, 4) && CanUse(BOW));}),
                  ...
                  LocationAccess(FIRE_TEMPLE_GS_SCARECROW_CLIMB,           []{return SmallKeys(FireTempleKeys, 5) && (CanUse(SCARECROW) || (LogicFireScarecrow && CanUse(LONGSHOT)));}),
                  LocationAccess(FIRE_TEMPLE_GS_SCARECROW_TOP,             []{return SmallKeys(FireTempleKeys, 5) && (CanUse(SCARECROW) || (LogicFireScarecrow && CanUse(LONGSHOT)));}),
                }, {
                  //Exits
                  Entrance(FIRE_TEMPLE_UPPER, []{return SmallKeys(FireTempleKeys, 7) || (SmallKeys(FireTempleKeys, 6) && ((CanUse(HOVER_BOOTS) && CanUse(MEGATON_HAMMER)) || LogicFireFlameMaze));})
  });
  ...
  areaTable[SHADOW_TEMPLE_HUGE_PIT] = Area("Shadow Temple Huge Pit", "Shadow Temple", SHADOW_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
                  ...
                  LocationAccess(SHADOW_TEMPLE_INVISIBLE_SPIKES_CHEST,           []{return SmallKeys(ShadowTempleKeys, 2) && (LogicLensShadowBack || CanUse(LENS_OF_TRUTH));}),
                  LocationAccess(SHADOW_TEMPLE_FREESTANDING_KEY,                 []{return SmallKeys(ShadowTempleKeys, 2) && (LogicLensShadowBack || CanUse(LENS_OF_TRUTH)) && Hookshot && (Bombs || GoronBracelet || (LogicShadowFreestandingKey && HasBombchus));}),
                  ...
                  LocationAccess(SHADOW_TEMPLE_GS_SINGLE_GIANT_POT,              []{return SmallKeys(ShadowTempleKeys, 2) && (LogicLensShadowBack || CanUse(LENS_OF_TRUTH)) && Hookshot;}),
                }, {
                  //Exits
                  Entrance(SHADOW_TEMPLE_WIND_TUNNEL, []{return (LogicLensShadowBack || CanUse(LENS_OF_TRUTH)) && Hookshot && SmallKeys(ShadowTempleKeys, 3);}),
  });
  ...
  areaTable[SHADOW_TEMPLE_WIND_TUNNEL] = Area("Shadow Temple Wind Tunnel", "Shadow Temple", SHADOW_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
                  ...
                  LocationAccess(SHADOW_TEMPLE_GS_NEAR_SHIP,            []{return CanUse(LONGSHOT) && SmallKeys(ShadowTempleKeys, 4);}),
                }, {
                  //Exits
  ...
  areaTable[DODONGOS_CAVERN_MQ_BOMB_BAG_AREA] = Area("Dodongos Cavern MQ Bomb Bag Area", "Dodongos Cavern", DODONGOS_CAVERN, NO_DAY_NIGHT_CYCLE, {}, {
                  ...
                  LocationAccess(DODONGOS_CAVERN_MQ_GS_SCRUB_ROOM,  []{return (Here(DODONGOS_CAVERN_MQ_BOMB_BAG_AREA, []{return CanUse(BOW);}) ||  GoronBracelet || CanUse(DINS_FIRE) || HasExplosives) && (HookshotOrBoomerang);}),
  }, {
                  //Exits
  ...
  areaTable[SPIRIT_TEMPLE_MQ_CHILD] = Area("Spirit Temple MQ Child", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {
                  ...
                  LocationAccess(SPIRIT_TEMPLE_MQ_MAP_ROOM_ENEMY_CHEST,       []{return (Sticks || KokiriSword) && HasBombchus && Slingshot && CanUse(DINS_FIRE);}),
