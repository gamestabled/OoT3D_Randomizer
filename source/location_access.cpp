...
void AreaTable_Init() {
  ...
  areaTable[LAKE_HYLIA] = Area("Lake Hylia", "Lake Hylia", LAKE_HYLIA, DAY_NIGHT_CYCLE, {
    ...
    LocationAccess(LH_GS_TREE,                {
      []{return CanUse(CanUseItem::Longshot) && AtNight && CanGetNightTimeGS;},
    ...
    Entrance(WATER_TEMPLE_ENTRYWAY, {
      []{return CanUse(CanUseItem::Hookshot) && (CanUse(CanUseItem::Iron_Boots) || ((CanUse(CanUseItem::Longshot)) && ProgressiveScale >= 2));},
  ...
  areaTable[GERUDO_VALLEY] = Area("Gerudo Valley", "Gerudo Valley", GERUDO_VALLEY, DAY_NIGHT_CYCLE, {
    ...
    Entrance(GV_FORTRESS_SIDE,  {
      []{return IsAdult && (CanRideEpona || CanUse(CanUseItem::Longshot) || GerudoFortress.Is(GERUDOFORTRESS_OPEN) || CarpenterRescue);},
  ...
  areaTable[THE_GRAVEYARD] = Area("The Graveyard", "The Graveyard", THE_GRAVEYARD, NO_DAY_NIGHT_CYCLE, {
    ...
    Entrance(KAKARIKO_VILLAGE,             {[]{return true;}}),
    Entrance(GRAVEYARD_WARP_PAD_REGION,    {
      []{return false;},
    ...
    Entrance(SHADOW_TEMPLE_ENTRYWAY,       {
      []{return false;},
  ...
  areaTable[ZORAS_DOMAIN] = Area("Zoras Domain", "Zoras Domain", ZORAS_DOMAIN, NO_DAY_NIGHT_CYCLE, {
    ...
    Entrance(ZD_BEHIND_KING_ZORA, {
      []{return DeliverLetter || ZorasFountain.Is(ZORASFOUNTAIN_OPEN) || (ZorasFountain.Is(ZORASFOUNTAIN_ADULT) && IsAdult);},
  ...
  areaTable[LON_LON_RANCH] = Area("Lon Lon Ranch", "Lon Lon Ranch", LON_LON_RANCH, NO_DAY_NIGHT_CYCLE, {
    ...
    LocationAccess(LLR_GS_BACK_WALL,    {
      []{return CanUse(CanUseItem::Boomerang) && AtNight && CanGetNightTimeGS;},
  ...
  areaTable[SHADOW_TEMPLE_ENTRYWAY] = Area("Shadow Temple Entryway", "Shadow Temple", SHADOW_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {}, {
    //Exits
    Entrance(SHADOW_TEMPLE_BEGINNING,    {
      []{return Dungeon::ShadowTemple.IsVanilla() && (LogicLensShadow || CanUse(CanUseItem::Lens_of_Truth)) && (CanUse(CanUseItem::Hover_Boots) || CanUse(CanUseItem::Hookshot));},
    ...
    Entrance(SHADOW_TEMPLE_MQ_BEGINNING, {
      []{return Dungeon::ShadowTemple.IsMQ()    && (LogicLensShadowMQ || CanUse(CanUseItem::Lens_of_Truth)) && (CanUse(CanUseItem::Hover_Boots) || CanUse(CanUseItem::Hookshot));},
  ...
  if (Dungeon::DekuTree.IsVanilla()) {
    ...
    areaTable[DEKU_TREE_LOBBY] = Area("Deku Tree Lobby", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {
      ...
      Entrance(DEKU_TREE_BASEMENT_BACK_ROOM, {
        []{
          return (Here(DEKU_TREE_LOBBY, []{return HasFireSourceWithTorch || CanUse(CanUseItem::Bow);})&&
      ...
      Entrance(DEKU_TREE_BOSS_ROOM,          {
        []{
          return Here(DEKU_TREE_LOBBY, []{return HasFireSourceWithTorch || (LogicDekuB1WebsWithBow && CanUse(CanUseItem::Bow));})&&
    ...
    areaTable[DEKU_TREE_BASEMENT_BACK_ROOM] = Area("Deku Tree Basement Backroom", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      LocationAccess(DEKU_TREE_GS_BASEMENT_BACK_ROOM,  {
        []{
          return Here(DEKU_TREE_BASEMENT_BACK_ROOM, []{return HasFireSourceWithTorch || CanUse(CanUseItem::Bow);})&&
  ...
  if (Dungeon::ForestTemple.IsVanilla()) {
    areaTable[FOREST_TEMPLE_LOBBY] = Area("Forest Temple Lobby", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      Entrance(FOREST_TEMPLE_NW_OUTDOORS,     {
    ...
    areaTable[FOREST_TEMPLE_NW_OUTDOORS] = Area("Forest Temple NW Outdoors", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE, {
      ...
      Entrance(FOREST_TEMPLE_OUTSIDE_UPPER_LEDGE,     {
        []{return false;},
    ...
    areaTable[FOREST_TEMPLE_NE_OUTDOORS] = Area("Forest Temple NE Outdoors", "Forest Temple", FOREST_TEMPLE, NO_DAY_NIGHT_CYCLE, {
      ...
      LocationAccess(FOREST_TEMPLE_GS_RAISED_ISLAND_COURTYARD,    {
        []{
          return CanUse(CanUseItem::Hookshot) ||
  ...
  if (Dungeon::FireTemple.IsVanilla()) {
    ...
    areaTable[FIRE_TEMPLE_LOWER] = Area("Fire Temple Lower", "Fire Temple", FIRE_TEMPLE, NO_DAY_NIGHT_CYCLE, {
      ...
      EventAccess(&FireTempleClear, {
        []{
          return FireTempleClear || (CanUse(CanUseItem::Goron_Tunic) && CanUse(CanUseItem::Hammer) && BossKeyFireTemple &&
      ...
      LocationAccess(FIRE_TEMPLE_BOSS_KEY_CHEST,     {
        []{return (SmallKeys(FireTempleKeys, 8) || !IsKeysanity) && CanUse(CanUseItem::Hammer);},
        /*Glitched*/[]{return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE);}
      }),
      LocationAccess(FIRE_TEMPLE_VOLVAGIA_HEART,     {
        []{
          return CanUse(CanUseItem::Goron_Tunic) && CanUse(CanUseItem::Hammer) && BossKeyFireTemple &&
          (LogicFireBossDoorJump || HoverBoots ||
          Here(FIRE_TEMPLE_UPPER, []{return CanPlay(SongOfTime) || HasExplosives;}));
        }
      }),
      LocationAccess(VOLVAGIA,                       {
        []{
          return CanUse(CanUseItem::Goron_Tunic) && CanUse(CanUseItem::Hammer) && BossKeyFireTemple &&
          (LogicFireBossDoorJump || HoverBoots ||
          Here(FIRE_TEMPLE_UPPER, []{return CanPlay(SongOfTime) || HasExplosives;}));
  ...
  if (Dungeon::WaterTemple.IsVanilla()) {
    ...
    areaTable[WATER_TEMPLE_DIVE] = Area("Water Temple Dive", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      LocationAccess(WATER_TEMPLE_CENTRAL_BOW_TARGET_CHEST, {
        []{
          return GoronBracelet && CanPlay(ZeldasLullaby) &&
      ...
      LocationAccess(WATER_TEMPLE_GS_BEHIND_GATE,           {
        []{
          return (CanUse(CanUseItem::Hookshot) || CanUse(CanUseItem::Hover_Boots)) &&
      ...
      Entrance(WATER_TEMPLE_DRAGON_STATUE,      {
        []{
          return CanPlay(ZeldasLullaby) && GoronBracelet &&
    ...
    areaTable[WATER_TEMPLE_DARK_LINK_REGION] = Area("Water Temple Dark Link Region", "Water Temple", WATER_TEMPLE, NO_DAY_NIGHT_CYCLE, {
      ...
      Entrance(WATER_TEMPLE_DRAGON_STATUE, {
        []{
          return (CanUse(CanUseItem::Zora_Tunic) || LogicFewerTunicRequirements) &&
  ...
  if (Dungeon::SpiritTemple.IsVanilla()) {
    ...
    areaTable[SPIRIT_TEMPLE_CHILD_CLIMB] = Area("Child Spirit Temple Climb", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      LocationAccess(SPIRIT_TEMPLE_GS_SUN_ON_FLOOR_ROOM,    {
        []{
          return HasProjectile(HasProjectileAge::Both) || CanUse(CanUseItem::Dins_Fire) ||
    ...
    areaTable[SPIRIT_TEMPLE_CENTRAL_CHAMBER] = Area("Spirit Temple Central Chamber", "Spirit Temple", SPIRIT_TEMPLE, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      LocationAccess(SPIRIT_TEMPLE_MAP_CHEST,                    {
        []{
          return ((HasExplosives || SmallKeys(SpiritTempleKeys, 3) || (SmallKeys(SpiritTempleKeys, 2) && BombchusInLogic && !ShuffleDungeonEntrances)) &&
  ...
  if (Dungeon::ShadowTemple.IsVanilla()) {
    areaTable[SHADOW_TEMPLE_BEGINNING] = Area("Shadow Temple Beginning", "Shadow Temple", SHADOW_TEMPLE, NO_DAY_NIGHT_CYCLE, {
      ...
      Entrance(SHADOW_TEMPLE_FIRST_BEAMOS, {
        []{return HoverBoots;},
        /*Glitched*/[]{return CanDoGlitch(GlitchType::Megaflip, GlitchDifficulty::NOVICE);}
      }),
    });
  ...
  if (Dungeon::GerudoTrainingGrounds.IsVanilla()) {
    ...
    areaTable[GERUDO_TRAINING_GROUNDS_CENTRAL_MAZE] = Area("Gerudo Training Grounds Central Maze", "Gerudo Training Grounds", GERUDO_TRAINING_GROUNDS, NO_DAY_NIGHT_CYCLE, {}, {
      //Locations
      LocationAccess(GERUDO_TRAINING_GROUNDS_HIDDEN_CEILING_CHEST,   {
        []{return SmallKeys(GerudoTrainingGroundsKeys, 3) && (LogicLensGtg || CanUse(CanUseItem::Lens_of_Truth));},
        /*Glitched*/[]{return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE) && (LogicLensGtg || CanUse(CanUseItem::Lens_of_Truth));}
      }),
      LocationAccess(GERUDO_TRAINING_GROUNDS_MAZE_PATH_FIRST_CHEST,  {
        []{return SmallKeys(GerudoTrainingGroundsKeys, 4);},
        /*Glitched*/[]{return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE);}
      }),
      LocationAccess(GERUDO_TRAINING_GROUNDS_MAZE_PATH_SECOND_CHEST, {
        []{return SmallKeys(GerudoTrainingGroundsKeys, 6);},
        /*Glitched*/[]{return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE);}
      }),
      LocationAccess(GERUDO_TRAINING_GROUNDS_MAZE_PATH_THIRD_CHEST,  {
        []{return SmallKeys(GerudoTrainingGroundsKeys, 7);},
        /*Glitched*/[]{return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE);}
      }),
      LocationAccess(GERUDO_TRAINING_GROUNDS_MAZE_PATH_FINAL_CHEST,  {
        []{return SmallKeys(GerudoTrainingGroundsKeys, 9);},
        /*Glitched*/[]{return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE);}
      }),
    }, {
      //Exits
      Entrance(GERUDO_TRAINING_GROUNDS_CENTRAL_MAZE_RIGHT, {
        []{return SmallKeys(GerudoTrainingGroundsKeys, 9);},
        /*Glitched*/[]{return CanDoGlitch(GlitchType::HookshotClip, GlitchDifficulty::NOVICE);}
      }),
    });
  ...
  if (Dungeon::DekuTree.IsMQ()) {
    areaTable[DEKU_TREE_MQ_LOBBY] = Area("Deku Tree MQ Lobby", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {
      ...
      //Exits
      Entrance(DEKU_TREE_ENTRYWAY,                     {[]{return true;}}),
      Entrance(DEKU_TREE_MQ_COMPASS_ROOM,              {
        []{
          return Here(DEKU_TREE_MQ_LOBBY, []{return CanUse(CanUseItem::Slingshot) || CanUse(CanUseItem::Bow);})&&
          Here(DEKU_TREE_MQ_LOBBY, []{return HasFireSourceWithTorch || CanUse(CanUseItem::Bow);});
        }
      }),
      Entrance(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_FRONT, {
        []{
          return Here(DEKU_TREE_MQ_LOBBY, []{return CanUse(CanUseItem::Slingshot) || CanUse(CanUseItem::Bow);})&&
    ...
    areaTable[DEKU_TREE_MQ_COMPASS_ROOM] = Area("Deku Tree MQ Compass Room", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      LocationAccess(DEKU_TREE_MQ_GS_COMPASS_ROOM, {
        []{
          return HookshotOrBoomerang &&
          Here(DEKU_TREE_MQ_COMPASS_ROOM, []{
            return HasBombchus ||
    ...
    areaTable[DEKU_TREE_MQ_BASEMENT_WATER_ROOM_FRONT] = Area("Deku Tree MQ Basement Water Room Front", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      //Exits
      Entrance(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK, {
        []{
          return /*LogicDekuMQLog || */ (IsChild && (DekuShield || HylianShield)) ||
    ...
    areaTable[DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK] = Area("Deku Tree MQ Basement Water Room Front", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      //Exits
      Entrance(DEKU_TREE_MQ_BASEMENT_BACK_ROOM,        {
        []{
          return Here(DEKU_TREE_MQ_BASEMENT_WATER_ROOM_BACK, []{
            return CanUse(CanUseItem::Sticks) || CanUse(CanUseItem::Dins_Fire) ||
    ...
    areaTable[DEKU_TREE_MQ_BASEMENT_LEDGE] = Area("Deku Tree MQ Basement Ledge", "Deku Tree", DEKU_TREE, NO_DAY_NIGHT_CYCLE, {
      ...
      EventAccess(&DekuTreeClear, {
        []{
          return DekuTreeClear || (Here(DEKU_TREE_MQ_BASEMENT_LEDGE, []{return HasFireSourceWithTorch;})&&
  ...
  if (Dungeon::DodongosCavern.IsMQ()) {
    ...
    areaTable[DODONGOS_CAVERN_MQ_LOWER_RIGHT_SIDE] = Area("Dodongos Cavern MQ Lower Right Side", "Dodongos Cavern", DODONGOS_CAVERN, NO_DAY_NIGHT_CYCLE, {}, {
      ...
      Entrance(DODONGOS_CAVERN_MQ_BOMB_BAG_AREA, {
        []{
          return (Here(DODONGOS_CAVERN_MQ_LOWER_RIGHT_SIDE, []{return CanUse(CanUseItem::Bow);}) || GoronBracelet ||
