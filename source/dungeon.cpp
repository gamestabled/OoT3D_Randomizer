...
DungeonInfo WaterTemple = DungeonInfo(
    "Water Temple", WATER_TEMPLE, WATER_TEMPLE_MAP, WATER_TEMPLE_COMPASS, WATER_TEMPLE_SMALL_KEY, WATER_TEMPLE_KEY_RING,
    WATER_TEMPLE_BOSS_KEY, WATER_KEY_COUNT, WATER_MQ_KEY_COUNT,
    { // Vanilla Locations
      WATER_TEMPLE_MAP_CHEST, WATER_TEMPLE_COMPASS_CHEST, WATER_TEMPLE_TORCHES_CHEST, WATER_TEMPLE_DRAGON_CHEST,
      WATER_TEMPLE_CENTRAL_BOW_TARGET_CHEST, WATER_TEMPLE_CENTRAL_PILLAR_CHEST, WATER_TEMPLE_CRACKED_WALL_CHEST,
      WATER_TEMPLE_BOSS_KEY_CHEST, WATER_TEMPLE_LONGSHOT_CHEST, WATER_TEMPLE_RIVER_CHEST, WATER_TEMPLE_GS_BEHIND_GATE,
      WATER_TEMPLE_GS_FALLING_PLATFORM_ROOM, WATER_TEMPLE_GS_CENTRAL_PILLAR, WATER_TEMPLE_GS_NEAR_BOSS_KEY_CHEST,
      WATER_TEMPLE_GS_RIVER, WATER_TEMPLE_RIVER_HEART_1, WATER_TEMPLE_RIVER_HEART_2, WATER_TEMPLE_RIVER_HEART_3,
...
DungeonInfo IceCavern = DungeonInfo(
    "Ice Cavern", ICE_CAVERN, ICE_CAVERN_MAP, ICE_CAVERN_COMPASS, NONE, NONE, NONE, 0, 0,
    { // Vanilla Locations
      ICE_CAVERN_MAP_CHEST, ICE_CAVERN_COMPASS_CHEST, ICE_CAVERN_IRON_BOOTS_CHEST, ICE_CAVERN_FREESTANDING_POH,
      ICE_CAVERN_GS_PUSH_BLOCK_ROOM, ICE_CAVERN_GS_SPINNING_SCYTHE_ROOM, ICE_CAVERN_GS_HEART_PIECE_ROOM,
      ICE_CAVERN_RED_ICE_BLUE_RUPEE, ICE_CAVERN_PUSH_BLOCK_ROOM_RED_RUPEE_1, ICE_CAVERN_PUSH_BLOCK_ROOM_RED_RUPEE_2,
      ICE_CAVERN_PUSH_BLOCK_ROOM_RED_RUPEE_3, ICE_CAVERN_MAP_CHEST_ROOM_HEART_1, ICE_CAVERN_MAP_CHEST_ROOM_HEART_2,
