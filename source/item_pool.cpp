...
const std::array<Item, 61> alwaysItems = {
  I_BiggoronSword,
  I_Boomerang,
  I_LensOfTruth,
  I_MegatonHammer,
...
static void AddRandomBottle() {
  u32 idx = Random() % normalBottles.size();
  AddItemToMainPool(normalBottles[idx]);
  normalBottles.erase(normalBottles.begin() + idx);
}
