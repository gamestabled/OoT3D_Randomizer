...
static std::map<std::string, int> pixelWidthTable = {
    {" ",  4}, {"!",  3}, {"\"", 5}, {"#",  9}, {"$",  9}, {"%", 11}, {"&",  9}, {"\'",     4}, {"(",  5}, {")",  5}, {"*",  6}, 
    {"+",  8}, {",",  4}, {"-",  6}, {".",  3}, {"/",  6}, {"0",  8}, {"1",  4}, {"2",      8}, {"3",  8}, {"4",  8}, {"5",  8},
    {"6",  8}, {"7",  8}, {"8",  8}, {"9",  8}, {":",  3}, {";",  3}, {"<",  8}, {"=",      9}, {">",  8}, {"?",  7}, {"@", 11},
    {"A", 11}, {"B",  9}, {"C", 10}, {"D",  9}, {"E",  8}, {"F",  8}, {"G", 10}, {"H",      9}, {"I",  3}, {"J",  8}, {"K",  9},
    {"L",  7}, {"M", 11}, {"N",  9}, {"O", 11}, {"P",  9}, {"Q", 11}, {"R",  9}, {"S",      9}, {"T",  9}, {"U",  9}, {"V", 10},
    {"W", 12}, {"X",  9}, {"Y", 10}, {"Z",  9}, {"[",  5}, {"\\", 6}, {"]",  5}, {"^",      7}, {"_",  8}, {"`",  4}, {"a",  8},
    {"b",  8}, {"c",  8}, {"d",  8}, {"e",  8}, {"f",  5}, {"g",  8}, {"h",  7}, {"i",      3}, {"j",  4}, {"k",  7}, {"l",  3},
    {"m", 10}, {"n",  7}, {"o",  9}, {"p",  8}, {"q",  8}, {"r",  5}, {"s",  7}, {"t",      5}, {"u",  7}, {"v",  8}, {"w",  9},
    {"x",  8}, {"y",  8}, {"z",  8}, {"{",  5}, {"¦",  3}, {"}",  5}, {"¡",  5}, {"¢",      7}, {"£",  8}, {"¤",  7}, {"¥",  8},
    {"|",  3}, {"§", 12}, {"¨", 12}, {"©", 10}, {"ª",  5}, {"«",  8}, {"¬",  7}, {"\u00AD", 6}, {"®", 10}, {"¯",  5}, {"°", 12}, 
    {"±", 12}, {"²",  5}, {"³",  5}, {"µ",  6}, {"¶",  8}, {"·",  4}, {"¹",  4}, {"º",      5}, {"»",  9}, {"¼",  9}, {"½",  9},
    {"¾", 10}, {"¿",  7}, {"À", 11}, {"Á", 11}, {"Â", 11}, {"Ã", 11}, {"Ä", 11}, {"Å",     11}, {"Æ", 12}, {"Ç", 10}, {"È",  8}, 
    {"É",  8}, {"Ê",  8}, {"Ë",  8}, {"Ì",  5}, {"Í",  5}, {"Î",  5}, {"Ï",  5}, {"Ð",     10}, {"Ñ",  9}, {"Ò", 11}, {"Ó", 11},
    {"Ô", 11}, {"Õ", 11}, {"Ö", 11}, {"×",  9}, {"Ø", 11}, {"Ù",  9}, {"Ú",  9}, {"Û",      9}, {"Ü",  9}, {"Ý", 10}, {"Þ",  8},
    {"ß",  8}, {"à",  8}, {"á",  8}, {"â",  8}, {"ã",  8}, {"ä",  8}, {"å",  8}, {"æ",     11}, {"ç",  8}, {"è",  8}, {"é",  8},
    {"ê",  8}, {"ë",  8}, {"ì",  5}, {"í",  5}, {"î",  5}, {"ï",  5}, {"ð",  9}, {"ñ",      7}, {"ò",  9}, {"ó",  9}, {"ô",  9},
    {"õ",  9}, {"ö",  9}, {"÷", 11}, {"ø",  9}, {"ù",  7}, {"ú",  7}, {"û",  7}, {"ü",      7}, {"ý",  8}, {"þ",  8}, {"ÿ",  8},
    {"Œ", 11}, {"œ", 11}, {"„",  5}, {"”",  5}, {"€", 10}, {"Ÿ", 10},
};
    ...
    while (totalPixelWidth < maxLinePixelWidth && currentPos < textStr->length())
    {
        ...
        if (textStr->at(currentPos) == '\x7F') {
            ...
            if (pixelWidthTable.count(textStr->substr(currentPos, 1))) {
                ...
                CitraPrint("Table does not contain " + textStr->substr(currentPos, 1) + "/" + textStr->substr(currentPos, 2));
