...
void LocationTable_Init() {
    ...
    locationTable[LW_DEKU_SCRUB_NEAR_DEKU_THEATER_RIGHT] = ItemLocation::Base       (0x5B, 0x30, "LW Deku Scrub Near Deku Theater Right",LW_DEKU_SCRUB_NEAR_DEKU_THEATER_RIGHT, {Category::cLostWoods, Category::cForest, Category::cDekuScrub},                                                      SpoilerCollectionCheck::Scrub(0x5B, 0x01));
    locationTable[LW_DEKU_SCRUB_NEAR_DEKU_THEATER_LEFT]  = ItemLocation::Base       (0x5B, 0x31, "LW Deku Scrub Near Deku Theater Left", LW_DEKU_SCRUB_NEAR_DEKU_THEATER_LEFT,  {Category::cLostWoods, Category::cForest, Category::cDekuScrub},                                                      SpoilerCollectionCheck::Scrub(0x5B, 0x02));
    locationTable[LW_DEKU_SCRUB_NEAR_BRIDGE]             = ItemLocation::Base       (0x5B, 0x77, "LW Deku Scrub Near Bridge",            LW_DEKU_SCRUB_NEAR_BRIDGE,             {Category::cLostWoods, Category::cForest, Category::cDekuScrub, Category::cDekuScrubUpgrades},                        SpoilerCollectionCheck::Scrub(0x5B, 0x0A));
    locationTable[LW_DEKU_SCRUB_GROTTO_REAR]             = ItemLocation::GrottoScrub(0xF5, 0x33, "LW Deku Scrub Grotto Rear",            LW_DEKU_SCRUB_GROTTO_REAR,             {Category::cLostWoods, Category::cForest, Category::cDekuScrub, Category::cGrotto},                                   SpoilerCollectionCheck::Scrub(0x1F, 0x04));
    locationTable[LW_DEKU_SCRUB_GROTTO_FRONT]            = ItemLocation::GrottoScrub(0xF5, 0x79, "LW Deku Scrub Grotto Front",           LW_DEKU_SCRUB_GROTTO_FRONT,            {Category::cLostWoods, Category::cForest, Category::cDekuScrub, Category::cDekuScrubUpgrades, Category::cGrotto},     SpoilerCollectionCheck::Scrub(0x1F, 0x0B));
    ...
    locationTable[SFM_DEKU_SCRUB_GROTTO_REAR]            = ItemLocation::GrottoScrub(0xEE, 0x39, "SFM Deku Scrub Grotto Rear",           SFM_DEKU_SCRUB_GROTTO_REAR,            {Category::cSacredForestMeadow, Category::cForest, Category::cDekuScrub, Category::cGrotto},                          SpoilerCollectionCheck::Scrub(0x18, 0x08));
    locationTable[SFM_DEKU_SCRUB_GROTTO_FRONT]           = ItemLocation::GrottoScrub(0xEE, 0x3A, "SFM Deku Scrub Grotto Front",          SFM_DEKU_SCRUB_GROTTO_FRONT,           {Category::cSacredForestMeadow, Category::cForest, Category::cDekuScrub, Category::cGrotto},                          SpoilerCollectionCheck::Scrub(0x18, 0x09));
    ...
    locationTable[HF_DEKU_SCRUB_GROTTO]                  = ItemLocation::GrottoScrub(0xE6, 0x3E, "HF Deku Scrub Grotto",                 HF_DEKU_SCRUB_GROTTO,                  {Category::cHyruleField, Category::cDekuScrub, Category::cDekuScrubUpgrades, Category::cGrotto},                      SpoilerCollectionCheck::Scrub(0x10, 0x03));

    //Lake Hylia
    locationTable[LH_CHILD_FISHING]                      = ItemLocation::Base       (0x49, 0x3E, "LH Child Fishing",                     LH_CHILD_FISHING,                      {Category::cLakeHylia, Category::cMinigame,},                                                                         SpoilerCollectionCheck::Fishing(0x02));
    ...
    locationTable[LH_DEKU_SCRUB_GROTTO_CENTER]           = ItemLocation::GrottoScrub(0xEF, 0x33, "LH Deku Scrub Grotto Center",          LH_DEKU_SCRUB_GROTTO_CENTER,           {Category::cLakeHylia, Category::cDekuScrub, Category::cGrotto},                                                      SpoilerCollectionCheck::Scrub(0x19, 0x04));
    ...
    locationTable[GV_DEKU_SCRUB_GROTTO_REAR]             = ItemLocation::GrottoScrub(0xF0, 0x39, "GV Deku Scrub Grotto Rear",            GV_DEKU_SCRUB_GROTTO_REAR,             {Category::cGerudoValley, Category::cGerudo, Category::cDekuScrub, Category::cGrotto},                                SpoilerCollectionCheck::Scrub(0x1A, 0x08));
    locationTable[GV_DEKU_SCRUB_GROTTO_FRONT]            = ItemLocation::GrottoScrub(0xF0, 0x3A, "GV Deku Scrub Grotto Front",           GV_DEKU_SCRUB_GROTTO_FRONT,            {Category::cGerudoValley, Category::cGerudo, Category::cDekuScrub, Category::cGrotto},                                SpoilerCollectionCheck::Scrub(0x1A, 0x09));
    ...
    locationTable[COLOSSUS_DEKU_SCRUB_GROTTO_REAR]       = ItemLocation::GrottoScrub(0xFD, 0x39, "Colossus Deku Scrub Grotto Rear",      COLOSSUS_DEKU_SCRUB_GROTTO_REAR,       {Category::cDesertColossus, Category::cDekuScrub, Category::cGrotto},                                                 SpoilerCollectionCheck::Scrub(0x27, 0x08));
    locationTable[COLOSSUS_DEKU_SCRUB_GROTTO_FRONT]      = ItemLocation::GrottoScrub(0xFD, 0x3A, "Colossus Deku Scrub Grotto Front",     COLOSSUS_DEKU_SCRUB_GROTTO_FRONT,      {Category::cDesertColossus, Category::cDekuScrub, Category::cGrotto},                                                 SpoilerCollectionCheck::Scrub(0x27, 0x09));
    ...
    locationTable[MARKET_BOMBCHU_BOWLING_FIRST_PRIZE]    = ItemLocation::Base       (0x4B, 0x33, "MK Bombchu Bowling First Prize",       MARKET_BOMBCHU_BOWLING_FIRST_PRIZE,    {Category::cInnerMarket, Category::cMarket, Category::cMinigame},                                                     SpoilerCollectionCheck::ItemGetInf(25));
    locationTable[MARKET_BOMBCHU_BOWLING_SECOND_PRIZE]   = ItemLocation::Base       (0x4B, 0x3E, "MK Bombchu Bowling Second Prize",      MARKET_BOMBCHU_BOWLING_SECOND_PRIZE,   {Category::cInnerMarket, Category::cMarket, Category::cMinigame},                                                     SpoilerCollectionCheck::ItemGetInf(26));
    ...
    locationTable[MARKET_SHOOTING_GALLERY_REWARD]        = ItemLocation::Base       (0x42, 0x60, "MK Shooting Gallery",                  MARKET_SHOOTING_GALLERY_REWARD,        {Category::cInnerMarket, Category::cMarket, Category::cMinigame},                                                     SpoilerCollectionCheck::ItemGetInf(5));
    locationTable[MARKET_10_BIG_POES]                    = ItemLocation::Base       (0x4D, 0x0F, "MK 10 Big Poes",                       MARKET_10_BIG_POES,                    {Category::cInnerMarket, Category::cMarket,},                                                                         SpoilerCollectionCheck::BigPoePoints());
    ...
    locationTable[DMT_BIGGORON]                          = ItemLocation::Base       (0x60, 0x57, "DMT Biggoron",                         DMT_BIGGORON,                          {Category::cDeathMountainTrail, Category::cDeathMountain,},                                                           SpoilerCollectionCheck::Biggoron());
    ...
    locationTable[GC_DARUNIAS_JOY]                       = ItemLocation::Base       (0x62, 0x54, "GC Darunias Joy",                      GC_DARUNIAS_JOY,                       {Category::cGoronCity,},                                                                                              SpoilerCollectionCheck::EventChkInf(0x36));
    ...
    locationTable[GC_MEDIGORON]                          = ItemLocation::Base       (0x62, 0x51, "GC Medigoron",                         GC_MEDIGORON,                          {Category::cGoronCity, Category::cMerchant,},                                                                         SpoilerCollectionCheck::EventChkInf(0x35));
    ...
    locationTable[DMC_DEKU_SCRUB]                        = ItemLocation::Base       (0x61, 0x37, "DMC Deku Scrub",                       DMC_DEKU_SCRUB,                        {Category::cDeathMountainCrater, Category::cDeathMountain, Category::cDekuScrub},                                     SpoilerCollectionCheck::Scrub(0x61, 0x06));
    locationTable[DMC_DEKU_SCRUB_GROTTO_LEFT]            = ItemLocation::GrottoScrub(0xF9, 0x30, "DMC Deku Scrub Grotto Left",           DMC_DEKU_SCRUB_GROTTO_LEFT,            {Category::cDeathMountainCrater, Category::cDeathMountain, Category::cDekuScrub, Category::cGrotto},                  SpoilerCollectionCheck::Scrub(0x23, 0x01));
    locationTable[DMC_DEKU_SCRUB_GROTTO_RIGHT]           = ItemLocation::GrottoScrub(0xF9, 0x37, "DMC Deku Scrub Grotto Right",          DMC_DEKU_SCRUB_GROTTO_RIGHT,           {Category::cDeathMountainCrater, Category::cDeathMountain, Category::cDekuScrub, Category::cGrotto},                  SpoilerCollectionCheck::Scrub(0x23, 0x06));
    ...
    locationTable[ZR_MAGIC_BEAN_SALESMAN]                = ItemLocation::Base       (0x54, 0x16, "ZR Magic Bean Salesman",               ZR_MAGIC_BEAN_SALESMAN,                {Category::cZorasRiver,},                                                                                             SpoilerCollectionCheck::MagicBeans(0x54, 0x01));
    ...
    locationTable[ZR_DEKU_SCRUB_GROTTO_FRONT]            = ItemLocation::GrottoScrub(0xEB, 0x3A, "ZR Deku Scrub Grotto Front",           ZR_DEKU_SCRUB_GROTTO_FRONT,            {Category::cZorasRiver, Category::cDekuScrub, Category::cGrotto},                                                     SpoilerCollectionCheck::Scrub(0x15, 0x09));
    ...
    locationTable[LLR_DEKU_SCRUB_GROTTO_LEFT]            = ItemLocation::GrottoScrub(0xFC, 0x30, "LLR Deku Scrub Grotto Left",           LLR_DEKU_SCRUB_GROTTO_LEFT,            {Category::cLonLonRanch, Category::cDekuScrub, Category::cGrotto},                                                    SpoilerCollectionCheck::Scrub(0x26, 0x01));
    locationTable[LLR_DEKU_SCRUB_GROTTO_RIGHT]           = ItemLocation::GrottoScrub(0xFC, 0x37, "LLR Deku Scrub Grotto Right",          LLR_DEKU_SCRUB_GROTTO_RIGHT,           {Category::cLonLonRanch, Category::cDekuScrub, Category::cGrotto},                                                    SpoilerCollectionCheck::Scrub(0x26, 0x06));
    locationTable[LLR_DEKU_SCRUB_GROTTO_CENTER]          = ItemLocation::GrottoScrub(0xFC, 0x33, "LLR Deku Scrub Grotto Center",         LLR_DEKU_SCRUB_GROTTO_CENTER,          {Category::cLonLonRanch, Category::cDekuScrub, Category::cGrotto},                                                    SpoilerCollectionCheck::Scrub(0x26, 0x04));
    ...
    locationTable[DEKU_TREE_MQ_DEKU_SCRUB]                                     = ItemLocation::Base       (0x00, 0x34, "Deku Tree MQ Deku Scrub",                            DEKU_TREE_MQ_DEKU_SCRUB,                {Category::cDekuTree,},                                                          SpoilerCollectionCheck::Scrub(0x00, 0x05));
    ...
    locationTable[DODONGOS_CAVERN_DEKU_SCRUB_NEAR_BOMB_BAG_LEFT]               = ItemLocation::Base       (0x01, 0x30, "Dodongos Cavern Deku Scrub Near Bomb Bag Left",      DODONGOS_CAVERN_DEKU_SCRUB_NEAR_BOMB_BAG_LEFT,      {Category::cDodongosCavern, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x01, 0x01));
    locationTable[DODONGOS_CAVERN_DEKU_SCRUB_SIDE_ROOM_NEAR_DODONGOS]          = ItemLocation::Base       (0x01, 0x31, "Dodongos Cavern Deku Scrub Side Room Near Dodongos", DODONGOS_CAVERN_DEKU_SCRUB_SIDE_ROOM_NEAR_DODONGOS, {Category::cDodongosCavern, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x01, 0x02));
    locationTable[DODONGOS_CAVERN_DEKU_SCRUB_NEAR_BOMB_BAG_RIGHT]              = ItemLocation::Base       (0x01, 0x33, "Dodongos Cavern Deku Scrub Near Bomb Bag Right",     DODONGOS_CAVERN_DEKU_SCRUB_NEAR_BOMB_BAG_RIGHT,     {Category::cDodongosCavern, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x01, 0x04));
    locationTable[DODONGOS_CAVERN_DEKU_SCRUB_LOBBY]                            = ItemLocation::Base       (0x01, 0x34, "Dodongos Cavern Deku Scrub Lobby",                   DODONGOS_CAVERN_DEKU_SCRUB_LOBBY,                   {Category::cDodongosCavern, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x01, 0x05));
    //Dodongos Cavern MQ
    ...
    locationTable[DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_REAR]                    = ItemLocation::Base       (0x01, 0x31, "Dodongos Cavern Deku Scrub Lobby Rear",              DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_REAR,                        {Category::cDodongosCavern, Category::cDekuScrub,},     SpoilerCollectionCheck::Scrub(0x01, 0x02));
    locationTable[DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_FRONT]                   = ItemLocation::Base       (0x01, 0x33, "Dodongos Cavern Deku Scrub Lobby Front",             DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_FRONT,                       {Category::cDodongosCavern, Category::cDekuScrub,},     SpoilerCollectionCheck::Scrub(0x01, 0x04));
    locationTable[DODONGOS_CAVERN_MQ_DEKU_SCRUB_STAIRCASE]                     = ItemLocation::Base       (0x01, 0x34, "Dodongos Cavern Deku Scrub Staircase",               DODONGOS_CAVERN_MQ_DEKU_SCRUB_STAIRCASE,                         {Category::cDodongosCavern, Category::cDekuScrub,},     SpoilerCollectionCheck::Scrub(0x01, 0x05));
    ...
    locationTable[JABU_JABUS_BELLY_DEKU_SCRUB]                                 = ItemLocation::Base       (0x02, 0x30, "Jabu Jabus Belly Deku Scrub",                        JABU_JABUS_BELLY_DEKU_SCRUB,                    {Category::cJabuJabusBelly, Category::cDekuScrub,},                      SpoilerCollectionCheck::Scrub(0x02, 0x01));
    //Jabu Jabus Belly MQ
    ...
    locationTable[GANONS_CASTLE_DEKU_SCRUB_CENTER_LEFT]                        = ItemLocation::Base       (0x0D, 0x37, "Ganon's Castle Deku Scrub Center-Left",                 GANONS_CASTLE_DEKU_SCRUB_CENTER_LEFT,              {Category::cGanonsCastle, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x0D, 0x06));
    locationTable[GANONS_CASTLE_DEKU_SCRUB_CENTER_RIGHT]                       = ItemLocation::Base       (0x0D, 0x33, "Ganon's Castle Deku Scrub Center-Right",                GANONS_CASTLE_DEKU_SCRUB_CENTER_RIGHT,             {Category::cGanonsCastle, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x0D, 0x04));
    locationTable[GANONS_CASTLE_DEKU_SCRUB_RIGHT]                              = ItemLocation::Base       (0x0D, 0x39, "Ganon's Castle Deku Scrub Right",                       GANONS_CASTLE_DEKU_SCRUB_RIGHT,                    {Category::cGanonsCastle, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x0D, 0x08));
    locationTable[GANONS_CASTLE_DEKU_SCRUB_LEFT]                               = ItemLocation::Base       (0x0D, 0x3A, "Ganon's Castle Deku Scrub Left",                        GANONS_CASTLE_DEKU_SCRUB_LEFT,                     {Category::cGanonsCastle, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x0D, 0x09));
    //Ganons Castle MQ
    ...
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_RIGHT]                           = ItemLocation::Base       (0x0D, 0x30, "Ganon's Castle MQ Deku Scrub Right",                    GANONS_CASTLE_MQ_DEKU_SCRUB_RIGHT,                     {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x0D, 0x01));
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_LEFT]                     = ItemLocation::Base       (0x0D, 0x37, "Ganon's Castle MQ Deku Scrub Center-Left",              GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_LEFT,               {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x0D, 0x06));
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER]                          = ItemLocation::Base       (0x0D, 0x33, "Ganon's Castle MQ Deku Scrub Center",                   GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER,                    {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x0D, 0x04));
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_RIGHT]                    = ItemLocation::Base       (0x0D, 0x39, "Ganon's Castle MQ Deku Scrub Center-Right",             GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_RIGHT,              {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x0D, 0x08));
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_LEFT]                            = ItemLocation::Base       (0x0D, 0x3A, "Ganon's Castle MQ Deku Scrub Left",                     GANONS_CASTLE_MQ_DEKU_SCRUB_LEFT,                      {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x0D, 0x09));
    ...
    locationTable[QUEEN_GOHMA]                                   = ItemLocation::Reward (0xFF, DUNGEON_DEKU_TREE,       "Queen Gohma",                 QUEEN_GOHMA,                      {},                                                                                                          SpoilerCollectionCheck::EventChkInf(0x09));
    ...
    locationTable[DEKU_TREE_QUEEN_GOHMA_HEART]                   = ItemLocation::Base   (0x11, 0x4F, "Deku Tree Queen Gohma Heart Container",          DEKU_TREE_QUEEN_GOHMA_HEART,        {Category::cDekuTree, Category::cBossHeart, Category::cSongDungeonReward},                                 SpoilerCollectionCheck::Collectable(0x11, 0x1F));
    locationTable[DODONGOS_CAVERN_KING_DODONGO_HEART]            = ItemLocation::Base   (0x12, 0x4F, "Dodongos Cavern King Dodongo Heart Container",   DODONGOS_CAVERN_KING_DODONGO_HEART, {Category::cDodongosCavern, Category::cBossHeart, Category::cSongDungeonReward},                           SpoilerCollectionCheck::Collectable(0x12, 0x1F));
    locationTable[JABU_JABUS_BELLY_BARINADE_HEART]               = ItemLocation::Base   (0x13, 0x4F, "Jabu Jabus Belly Barinade Heart Container",      JABU_JABUS_BELLY_BARINADE_HEART,    {Category::cJabuJabusBelly, Category::cBossHeart, Category::cSongDungeonReward},                           SpoilerCollectionCheck::Collectable(0x13, 0x1F));
    locationTable[FOREST_TEMPLE_PHANTOM_GANON_HEART]             = ItemLocation::Base   (0x14, 0x4F, "Forest Temple Phantom Ganon Heart Container",    FOREST_TEMPLE_PHANTOM_GANON_HEART,  {Category::cForestTemple, Category::cBossHeart, Category::cSongDungeonReward},                             SpoilerCollectionCheck::Collectable(0x14, 0x1F));
    locationTable[FIRE_TEMPLE_VOLVAGIA_HEART]                    = ItemLocation::Base   (0x15, 0x4F, "Fire Temple Volvagia Heart Container",           FIRE_TEMPLE_VOLVAGIA_HEART,         {Category::cFireTemple, Category::cBossHeart, Category::cSongDungeonReward},                               SpoilerCollectionCheck::Collectable(0x15, 0x1F));
    locationTable[WATER_TEMPLE_MORPHA_HEART]                     = ItemLocation::Base   (0x16, 0x4F, "Water Temple Morpha Heart Container",            WATER_TEMPLE_MORPHA_HEART,          {Category::cWaterTemple, Category::cBossHeart, Category::cSongDungeonReward},                              SpoilerCollectionCheck::Collectable(0x16, 0x1F));
    locationTable[SPIRIT_TEMPLE_TWINROVA_HEART]                  = ItemLocation::Base   (0x17, 0x4F, "Spirit Temple Twinrova Heart Container",         SPIRIT_TEMPLE_TWINROVA_HEART,       {Category::cSpiritTemple, Category::cBossHeart, Category::cSongDungeonReward},                             SpoilerCollectionCheck::Collectable(0x17, 0x1F));
    locationTable[SHADOW_TEMPLE_BONGO_BONGO_HEART]               = ItemLocation::Base   (0x18, 0x4F, "Shadow Temple Bongo Bongo Heart Container",      SHADOW_TEMPLE_BONGO_BONGO_HEART,    {Category::cShadowTemple, Category::cBossHeart, Category::cSongDungeonReward},                             SpoilerCollectionCheck::Collectable(0x18, 0x1F));
    ...
    locationTable[DMT_GREAT_FAIRY_REWARD]                        = ItemLocation::Delayed(0xFF, 0x13, "DMT Great Fairy Reward",                         DMT_GREAT_FAIRY_REWARD,            {Category::cDeathMountainTrail, Category::cDeathMountain, Category::cFairies},                              SpoilerCollectionCheck::Chest(0x3B, 0x00));
    locationTable[DMC_GREAT_FAIRY_REWARD]                        = ItemLocation::Delayed(0xFF, 0x14, "DMC Great Fairy Reward",                         DMC_GREAT_FAIRY_REWARD,            {Category::cDeathMountainCrater, Category::cDeathMountain, Category::cFairies},                             SpoilerCollectionCheck::Chest(0x3B, 0x01));
    locationTable[OGC_GREAT_FAIRY_REWARD]                        = ItemLocation::Delayed(0xFF, 0x15, "OGC Great Fairy Reward",                         OGC_GREAT_FAIRY_REWARD,            {Category::cOutsideGanonsCastle, Category::cMarket, Category::cFairies},                                    SpoilerCollectionCheck::Chest(0x3B, 0x02));
    ...
    locationTable[SONG_FROM_SARIA]                               = ItemLocation::Delayed(0xFF, 0x28, "Song from Saria",                                SONG_FROM_SARIA,                   {Category::cSacredForestMeadow, Category::cForest, Category::cSong,},                                       SpoilerCollectionCheck::EventChkInf(0x57));
    ...
    locationTable[KF_SHOP_ITEM_1]                                = ItemLocation::Base(0x2D, 0x30, "KF Shop Item 1",                                   KF_SHOP_ITEM_1,             {Category::cKokiriForest, Category::cForest, Category::cShop},                                                      SpoilerCollectionCheck::ShopItem(0x2D, 0));
    locationTable[KF_SHOP_ITEM_2]                                = ItemLocation::Base(0x2D, 0x31, "KF Shop Item 2",                                   KF_SHOP_ITEM_2,             {Category::cKokiriForest, Category::cForest, Category::cShop},                                                      SpoilerCollectionCheck::ShopItem(0x2D, 1));
    locationTable[KF_SHOP_ITEM_3]                                = ItemLocation::Base(0x2D, 0x32, "KF Shop Item 3",                                   KF_SHOP_ITEM_3,             {Category::cKokiriForest, Category::cForest, Category::cShop},                                                      SpoilerCollectionCheck::ShopItem(0x2D, 2));
    locationTable[KF_SHOP_ITEM_4]                                = ItemLocation::Base(0x2D, 0x33, "KF Shop Item 4",                                   KF_SHOP_ITEM_4,             {Category::cKokiriForest, Category::cForest, Category::cShop},                                                      SpoilerCollectionCheck::ShopItem(0x2D, 3));
    locationTable[KF_SHOP_ITEM_5]                                = ItemLocation::Base(0x2D, 0x34, "KF Shop Item 5",                                   KF_SHOP_ITEM_5,             {Category::cKokiriForest, Category::cForest, Category::cShop},                                                      SpoilerCollectionCheck::ShopItem(0x2D, 4));
    locationTable[KF_SHOP_ITEM_6]                                = ItemLocation::Base(0x2D, 0x35, "KF Shop Item 6",                                   KF_SHOP_ITEM_6,             {Category::cKokiriForest, Category::cForest, Category::cShop},                                                      SpoilerCollectionCheck::ShopItem(0x2D, 5));
    locationTable[KF_SHOP_ITEM_7]                                = ItemLocation::Base(0x2D, 0x36, "KF Shop Item 7",                                   KF_SHOP_ITEM_7,             {Category::cKokiriForest, Category::cForest, Category::cShop},                                                      SpoilerCollectionCheck::ShopItem(0x2D, 6));
    locationTable[KF_SHOP_ITEM_8]                                = ItemLocation::Base(0x2D, 0x37, "KF Shop Item 8",                                   KF_SHOP_ITEM_8,             {Category::cKokiriForest, Category::cForest, Category::cShop},                                                      SpoilerCollectionCheck::ShopItem(0x2D, 7));

    locationTable[KAK_POTION_SHOP_ITEM_1]                        = ItemLocation::Base(0x30, 0x30, "Kak Potion Shop Item 1",                           KAK_POTION_SHOP_ITEM_1,     {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x30, 0));
    locationTable[KAK_POTION_SHOP_ITEM_2]                        = ItemLocation::Base(0x30, 0x31, "Kak Potion Shop Item 2",                           KAK_POTION_SHOP_ITEM_2,     {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x30, 1));
    locationTable[KAK_POTION_SHOP_ITEM_3]                        = ItemLocation::Base(0x30, 0x32, "Kak Potion Shop Item 3",                           KAK_POTION_SHOP_ITEM_3,     {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x30, 2));
    locationTable[KAK_POTION_SHOP_ITEM_4]                        = ItemLocation::Base(0x30, 0x33, "Kak Potion Shop Item 4",                           KAK_POTION_SHOP_ITEM_4,     {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x30, 3));
    locationTable[KAK_POTION_SHOP_ITEM_5]                        = ItemLocation::Base(0x30, 0x34, "Kak Potion Shop Item 5",                           KAK_POTION_SHOP_ITEM_5,     {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x30, 4));
    locationTable[KAK_POTION_SHOP_ITEM_6]                        = ItemLocation::Base(0x30, 0x35, "Kak Potion Shop Item 6",                           KAK_POTION_SHOP_ITEM_6,     {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x30, 5));
    locationTable[KAK_POTION_SHOP_ITEM_7]                        = ItemLocation::Base(0x30, 0x36, "Kak Potion Shop Item 7",                           KAK_POTION_SHOP_ITEM_7,     {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x30, 6));
    locationTable[KAK_POTION_SHOP_ITEM_8]                        = ItemLocation::Base(0x30, 0x37, "Kak Potion Shop Item 8",                           KAK_POTION_SHOP_ITEM_8,     {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x30, 7));

    locationTable[MARKET_BOMBCHU_SHOP_ITEM_1]                    = ItemLocation::Base(0x32, 0x30, "MK Bombchu Shop Item 1",                           MARKET_BOMBCHU_SHOP_ITEM_1, {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x32, 0));
    locationTable[MARKET_BOMBCHU_SHOP_ITEM_2]                    = ItemLocation::Base(0x32, 0x31, "MK Bombchu Shop Item 2",                           MARKET_BOMBCHU_SHOP_ITEM_2, {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x32, 1));
    locationTable[MARKET_BOMBCHU_SHOP_ITEM_3]                    = ItemLocation::Base(0x32, 0x32, "MK Bombchu Shop Item 3",                           MARKET_BOMBCHU_SHOP_ITEM_3, {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x32, 2));
    locationTable[MARKET_BOMBCHU_SHOP_ITEM_4]                    = ItemLocation::Base(0x32, 0x33, "MK Bombchu Shop Item 4",                           MARKET_BOMBCHU_SHOP_ITEM_4, {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x32, 3));
    locationTable[MARKET_BOMBCHU_SHOP_ITEM_5]                    = ItemLocation::Base(0x32, 0x34, "MK Bombchu Shop Item 5",                           MARKET_BOMBCHU_SHOP_ITEM_5, {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x32, 4));
    locationTable[MARKET_BOMBCHU_SHOP_ITEM_6]                    = ItemLocation::Base(0x32, 0x35, "MK Bombchu Shop Item 6",                           MARKET_BOMBCHU_SHOP_ITEM_6, {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x32, 5));
    locationTable[MARKET_BOMBCHU_SHOP_ITEM_7]                    = ItemLocation::Base(0x32, 0x36, "MK Bombchu Shop Item 7",                           MARKET_BOMBCHU_SHOP_ITEM_7, {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x32, 6));
    locationTable[MARKET_BOMBCHU_SHOP_ITEM_8]                    = ItemLocation::Base(0x32, 0x37, "MK Bombchu Shop Item 8",                           MARKET_BOMBCHU_SHOP_ITEM_8, {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x32, 7));

    locationTable[MARKET_POTION_SHOP_ITEM_1]                     = ItemLocation::Base(0x31, 0x30, "MK Potion Shop Item 1",                            MARKET_POTION_SHOP_ITEM_1,  {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x31, 0));
    locationTable[MARKET_POTION_SHOP_ITEM_2]                     = ItemLocation::Base(0x31, 0x31, "MK Potion Shop Item 2",                            MARKET_POTION_SHOP_ITEM_2,  {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x31, 1));
    locationTable[MARKET_POTION_SHOP_ITEM_3]                     = ItemLocation::Base(0x31, 0x32, "MK Potion Shop Item 3",                            MARKET_POTION_SHOP_ITEM_3,  {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x31, 2));
    locationTable[MARKET_POTION_SHOP_ITEM_4]                     = ItemLocation::Base(0x31, 0x33, "MK Potion Shop Item 4",                            MARKET_POTION_SHOP_ITEM_4,  {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x31, 3));
    locationTable[MARKET_POTION_SHOP_ITEM_5]                     = ItemLocation::Base(0x31, 0x34, "MK Potion Shop Item 5",                            MARKET_POTION_SHOP_ITEM_5,  {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x31, 4));
    locationTable[MARKET_POTION_SHOP_ITEM_6]                     = ItemLocation::Base(0x31, 0x35, "MK Potion Shop Item 6",                            MARKET_POTION_SHOP_ITEM_6,  {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x31, 5));
    locationTable[MARKET_POTION_SHOP_ITEM_7]                     = ItemLocation::Base(0x31, 0x36, "MK Potion Shop Item 7",                            MARKET_POTION_SHOP_ITEM_7,  {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x31, 6));
    locationTable[MARKET_POTION_SHOP_ITEM_8]                     = ItemLocation::Base(0x31, 0x37, "MK Potion Shop Item 8",                            MARKET_POTION_SHOP_ITEM_8,  {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x31, 7));

    locationTable[MARKET_BAZAAR_ITEM_1]                          = ItemLocation::Base(0x2C, 0x30, "MK Bazaar Item 1",                                 MARKET_BAZAAR_ITEM_1,       {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x2C, 0));
    locationTable[MARKET_BAZAAR_ITEM_2]                          = ItemLocation::Base(0x2C, 0x31, "MK Bazaar Item 2",                                 MARKET_BAZAAR_ITEM_2,       {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x2C, 1));
    locationTable[MARKET_BAZAAR_ITEM_3]                          = ItemLocation::Base(0x2C, 0x32, "MK Bazaar Item 3",                                 MARKET_BAZAAR_ITEM_3,       {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x2C, 2));
    locationTable[MARKET_BAZAAR_ITEM_4]                          = ItemLocation::Base(0x2C, 0x33, "MK Bazaar Item 4",                                 MARKET_BAZAAR_ITEM_4,       {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x2C, 3));
    locationTable[MARKET_BAZAAR_ITEM_5]                          = ItemLocation::Base(0x2C, 0x34, "MK Bazaar Item 5",                                 MARKET_BAZAAR_ITEM_5,       {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x2C, 4));
    locationTable[MARKET_BAZAAR_ITEM_6]                          = ItemLocation::Base(0x2C, 0x35, "MK Bazaar Item 6",                                 MARKET_BAZAAR_ITEM_6,       {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x2C, 5));
    locationTable[MARKET_BAZAAR_ITEM_7]                          = ItemLocation::Base(0x2C, 0x36, "MK Bazaar Item 7",                                 MARKET_BAZAAR_ITEM_7,       {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x2C, 6));
    locationTable[MARKET_BAZAAR_ITEM_8]                          = ItemLocation::Base(0x2C, 0x37, "MK Bazaar Item 8",                                 MARKET_BAZAAR_ITEM_8,       {Category::cInnerMarket, Category::cMarket, Category::cShop},                                                       SpoilerCollectionCheck::ShopItem(0x2C, 7));

    locationTable[KAK_BAZAAR_ITEM_1]                             = ItemLocation::Base(0x2C, 0x38, "Kak Bazaar Item 1",                                KAK_BAZAAR_ITEM_1,          {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x33, 0));
    locationTable[KAK_BAZAAR_ITEM_2]                             = ItemLocation::Base(0x2C, 0x39, "Kak Bazaar Item 2",                                KAK_BAZAAR_ITEM_2,          {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x33, 1));
    locationTable[KAK_BAZAAR_ITEM_3]                             = ItemLocation::Base(0x2C, 0x3A, "Kak Bazaar Item 3",                                KAK_BAZAAR_ITEM_3,          {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x33, 2));
    locationTable[KAK_BAZAAR_ITEM_4]                             = ItemLocation::Base(0x2C, 0x3B, "Kak Bazaar Item 4",                                KAK_BAZAAR_ITEM_4,          {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x33, 3));
    locationTable[KAK_BAZAAR_ITEM_5]                             = ItemLocation::Base(0x2C, 0x3C, "Kak Bazaar Item 5",                                KAK_BAZAAR_ITEM_5,          {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x33, 4));
    locationTable[KAK_BAZAAR_ITEM_6]                             = ItemLocation::Base(0x2C, 0x3D, "Kak Bazaar Item 6",                                KAK_BAZAAR_ITEM_6,          {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x33, 5));
    locationTable[KAK_BAZAAR_ITEM_7]                             = ItemLocation::Base(0x2C, 0x3E, "Kak Bazaar Item 7",                                KAK_BAZAAR_ITEM_7,          {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x33, 6));
    locationTable[KAK_BAZAAR_ITEM_8]                             = ItemLocation::Base(0x2C, 0x3F, "Kak Bazaar Item 8",                                KAK_BAZAAR_ITEM_8,          {Category::cKakarikoVillage, Category::cKakariko, Category::cShop},                                                 SpoilerCollectionCheck::ShopItem(0x33, 7));

    locationTable[ZD_SHOP_ITEM_1]                                = ItemLocation::Base(0x2F, 0x30, "ZD Shop Item 1",                                   ZD_SHOP_ITEM_1,             {Category::cZorasDomain, Category::cShop},                                                                          SpoilerCollectionCheck::ShopItem(0x2F, 0));
    locationTable[ZD_SHOP_ITEM_2]                                = ItemLocation::Base(0x2F, 0x31, "ZD Shop Item 2",                                   ZD_SHOP_ITEM_2,             {Category::cZorasDomain, Category::cShop},                                                                          SpoilerCollectionCheck::ShopItem(0x2F, 1));
    locationTable[ZD_SHOP_ITEM_3]                                = ItemLocation::Base(0x2F, 0x32, "ZD Shop Item 3",                                   ZD_SHOP_ITEM_3,             {Category::cZorasDomain, Category::cShop},                                                                          SpoilerCollectionCheck::ShopItem(0x2F, 2));
    locationTable[ZD_SHOP_ITEM_4]                                = ItemLocation::Base(0x2F, 0x33, "ZD Shop Item 4",                                   ZD_SHOP_ITEM_4,             {Category::cZorasDomain, Category::cShop},                                                                          SpoilerCollectionCheck::ShopItem(0x2F, 3));
    locationTable[ZD_SHOP_ITEM_5]                                = ItemLocation::Base(0x2F, 0x34, "ZD Shop Item 5",                                   ZD_SHOP_ITEM_5,             {Category::cZorasDomain, Category::cShop},                                                                          SpoilerCollectionCheck::ShopItem(0x2F, 4));
    locationTable[ZD_SHOP_ITEM_6]                                = ItemLocation::Base(0x2F, 0x35, "ZD Shop Item 6",                                   ZD_SHOP_ITEM_6,             {Category::cZorasDomain, Category::cShop},                                                                          SpoilerCollectionCheck::ShopItem(0x2F, 5));
    locationTable[ZD_SHOP_ITEM_7]                                = ItemLocation::Base(0x2F, 0x36, "ZD Shop Item 7",                                   ZD_SHOP_ITEM_7,             {Category::cZorasDomain, Category::cShop},                                                                          SpoilerCollectionCheck::ShopItem(0x2F, 6));
    locationTable[ZD_SHOP_ITEM_8]                                = ItemLocation::Base(0x2F, 0x37, "ZD Shop Item 8",                                   ZD_SHOP_ITEM_8,             {Category::cZorasDomain, Category::cShop},                                                                          SpoilerCollectionCheck::ShopItem(0x2F, 7));

    locationTable[GC_SHOP_ITEM_1]                                = ItemLocation::Base(0x2E, 0x30, "GC Shop Item 1",                                   GC_SHOP_ITEM_1,             {Category::cGoronCity, Category::cShop},                                                                            SpoilerCollectionCheck::ShopItem(0x2E, 0));
    locationTable[GC_SHOP_ITEM_2]                                = ItemLocation::Base(0x2E, 0x31, "GC Shop Item 2",                                   GC_SHOP_ITEM_2,             {Category::cGoronCity, Category::cShop},                                                                            SpoilerCollectionCheck::ShopItem(0x2E, 1));
    locationTable[GC_SHOP_ITEM_3]                                = ItemLocation::Base(0x2E, 0x32, "GC Shop Item 3",                                   GC_SHOP_ITEM_3,             {Category::cGoronCity, Category::cShop},                                                                            SpoilerCollectionCheck::ShopItem(0x2E, 2));
    locationTable[GC_SHOP_ITEM_4]                                = ItemLocation::Base(0x2E, 0x33, "GC Shop Item 4",                                   GC_SHOP_ITEM_4,             {Category::cGoronCity, Category::cShop},                                                                            SpoilerCollectionCheck::ShopItem(0x2E, 3));
    locationTable[GC_SHOP_ITEM_5]                                = ItemLocation::Base(0x2E, 0x34, "GC Shop Item 5",                                   GC_SHOP_ITEM_5,             {Category::cGoronCity, Category::cShop},                                                                            SpoilerCollectionCheck::ShopItem(0x2E, 4));
    locationTable[GC_SHOP_ITEM_6]                                = ItemLocation::Base(0x2E, 0x35, "GC Shop Item 6",                                   GC_SHOP_ITEM_6,             {Category::cGoronCity, Category::cShop},                                                                            SpoilerCollectionCheck::ShopItem(0x2E, 5));
    locationTable[GC_SHOP_ITEM_7]                                = ItemLocation::Base(0x2E, 0x36, "GC Shop Item 7",                                   GC_SHOP_ITEM_7,             {Category::cGoronCity, Category::cShop},                                                                            SpoilerCollectionCheck::ShopItem(0x2E, 6));
    locationTable[GC_SHOP_ITEM_8]                                = ItemLocation::Base(0x2E, 0x37, "GC Shop Item 8",                                   GC_SHOP_ITEM_8,             {Category::cGoronCity, Category::cShop},                                                                            SpoilerCollectionCheck::ShopItem(0x2E, 7));
