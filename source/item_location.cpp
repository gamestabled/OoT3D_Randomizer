...
void LocationTable_Init() {
    ...
    locationTable[DEKU_TREE_MQ_DEKU_SCRUB]                                     = ItemLocation::Base       (0x00, 0x34, "Deku Tree MQ Deku Scrub",                            DEKU_TREE_MQ_DEKU_SCRUB,                {Category::cDekuTree,},                                                          SpoilerCollectionCheck::Scrub(0x00, 0x00));
    ...
    locationTable[DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_REAR]                    = ItemLocation::Base       (0x01, 0x31, "Dodongos Cavern Deku Scrub Lobby Rear",              DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_REAR,                        {Category::cDodongosCavern, Category::cDekuScrub,},     SpoilerCollectionCheck::Scrub(0x01, 0x00));
    locationTable[DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_FRONT]                   = ItemLocation::Base       (0x01, 0x33, "Dodongos Cavern Deku Scrub Lobby Front",             DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_FRONT,                       {Category::cDodongosCavern, Category::cDekuScrub,},     SpoilerCollectionCheck::Scrub(0x01, 0x00));
    locationTable[DODONGOS_CAVERN_MQ_DEKU_SCRUB_STAIRCASE]                     = ItemLocation::Base       (0x01, 0x34, "Dodongos Cavern Deku Scrub Staircase",               DODONGOS_CAVERN_MQ_DEKU_SCRUB_STAIRCASE,                         {Category::cDodongosCavern, Category::cDekuScrub,},     SpoilerCollectionCheck::Scrub(0x01, 0x00));
    ...
    locationTable[GANONS_CASTLE_DEKU_SCRUB_CENTER_LEFT]                        = ItemLocation::Base       (0x0D, 0x37, "Ganon's Castle Deku Scrub Center-Left",                 GANONS_CASTLE_DEKU_SCRUB_CENTER_LEFT,              {Category::cGanonsCastle, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x0D, 0x00));
    locationTable[GANONS_CASTLE_DEKU_SCRUB_CENTER_RIGHT]                       = ItemLocation::Base       (0x0D, 0x33, "Ganon's Castle Deku Scrub Center-Right",                GANONS_CASTLE_DEKU_SCRUB_CENTER_RIGHT,             {Category::cGanonsCastle, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x0D, 0x00));
    locationTable[GANONS_CASTLE_DEKU_SCRUB_RIGHT]                              = ItemLocation::Base       (0x0D, 0x39, "Ganon's Castle Deku Scrub Right",                       GANONS_CASTLE_DEKU_SCRUB_RIGHT,                    {Category::cGanonsCastle, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x0D, 0x00));
    locationTable[GANONS_CASTLE_DEKU_SCRUB_LEFT]                               = ItemLocation::Base       (0x0D, 0x3A, "Ganon's Castle Deku Scrub Left",                        GANONS_CASTLE_DEKU_SCRUB_LEFT,                     {Category::cGanonsCastle, Category::cDekuScrub,},                  SpoilerCollectionCheck::Scrub(0x0D, 0x00));
    //Ganons Castle MQ
    ...
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_RIGHT]                           = ItemLocation::Base       (0x0D, 0x30, "Ganon's Castle MQ Deku Scrub Right",                    GANONS_CASTLE_MQ_DEKU_SCRUB_RIGHT,                     {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x01, 0x00));
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_LEFT]                     = ItemLocation::Base       (0x0D, 0x37, "Ganon's Castle MQ Deku Scrub Center-Left",              GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_LEFT,               {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x01, 0x00));
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER]                          = ItemLocation::Base       (0x0D, 0x33, "Ganon's Castle MQ Deku Scrub Center",                   GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER,                    {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x01, 0x00));
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_RIGHT]                    = ItemLocation::Base       (0x0D, 0x39, "Ganon's Castle MQ Deku Scrub Center-Right",             GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_RIGHT,              {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x01, 0x00));
    locationTable[GANONS_CASTLE_MQ_DEKU_SCRUB_LEFT]                            = ItemLocation::Base       (0x0D, 0x3A, "Ganon's Castle MQ Deku Scrub Left",                     GANONS_CASTLE_MQ_DEKU_SCRUB_LEFT,                      {Category::cGanonsCastle, Category::cDekuScrub,},              SpoilerCollectionCheck::Scrub(0x01, 0x00));
