...
void LocationTable_Init() {
    ...
    locationTable[LW_SKULL_KID]                          = ItemLocation::Base       (0x5B, 0x3E, "LW Skull Kid",                         LW_SKULL_KID,                          {Category::cLostWoods, Category::cForest,});
    locationTable[LW_OCARINA_MEMORY_GAME]                = ItemLocation::Base       (0x5B, 0x76, "LW Ocarina Memory Game",               LW_OCARINA_MEMORY_GAME,                {Category::cLostWoods, Category::cForest, Category::cMinigame});
    locationTable[LW_TARGET_IN_WOODS]                    = ItemLocation::Base       (0x5B, 0x60, "LW Target in Woods",                   LW_TARGET_IN_WOODS,                    {Category::cLostWoods, Category::cForest,});
    ...
    locationTable[LW_DEKU_SCRUB_NEAR_BRIDGE]             = ItemLocation::Base       (0x5B, 0x77, "LW Deku Scrub Near Bridge",            LW_DEKU_SCRUB_NEAR_BRIDGE,             {Category::cLostWoods, Category::cForest, Category::cDekuScrub, Category::cDekuScrubUpgrades});
    ...
    locationTable[LW_DEKU_SCRUB_GROTTO_FRONT]            = ItemLocation::GrottoScrub(0xF5, 0x79, "LW Deku Scrub Grotto Front",           LW_DEKU_SCRUB_GROTTO_FRONT,            {Category::cLostWoods, Category::cForest, Category::cDekuScrub, Category::cDekuScrubUpgrades, Category::cGrotto});
    locationTable[DEKU_THEATER_SKULL_MASK]               = ItemLocation::Base       (0x3E, 0x77, "Deku Theater Skull Mask",              DEKU_THEATER_SKULL_MASK,               {Category::cLostWoods, Category::cForest, Category::cGrotto});
    locationTable[DEKU_THEATER_MASK_OF_TRUTH]            = ItemLocation::Base       (0x3E, 0x7A, "Deku Theater Mask of Truth",           DEKU_THEATER_MASK_OF_TRUTH,            {Category::cLostWoods, Category::cForest, Category::cNeedSpiritualStones, Category::cGrotto});
    ...
    locationTable[HF_OCARINA_OF_TIME_ITEM]               = ItemLocation::Base       (0x51, 0x0C, "HF Ocarina of Time Item",              HF_OCARINA_OF_TIME_ITEM,               {Category::cHyruleField, Category::cNeedSpiritualStones,});
    ...
    locationTable[HF_DEKU_SCRUB_GROTTO]                  = ItemLocation::GrottoScrub(0xE6, 0x3E, "HF Deku Scrub Grotto",                 HF_DEKU_SCRUB_GROTTO,                  {Category::cHyruleField, Category::cDekuScrub, Category::cDekuScrubUpgrades, Category::cGrotto});

    //Lake Hylia
    locationTable[LH_CHILD_FISHING]                      = ItemLocation::Base       (0x49, 0x3E, "LH Child Fishing",                     LH_CHILD_FISHING,                      {Category::cLakeHylia, Category::cMinigame,});
    locationTable[LH_ADULT_FISHING]                      = ItemLocation::Base       (0x49, 0x38, "LH Adult Fishing",                     LH_ADULT_FISHING,                      {Category::cLakeHylia, Category::cMinigame,});
    locationTable[LH_LAB_DIVE]                           = ItemLocation::Base       (0x38, 0x3E, "LH Lab Dive",                          LH_LAB_DIVE,                           {Category::cLakeHylia,});
    locationTable[LH_UNDERWATER_ITEM]                    = ItemLocation::Base       (0x57, 0x15, "LH Underwater Item",                   LH_UNDERWATER_ITEM,                    {Category::cLakeHylia,});
    ...
    locationTable[GF_HBA_1000_POINTS]                    = ItemLocation::Base       (0x5D, 0x3E, "GF HBA 1000 Points",                   GF_HBA_1000_POINTS,                    {Category::cGerudoFortress, Category::cGerudo, Category::cMinigame});
    locationTable[GF_HBA_1500_POINTS]                    = ItemLocation::Base       (0x5D, 0x30, "GF HBA 1500 Points",                   GF_HBA_1500_POINTS,                    {Category::cGerudoFortress, Category::cGerudo, Category::cMinigame});
    ...
    locationTable[HC_ZELDAS_LETTER]                      = ItemLocation::Base       (0x4A, 0x0B, "HC Zeldas Letter",                     HC_ZELDAS_LETTER,                      {Category::cHyruleCastle, Category::cMarket,});
    ...
    locationTable[KAK_10_GOLD_SKULLTULA_REWARD]          = ItemLocation::Base       (0x50, 0x45, "Kak 10 Gold Skulltula Reward",         KAK_10_GOLD_SKULLTULA_REWARD,          {Category::cKakarikoVillage, Category::cKakariko, Category::cSkulltulaHouse});
    locationTable[KAK_20_GOLD_SKULLTULA_REWARD]          = ItemLocation::Base       (0x50, 0x39, "Kak 20 Gold Skulltula Reward",         KAK_20_GOLD_SKULLTULA_REWARD,          {Category::cKakarikoVillage, Category::cKakariko, Category::cSkulltulaHouse});
    locationTable[KAK_30_GOLD_SKULLTULA_REWARD]          = ItemLocation::Base       (0x50, 0x46, "Kak 30 Gold Skulltula Reward",         KAK_30_GOLD_SKULLTULA_REWARD,          {Category::cKakarikoVillage, Category::cKakariko, Category::cSkulltulaHouse});
    locationTable[KAK_40_GOLD_SKULLTULA_REWARD]          = ItemLocation::Base       (0x50, 0x03, "Kak 40 Gold Skulltula Reward",         KAK_40_GOLD_SKULLTULA_REWARD,          {Category::cKakarikoVillage, Category::cKakariko, Category::cSkulltulaHouse});
    locationTable[KAK_50_GOLD_SKULLTULA_REWARD]          = ItemLocation::Base       (0x50, 0x3E, "Kak 50 Gold Skulltula Reward",         KAK_50_GOLD_SKULLTULA_REWARD,          {Category::cKakarikoVillage, Category::cKakariko, Category::cSkulltulaHouse});
    locationTable[KAK_MAN_ON_ROOF]                       = ItemLocation::Base       (0x52, 0x3E, "Kak Man on Roof",                      KAK_MAN_ON_ROOF,                       {Category::cKakarikoVillage, Category::cKakariko,});
    locationTable[KAK_SHOOTING_GALLERY_REWARD]           = ItemLocation::Base       (0x42, 0x30, "Kak Shooting Gallery Reward",          KAK_SHOOTING_GALLERY_REWARD,           {Category::cKakarikoVillage, Category::cKakariko, Category::cMinigame});
    locationTable[KAK_ANJU_AS_ADULT]                     = ItemLocation::Base       (0x52, 0x1D, "Kak Anju as Adult",                    KAK_ANJU_AS_ADULT,                     {Category::cKakarikoVillage, Category::cKakariko,});
    locationTable[KAK_ANJU_AS_CHILD]                     = ItemLocation::Base       (0x52, 0x0F, "Kak Anju as Child",                    KAK_ANJU_AS_CHILD,                     {Category::cKakarikoVillage, Category::cKakariko, Category::cMinigame});
    ...
    locationTable[GRAVEYARD_DAMPE_GRAVEDIGGING_TOUR]     = ItemLocation::Collectable(0x53, 0x08, "GY Dampe Gravedigging Tour",           GRAVEYARD_DAMPE_GRAVEDIGGING_TOUR,     {Category::cGraveyard, Category::cKakariko,});
    ...
    locationTable[GC_ROLLING_GORON_AS_CHILD]             = ItemLocation::Base       (0x62, 0x34, "GC Rolling Goron as Child",            GC_ROLLING_GORON_AS_CHILD,             {Category::cGoronCity,});
    locationTable[GC_ROLLING_GORON_AS_ADULT]             = ItemLocation::Base       (0x62, 0x2C, "GC Rolling Goron as Adult",            GC_ROLLING_GORON_AS_ADULT,             {Category::cGoronCity,});
    ...
    locationTable[ZR_MAGIC_BEAN_SALESMAN]                = ItemLocation::Base       (0x54, 0x16, "ZR Magic Bean Salesman",               ZR_MAGIC_BEAN_SALESMAN,                {Category::cZorasRiver,});
    locationTable[ZR_FROGS_OCARINA_GAME]                 = ItemLocation::Base       (0x54, 0x76, "ZR Frogs Ocarina Game",                ZR_FROGS_OCARINA_GAME,                 {Category::cZorasRiver,});
    locationTable[ZR_FROGS_IN_THE_RAIN]                  = ItemLocation::Base       (0x54, 0x3E, "ZR Frogs in the Rain",                 ZR_FROGS_IN_THE_RAIN,                  {Category::cZorasRiver, Category::cMinigame,});
    ...
    locationTable[ZD_DIVING_MINIGAME]                    = ItemLocation::Base       (0x58, 0x37, "ZD Diving Minigame",                   ZD_DIVING_MINIGAME,                    {Category::cZorasDomain, Category::cMinigame,});
    locationTable[ZD_KING_ZORA_THAWED]                   = ItemLocation::Base       (0x58, 0x2D, "ZD King Zora Thawed",                  ZD_KING_ZORA_THAWED,                   {Category::cZorasDomain,});
    ...
    //Lon Lon Ranch
    locationTable[LLR_TALONS_CHICKENS]                   = ItemLocation::Base       (0x4C, 0x14, "LLR Talons Chickens",                  LLR_TALONS_CHICKENS,                   {Category::cLonLonRanch, Category::cMinigame});
    ...
    locationTable[LINKS_POCKET]                                  = ItemLocation::Reward (0xFF, 0xFF,                    "Link's Pocket",               LINKS_POCKET,                     {});
    locationTable[QUEEN_GOHMA]                                   = ItemLocation::Reward (0xFF, DUNGEON_DEKU_TREE,       "Queen Gohma",                 QUEEN_GOHMA,                      {});
    locationTable[KING_DODONGO]                                  = ItemLocation::Reward (0xFF, DUNGEON_DODONGOS_CAVERN, "King Dodongo",                KING_DODONGO,                     {});
    locationTable[BARINADE]                                      = ItemLocation::Reward (0xFF, DUNGEON_JABUJABUS_BELLY, "Barinade",                    BARINADE,                         {});
    locationTable[PHANTOM_GANON]                                 = ItemLocation::Reward (0xFF, DUNGEON_FOREST_TEMPLE,   "Phantom Ganon",               PHANTOM_GANON,                    {});
    locationTable[VOLVAGIA]                                      = ItemLocation::Reward (0xFF, DUNGEON_FIRE_TEMPLE,     "Volvagia",                    VOLVAGIA,                         {});
    locationTable[MORPHA]                                        = ItemLocation::Reward (0xFF, DUNGEON_WATER_TEMPLE,    "Morpha",                      MORPHA,                           {});
    locationTable[TWINROVA]                                      = ItemLocation::Reward (0xFF, DUNGEON_SPIRIT_TEMPLE,   "Twinrova",                    TWINROVA,                         {});
    locationTable[BONGO_BONGO]                                   = ItemLocation::Reward (0xFF, DUNGEON_SHADOW_TEMPLE,   "Bongo Bongo",                 BONGO_BONGO,                      {});
    locationTable[GANON]                                         = ItemLocation::Reward (0xFF, 0xF0,                    "Ganon",                       NONE,                             {});

    /*-------------------------------
          ---HEART CONTAINERS ---
      -------------------------------*/

    locationTable[DEKU_TREE_QUEEN_GOHMA_HEART]                   = ItemLocation::Base   (0x11, 0x4F, "Deku Tree Queen Gohma Heart Container",          DEKU_TREE_QUEEN_GOHMA_HEART,        {Category::cDekuTree, Category::cBossHeart, Category::cSongDungeonReward});
    locationTable[DODONGOS_CAVERN_KING_DODONGO_HEART]            = ItemLocation::Base   (0x12, 0x4F, "Dodongos Cavern King Dodongo Heart Container",   DODONGOS_CAVERN_KING_DODONGO_HEART, {Category::cDodongosCavern, Category::cBossHeart, Category::cSongDungeonReward});
    locationTable[JABU_JABUS_BELLY_BARINADE_HEART]               = ItemLocation::Base   (0x13, 0x4F, "Jabu Jabus Belly Barinade Heart Container",      JABU_JABUS_BELLY_BARINADE_HEART,    {Category::cJabuJabusBelly, Category::cBossHeart, Category::cSongDungeonReward});
    locationTable[FOREST_TEMPLE_PHANTOM_GANON_HEART]             = ItemLocation::Base   (0x14, 0x4F, "Forest Temple Phantom Ganon Heart Container",    FOREST_TEMPLE_PHANTOM_GANON_HEART,  {Category::cForestTemple, Category::cBossHeart, Category::cSongDungeonReward});
    locationTable[FIRE_TEMPLE_VOLVAGIA_HEART]                    = ItemLocation::Base   (0x15, 0x4F, "Fire Temple Volvagia Heart Container",           FIRE_TEMPLE_VOLVAGIA_HEART,         {Category::cFireTemple, Category::cBossHeart, Category::cSongDungeonReward});
    locationTable[WATER_TEMPLE_MORPHA_HEART]                     = ItemLocation::Base   (0x16, 0x4F, "Water Temple Morpha Heart Container",            WATER_TEMPLE_MORPHA_HEART,          {Category::cWaterTemple, Category::cBossHeart, Category::cSongDungeonReward});
    locationTable[SPIRIT_TEMPLE_TWINROVA_HEART]                  = ItemLocation::Base   (0x17, 0x4F, "Spirit Temple Twinrova Heart Container",         SPIRIT_TEMPLE_TWINROVA_HEART,       {Category::cSpiritTemple, Category::cBossHeart, Category::cSongDungeonReward});
    locationTable[SHADOW_TEMPLE_BONGO_BONGO_HEART]               = ItemLocation::Base   (0x18, 0x4F, "Shadow Temple Bongo Bongo Heart Container",      SHADOW_TEMPLE_BONGO_BONGO_HEART,    {Category::cShadowTemple, Category::cBossHeart, Category::cSongDungeonReward});

    /*-------------------------------
            --- CUTSCENES ---
      -------------------------------*/

    locationTable[TOT_LIGHT_ARROWS_CUTSCENE]                     = ItemLocation::Delayed(0xFF, 0x01, "ToT Light Arrow Cutscene",                       TOT_LIGHT_ARROWS_CUTSCENE,          {Category::cTempleOfTime, Category::cMarket});
    locationTable[LW_GIFT_FROM_SARIA]                            = ItemLocation::Delayed(0xFF, 0x02, "LW Gift From Saria",                             LW_GIFT_FROM_SARIA,                {Category::cLostWoods, Category::cForest});
    locationTable[ZF_GREAT_FAIRY_REWARD]                         = ItemLocation::Delayed(0xFF, 0x10, "ZF Great Fairy Reward",                          ZF_GREAT_FAIRY_REWARD,             {Category::cZorasFountain, Category::cFairies});
    locationTable[HC_GREAT_FAIRY_REWARD]                         = ItemLocation::Delayed(0xFF, 0x11, "HC Great Fairy Reward",                          HC_GREAT_FAIRY_REWARD,             {Category::cHyruleCastle, Category::cMarket, Category::cFairies});
    locationTable[COLOSSUS_GREAT_FAIRY_REWARD]                   = ItemLocation::Delayed(0xFF, 0x12, "Colossus Great Fairy Reward",                    COLOSSUS_GREAT_FAIRY_REWARD,       {Category::cDesertColossus, Category::cFairies});
    locationTable[DMT_GREAT_FAIRY_REWARD]                        = ItemLocation::Delayed(0xFF, 0x13, "DMT Great Fairy Reward",                         DMT_GREAT_FAIRY_REWARD,            {Category::cDeathMountainTrail, Category::cDeathMountain, Category::cFairies});
    locationTable[DMC_GREAT_FAIRY_REWARD]                        = ItemLocation::Delayed(0xFF, 0x14, "DMC Great Fairy Reward",                         DMC_GREAT_FAIRY_REWARD,            {Category::cDeathMountainCrater, Category::cDeathMountain, Category::cFairies});
    locationTable[OGC_GREAT_FAIRY_REWARD]                        = ItemLocation::Delayed(0xFF, 0x15, "OGC Great Fairy Reward",                         OGC_GREAT_FAIRY_REWARD,            {Category::cOutsideGanonsCastle, Category::cMarket, Category::cFairies});

    locationTable[SHEIK_IN_FOREST]                               = ItemLocation::Delayed(0xFF, 0x20, "Sheik in Forest",                                SHEIK_IN_FOREST,                   {Category::cSacredForestMeadow, Category::cForest, Category::cSong,});
    locationTable[SHEIK_IN_CRATER]                               = ItemLocation::Delayed(0xFF, 0x21, "Sheik in Crater",                                SHEIK_IN_CRATER,                   {Category::cDeathMountainCrater, Category::cDeathMountain, Category::cSong,});
    locationTable[SHEIK_IN_ICE_CAVERN]                           = ItemLocation::Delayed(0xFF, 0x22, "Sheik in Ice Cavern",                            SHEIK_IN_ICE_CAVERN,                {Category::cIceCavern, Category::cSong, Category::cSongDungeonReward});
    locationTable[SHEIK_AT_COLOSSUS]                             = ItemLocation::Delayed(0xFF, 0x23, "Sheik at Colossus",                              SHEIK_AT_COLOSSUS,                 {Category::cDesertColossus, Category::cSong,});
    locationTable[SHEIK_IN_KAKARIKO]                             = ItemLocation::Delayed(0xFF, 0x24, "Sheik in Kakariko",                              SHEIK_IN_KAKARIKO,                 {Category::cKakarikoVillage, Category::cKakariko, Category::cSong,});
    locationTable[SHEIK_AT_TEMPLE]                               = ItemLocation::Delayed(0xFF, 0x25, "Sheik at Temple",                                SHEIK_AT_TEMPLE,                   {Category::cTempleOfTime, Category::cMarket, Category::cSong,});
    locationTable[SONG_FROM_IMPA]                                = ItemLocation::Delayed(0xFF, 0x26, "Song from Impa",                                 SONG_FROM_IMPA,                    {Category::cHyruleCastle, Category::cMarket, Category::cSong, Category::cSongDungeonReward});
    locationTable[SONG_FROM_MALON]                               = ItemLocation::Delayed(0xFF, 0x27, "Song from Malon",                                SONG_FROM_MALON,                   {Category::cLonLonRanch, Category::cSong,});
    locationTable[SONG_FROM_SARIA]                               = ItemLocation::Delayed(0xFF, 0x28, "Song from Saria",                                SONG_FROM_SARIA,                   {Category::cSacredForestMeadow, Category::cForest, Category::cSong,});
    locationTable[SONG_FROM_COMPOSERS_GRAVE]                     = ItemLocation::Delayed(0xFF, 0x29, "Song from Composers Grave",                      SONG_FROM_COMPOSERS_GRAVE,          {Category::cGraveyard, Category::cKakariko, Category::cSong,});
    locationTable[SONG_FROM_OCARINA_OF_TIME]                     = ItemLocation::Delayed(0xFF, 0x2A, "Song from Ocarina of Time",                      SONG_FROM_OCARINA_OF_TIME,           {Category::cHyruleField, Category::cSong, Category::cNeedSpiritualStones,});
    locationTable[SONG_FROM_WINDMILL]                            = ItemLocation::Delayed(0xFF, 0x2B, "Song from Windmill",                             SONG_FROM_WINDMILL,                {Category::cKakarikoVillage, Category::cKakariko, Category::cSong,});

    /*-------------------------------
               --- COWS ---
      -------------------------------*/

    locationTable[KF_LINKS_HOUSE_COW]                            = ItemLocation::Base   (0x34, 0x15, "KF Links House Cow",                             KF_LINKS_HOUSE_COW,                {Category::cForest, Category::cCow, Category::cMinigame});
    locationTable[HF_COW_GROTTO_COW]                             = ItemLocation::Base   (0x3E, 0x16, "HF Cow Grotto Cow",                              HF_COW_GROTTO_COW,                 {Category::cHyruleField, Category::cCow, Category::cGrotto});
    locationTable[LLR_STABLES_LEFT_COW]                          = ItemLocation::Base   (0x36, 0x16, "LLR Stables Left Cow",                           LLR_STABLES_LEFT_COW,              {Category::cLonLonRanch, Category::cCow});
    locationTable[LLR_STABLES_RIGHT_COW]                         = ItemLocation::Base   (0x36, 0x15, "LLR Stables Right Cow",                          LLR_STABLES_RIGHT_COW,             {Category::cLonLonRanch, Category::cCow});
    locationTable[LLR_TOWER_LEFT_COW]                            = ItemLocation::Base   (0x4C, 0x16, "LLR Tower Left Cow",                             LLR_TOWER_LEFT_COW,                {Category::cLonLonRanch, Category::cCow});
    locationTable[LLR_TOWER_RIGHT_COW]                           = ItemLocation::Base   (0x4C, 0x15, "LLR Tower Right Cow",                            LLR_TOWER_RIGHT_COW,               {Category::cLonLonRanch, Category::cCow});
    locationTable[KAK_IMPAS_HOUSE_COW]                           = ItemLocation::Base   (0x37, 0x15, "Kak Impas House Cow",                            KAK_IMPAS_HOUSE_COW,               {Category::cKakarikoVillage, Category::cKakariko, Category::cCow});
    locationTable[DMT_COW_GROTTO_COW]                            = ItemLocation::Base   (0x3E, 0x15, "DMT Cow Grotto Cow",                             DMT_COW_GROTTO_COW,                {Category::cDeathMountainTrail, Category::cDeathMountain, Category::cCow, Category::cGrotto});
    locationTable[GV_COW]                                        = ItemLocation::Base   (0x5A, 0x15, "GV Cow",                                         GV_COW,                            {Category::cGerudoValley, Category::cGerudo, Category::cCow});
    locationTable[JABU_JABUS_BELLY_MQ_COW]                       = ItemLocation::Base   (0x02, 0x15, "Jabu Jabus Belly MQ Cow",                        JABU_JABUS_BELLY_MQ_COW,           {Category::cJabuJabusBelly, Category::cCow});
