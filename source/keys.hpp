...
typedef enum {
    ...
    SOUL_ITEM_SHABOM,
    SOUL_ITEM_BIRI_BARI,
    SOUL_ITEM_TAILPASARAN,
    SOUL_ITEM_SKULLTULA,
    SOUL_ITEM_TORCH_SLUG,
    SOUL_ITEM_STINGER,
    SOUL_ITEM_MOBLIN,
    SOUL_ITEM_ARMOS,
    SOUL_ITEM_DEKU_BABA,
    SOUL_ITEM_BUBBLE,
    SOUL_ITEM_FLYING_TRAP,
    SOUL_ITEM_BEAMOS,
    SOUL_ITEM_WALLMASTER,
    SOUL_ITEM_REDEAD_GIBDO,
    SOUL_ITEM_SHELL_BLADE,
    SOUL_ITEM_LIKE_LIKE,
    SOUL_ITEM_TENTACLE,
    SOUL_ITEM_ANUBIS,
    SOUL_ITEM_SPIKE,
    SOUL_ITEM_SKULL_KID,
    SOUL_ITEM_FREEZARD,
    SOUL_ITEM_DEKU_SCRUB,
    SOUL_ITEM_WOLFOS,
    SOUL_ITEM_STALCHILD,
    SOUL_ITEM_GUAY,
    SOUL_ITEM_DOOR_MIMIC,
    SOUL_ITEM_STALFOS,
    SOUL_ITEM_DARK_LINK,
    SOUL_ITEM_FLARE_DANCER,
    SOUL_ITEM_DEAD_HAND,
    SOUL_ITEM_GERUDO,
    SOUL_ITEM_GOHMA,
    SOUL_ITEM_DODONGO,
    SOUL_ITEM_BARINADE,
    SOUL_ITEM_PHANTOM_GANON,
    SOUL_ITEM_VOLVAGIA,
    SOUL_ITEM_MORPHA,
    SOUL_ITEM_BONGO_BONGO,
    SOUL_ITEM_TWINROVA,
    SOUL_ITEM_GANON,

    // OCARINA NOTE BUTTONS
    OCA_BUTTON_ITEM_L,
    OCA_BUTTON_ITEM_R,
    OCA_BUTTON_ITEM_X,
    OCA_BUTTON_ITEM_Y,
    ...
    SPIRIT_TEMPLE_LOBBY,
    SPIRIT_TEMPLE_CHILD,
    SPIRIT_TEMPLE_CHILD_STALFOS_ROOM_BEFORE_BRIDGE,
    SPIRIT_TEMPLE_CHILD_STALFOS_ROOM_AFTER_BRIDGE,
    SPIRIT_TEMPLE_CHILD_ANUBIS_ROOM,
    SPIRIT_TEMPLE_CHILD_TORCHES_ROOM_BEFORE_BRIDGE,
    SPIRIT_TEMPLE_CHILD_TORCHES_ROOM_AFTER_BRIDGE,
    SPIRIT_TEMPLE_CHILD_AFTER_SECOND_CRAWL_SPACE,
    ...
    SHEIK_LIGHT_ARROW_LOCATION_HINT,
    SHEIK_MASTER_SWORD_LOCATION_HINT,
    SHEIK_LINE01,
    SHEIK_LINE02,
    SHEIK_LINE03,
