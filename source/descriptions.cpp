...
string_view playthroughHintsDesc      = "Hints will indicate the location of required items"
                                        "following the playthrough generated by the logic\n"
                                        "system.\n\n"                                      //
                                        "Not compatible with No Logic.";                   //
/*------------------------------                                                           //
|       HINT SPECIFICITY       |                                                           //
------------------------------*/                                                           //
string_view hintSpecificityDesc       = "Choose if hints should refer to a general area\n" //
                                        "(like \"Forest Temple\") or an exact location\n"  //
                                        "(like \"Forest Temple Map Chest\").";             //
/*------------------------------                                                           //
|      BONUS GOSSIP HINTS      |                                                           //
------------------------------*/                                                           //
